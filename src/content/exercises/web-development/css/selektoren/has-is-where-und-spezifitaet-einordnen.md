---
title: "Aufgabe – :has(), :is() und :where() mit Spezifität einordnen"
...
Vergleiche zwei Selektoren: .card:is(article, section) h2 und :where(.card, .panel) h2. Erkläre, welcher leichter überschrieben werden kann.
