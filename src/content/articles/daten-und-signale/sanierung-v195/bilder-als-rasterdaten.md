---
title: "Bilder als Rasterdaten"
description: "Verstehe pixel, farbe und auflösung verbinden als ruhigen Baustein für Daten, Signale, Messung und Übertragung."
...
keyTakeaways:
  ...
  - "Farbtiefe bestimmt, wie viele Farbwerte möglich sind."
  - "Auflösung und Kompression beeinflussen Dateigröße."
...
![Didaktische Skizze zu Bilder als Rasterdaten](/schlaufuchs-platform/images/daten-und-signale/sanierung-v195/bilder-als-rasterdaten.svg)

Bilder als Rasterdaten gehört zur Daten-und-Signale-Sanierung v195. Die Seite behandelt das Thema als ruhigen Arbeitsbaustein: Erst wird geklärt, welches Signal oder welche Daten vorliegen, dann wird entschieden, wie sie dargestellt, übertragen oder ausgewertet werden.

## Worum es geht

Pixel, Farbe und Auflösung verbinden. Wichtig ist dabei, nicht nur auf einzelne Zahlen zu schauen. Daten und Signale brauchen Kontext: Quelle, Einheit, Zeitpunkt, Codierung und Zweck bestimmen, was aus einem Wert wirklich abgeleitet werden darf.
