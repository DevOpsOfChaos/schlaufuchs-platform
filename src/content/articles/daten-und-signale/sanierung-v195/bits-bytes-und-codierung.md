---
title: "Bits, Bytes und Codierung"
description: "Verstehe darstellung von bedeutung unterscheiden als ruhigen Baustein für Daten, Signale, Messung und Übertragung."
subject: "daten-und-signale"
section: "signalverarbeitung-und-uebertragung"
topicPath: ["sanierung-v195", "bits-bytes-und-codierung"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
draft: false
---
![Didaktische Skizze zu Bits, Bytes und Codierung](/schlaufuchs-platform/images/daten-und-signale/sanierung-v195/bits-bytes-und-codierung.svg)

Bits, Bytes und Codierung gehört zur Daten-und-Signale-Sanierung v195. Die Seite behandelt das Thema als ruhigen Arbeitsbaustein: Erst wird geklärt, welches Signal oder welche Daten vorliegen, dann wird entschieden, wie sie dargestellt, übertragen oder ausgewertet werden.

## Worum es geht

Darstellung von Bedeutung unterscheiden. Wichtig ist dabei, nicht nur auf einzelne Zahlen zu schauen. Daten und Signale brauchen Kontext: Quelle, Einheit, Zeitpunkt, Codierung und Zweck bestimmen, was aus einem Wert wirklich abgeleitet werden darf.
...
- Bits sind Zustände, keine automatische Bedeutung.\n- Bytes bündeln mehrere Bits zu handhabbaren Einheiten.\n- Codierungen legen fest, wie Zeichen oder Werte gelesen werden.\n
## Ruhiger Prüfweg
