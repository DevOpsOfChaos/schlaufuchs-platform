---
title: "Glättung und Mittelwert"
description: "Verstehe schwankungen beruhigen ohne trends zu verlieren als ruhigen Baustein für Daten, Signale, Messung und Übertragung."
...
keyTakeaways:
  - "Glättung reduziert kurzfristige Schwankungen."
  - "Mittelwerte können Ausreißer verdecken."
  - "Fenstergröße beeinflusst Reaktionsgeschwindigkeit."
...
![Didaktische Skizze zu Glättung und Mittelwert](/schlaufuchs-platform/images/daten-und-signale/sanierung-v195/glattung-und-mittelwert.svg)

Glättung und Mittelwert gehört zur Daten-und-Signale-Sanierung v195. Die Seite behandelt das Thema als ruhigen Arbeitsbaustein: Erst wird geklärt, welches Signal oder welche Daten vorliegen, dann wird entschieden, wie sie dargestellt, übertragen oder ausgewertet werden.

## Worum es geht

Schwankungen beruhigen ohne Trends zu verlieren. Wichtig ist dabei, nicht nur auf einzelne Zahlen zu schauen. Daten und Signale brauchen Kontext: Quelle, Einheit, Zeitpunkt, Codierung und Zweck bestimmen, was aus einem Wert wirklich abgeleitet werden darf.
