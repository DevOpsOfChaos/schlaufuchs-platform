---
title: "Sensoren und Messketten"
description: "Verstehe vom physikalischen zustand zum wert gehen als ruhigen Baustein für Daten, Signale, Messung und Übertragung."
subject: "daten-und-signale"
section: "signalverarbeitung-und-uebertragung"
topicPath: ["sanierung-v195", "sensoren-und-messketten"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
draft: false
---
![Didaktische Skizze zu Sensoren und Messketten](/schlaufuchs-platform/images/daten-und-signale/sanierung-v195/sensoren-und-messketten.svg)

Sensoren und Messketten gehört zur Daten-und-Signale-Sanierung v195. Die Seite behandelt das Thema als ruhigen Arbeitsbaustein: Erst wird geklärt, welches Signal oder welche Daten vorliegen, dann wird entschieden, wie sie dargestellt, übertragen oder ausgewertet werden.

## Worum es geht

Vom physikalischen Zustand zum Wert gehen. Wichtig ist dabei, nicht nur auf einzelne Zahlen zu schauen. Daten und Signale brauchen Kontext: Quelle, Einheit, Zeitpunkt, Codierung und Zweck bestimmen, was aus einem Wert wirklich abgeleitet werden darf.
...
- Sensoren wandeln physikalische Größen in Signale.\n- Messketten enthalten oft Verstärkung, Wandlung und Auswertung.\n- Jede Stufe kann Fehler oder Verzögerung einbringen.\n
## Ruhiger Prüfweg
