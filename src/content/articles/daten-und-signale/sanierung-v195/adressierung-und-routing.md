...
description: "Verstehe ziel und weg getrennt betrachten als ruhigen Baustein für Daten, Signale, Messung und Übertragung."
...
learningGoals:
  - "Ziel und Weg getrennt betrachten"
  - "Rohdaten, Darstellung und Interpretation sauber trennen"
  - "einen kleinen prüfbaren nächsten Schritt formulieren"
practiceIdeas:
  - "Analysiere einen einfachen Übertragungsweg mit Sender, Router und Empfänger."
...
keyTakeaways:
  - "Adressierung beschreibt, wohin Daten sollen."
  - "Routing entscheidet über den Weg durch ein Netz."
  - "Fehler können beim Ziel, beim Weg oder bei Regeln liegen."
...
![Didaktische Skizze zu Adressierung und Routing](/schlaufuchs-platform/images/daten-und-signale/sanierung-v195/adressierung-und-routing.svg)

Adressierung und Routing gehört zur Daten-und-Signale-Sanierung v195. Die Seite behandelt das Thema als ruhigen Arbeitsbaustein: Erst wird geklärt, welches Signal oder welche Daten vorliegen, dann wird entschieden, wie sie dargestellt, übertragen oder ausgewertet werden.

## Worum es geht

Ziel und Weg getrennt betrachten. Wichtig ist dabei, nicht nur auf einzelne Zahlen zu schauen. Daten und Signale brauchen Kontext: Quelle, Einheit, Zeitpunkt, Codierung und Zweck bestimmen, was aus einem Wert wirklich abgeleitet werden darf.
