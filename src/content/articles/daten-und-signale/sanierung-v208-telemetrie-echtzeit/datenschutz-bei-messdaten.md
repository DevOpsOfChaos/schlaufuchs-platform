...
description: "Verstehe datenschutz bei messdaten als Teil belastbarer Telemetrie, Echtzeitbewertung und Datenqualität."
...
draft: false
---
![Datenschutz bei Messdaten](/schlaufuchs-platform/images/daten-und-signale/sanierung-v208-telemetrie-echtzeit/datenschutz-bei-messdaten.svg)

## Worum es geht

**Datenschutz bei Messdaten** gehört zu den Themen, die in Daten- und Signalprojekten schnell praktisch werden. Die Seite ordnet das Thema ruhig ein, damit nicht nur ein einzelner Messwert betrachtet wird, sondern der ganze Weg von Quelle über Übertragung bis Auswertung.
