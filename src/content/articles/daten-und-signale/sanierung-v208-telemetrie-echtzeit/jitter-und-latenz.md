---
title: "Jitter und Latenz"
description: "Verstehe jitter und latenz als Teil belastbarer Telemetrie, Echtzeitbewertung und Datenqualität."
subject: "daten-und-signale"
section: "echtzeit"
topicPath: ["zeitreihen-und-echtzeit", "jitter-und-latenz"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
draft: false
---
![Jitter und Latenz](/schlaufuchs-platform/images/daten-und-signale/sanierung-v208-telemetrie-echtzeit/jitter-und-latenz.svg)

## Worum es geht

**Jitter und Latenz** gehört zu den Themen, die in Daten- und Signalprojekten schnell praktisch werden. Die Seite ordnet das Thema ruhig ein, damit nicht nur ein einzelner Messwert betrachtet wird, sondern der ganze Weg von Quelle über Übertragung bis Auswertung.
