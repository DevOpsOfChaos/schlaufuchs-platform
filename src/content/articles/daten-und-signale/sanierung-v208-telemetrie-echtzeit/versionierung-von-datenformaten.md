---
title: "Versionierung von Datenformaten"
description: "Verstehe versionierung von datenformaten als Teil belastbarer Telemetrie, Echtzeitbewertung und Datenqualität."
...
draft: false
---
![Versionierung von Datenformaten](/schlaufuchs-platform/images/daten-und-signale/sanierung-v208-telemetrie-echtzeit/versionierung-von-datenformaten.svg)

## Worum es geht

**Versionierung von Datenformaten** gehört zu den Themen, die in Daten- und Signalprojekten schnell praktisch werden. Die Seite ordnet das Thema ruhig ein, damit nicht nur ein einzelner Messwert betrachtet wird, sondern der ganze Weg von Quelle über Übertragung bis Auswertung.
