---
title: "Event statt Dauerwert"
description: "Verstehe event statt dauerwert als Teil belastbarer Telemetrie, Echtzeitbewertung und Datenqualität."
...
draft: false
---
![Event statt Dauerwert](/schlaufuchs-platform/images/daten-und-signale/sanierung-v208-telemetrie-echtzeit/event-statt-dauerwert.svg)

## Worum es geht

**Event statt Dauerwert** gehört zu den Themen, die in Daten- und Signalprojekten schnell praktisch werden. Die Seite ordnet das Thema ruhig ein, damit nicht nur ein einzelner Messwert betrachtet wird, sondern der ganze Weg von Quelle über Übertragung bis Auswertung.
