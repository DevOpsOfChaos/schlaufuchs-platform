---
title: "CSV-Export und Messreihe"
description: "Verstehe csv-export und messreihe als Teil belastbarer Telemetrie, Echtzeitbewertung und Datenqualität."
...
draft: false
---
![CSV-Export und Messreihe](/schlaufuchs-platform/images/daten-und-signale/sanierung-v208-telemetrie-echtzeit/csv-export-und-messreihe.svg)

## Worum es geht

**CSV-Export und Messreihe** gehört zu den Themen, die in Daten- und Signalprojekten schnell praktisch werden. Die Seite ordnet das Thema ruhig ein, damit nicht nur ein einzelner Messwert betrachtet wird, sondern der ganze Weg von Quelle über Übertragung bis Auswertung.
