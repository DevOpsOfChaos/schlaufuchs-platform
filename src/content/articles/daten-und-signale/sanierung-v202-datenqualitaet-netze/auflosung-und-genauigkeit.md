---
title: "Auflösung und Genauigkeit unterscheiden"
description: "Verstehe, wie auflösung und genauigkeit unterscheiden Daten, Signale und Systeme belastbarer macht."
...
selfCheckPoints: []
level: "mittel"
tags: ["daten-und-signale", "datenqualitaet", "datenqualitaet-und-netze", "aufloesung-und-genauigkeit"]
draft: false
---
![Auflösung und Genauigkeit unterscheiden](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/auflosung-und-genauigkeit.svg)

Auflösung und Genauigkeit unterscheiden ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

Viele Nachkommastellen bedeuten nicht automatisch hohe Genauigkeit.
...
Auflösung und Genauigkeit unterscheiden bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
