---
title: "Entprellen und Flanken erkennen"
description: "Verstehe, wie entprellen und flanken erkennen Daten, Signale und Systeme belastbarer macht."
...
selfCheckPoints: []
level: "mittel"
tags: ["daten-und-signale", "sensorik", "sensorik-und-schnittstellen", "entprellen-und-flanken"]
draft: false
---
![Entprellen und Flanken erkennen](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/entprellen-und-flanken.svg)

Entprellen und Flanken erkennen ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

Mechanische Signale können mehrfach wechseln, obwohl nur eine Aktion gemeint ist.
...
Entprellen und Flanken erkennen bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
