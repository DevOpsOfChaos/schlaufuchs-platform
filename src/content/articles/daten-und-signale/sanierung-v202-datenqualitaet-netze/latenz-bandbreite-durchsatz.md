---
title: "Latenz, Bandbreite und Durchsatz"
description: "Verstehe, wie latenz, bandbreite und durchsatz Daten, Signale und Systeme belastbarer macht."
subject: "daten-und-signale"
section: "netze"
topicPath: ["netzwerke-und-protokolle", "leistung", "latenz-bandbreite-durchsatz"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["daten-und-signale", "netze", "netzwerke-und-protokolle", "latenz-bandbreite-durchsatz"]
draft: false
---
![Latenz, Bandbreite und Durchsatz](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/latenz-bandbreite-durchsatz.svg)

Latenz, Bandbreite und Durchsatz ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

Netzqualität besteht aus mehreren Größen, die unterschiedliche Probleme zeigen.
...
Latenz, Bandbreite und Durchsatz bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
