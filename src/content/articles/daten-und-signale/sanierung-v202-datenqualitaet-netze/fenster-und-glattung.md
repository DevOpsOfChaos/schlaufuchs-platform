---
title: "Fenster und Glättung einordnen"
description: "Verstehe, wie fenster und glättung einordnen Daten, Signale und Systeme belastbarer macht."
subject: "daten-und-signale"
section: "datenqualitaet"
topicPath: ["datenqualitaet-und-netze", "auswertung", "fenster-und-glaettung"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["daten-und-signale", "datenqualitaet", "datenqualitaet-und-netze", "fenster-und-glaettung"]
draft: false
---
![Fenster und Glättung einordnen](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/fenster-und-glattung.svg)

Fenster und Glättung einordnen ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

Glättung reduziert Störungen, kann aber schnelle Ereignisse verstecken.
...
Fenster und Glättung einordnen bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
