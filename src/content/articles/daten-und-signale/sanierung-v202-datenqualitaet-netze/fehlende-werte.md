---
title: "Fehlende Werte sauber behandeln"
description: "Verstehe, wie fehlende werte sauber behandeln Daten, Signale und Systeme belastbarer macht."
...
selfCheckPoints: []
level: "mittel"
tags: ["daten-und-signale", "datenqualitaet", "datenqualitaet-und-netze", "fehlende-werte"]
draft: false
---
![Fehlende Werte sauber behandeln](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/fehlende-werte.svg)

Fehlende Werte sauber behandeln ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

Lücken sind Information: sie zeigen Ausfall, Filterung oder Übertragungsprobleme.
...
Fehlende Werte sauber behandeln bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
