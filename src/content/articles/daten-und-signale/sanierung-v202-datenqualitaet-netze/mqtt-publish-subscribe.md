...
description: "Verstehe, wie mqtt publish subscribe Daten, Signale und Systeme belastbarer macht."
subject: "daten-und-signale"
section: "netze"
topicPath: ["netzwerke-und-protokolle", "iot", "mqtt-publish-subscribe"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["daten-und-signale", "netze", "netzwerke-und-protokolle", "mqtt-publish-subscribe"]
draft: false
---
![MQTT Publish Subscribe](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/mqtt-publish-subscribe.svg)

MQTT Publish Subscribe ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

MQTT entkoppelt Sender und Empfänger über Topics und einen Broker.
...
MQTT Publish Subscribe bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
