---
title: "Analog-Digital-Wandlung verstehen"
description: "Verstehe, wie analog-digital-wandlung verstehen Daten, Signale und Systeme belastbarer macht."
subject: "daten-und-signale"
section: "sensorik"
topicPath: ["sensorik-und-schnittstellen", "schnittstellen", "analog-digital-wandlung"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["daten-und-signale", "sensorik", "sensorik-und-schnittstellen", "analog-digital-wandlung"]
draft: false
---
![Analog-Digital-Wandlung verstehen](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/analog-digital-wandlung.svg)

Analog-Digital-Wandlung verstehen ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

A/D-Wandlung übersetzt kontinuierliche Signale in Zahlen mit begrenzter Auflösung.
...
Analog-Digital-Wandlung verstehen bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
