...
description: "Verstehe, wie uart und serielle daten Daten, Signale und Systeme belastbarer macht."
subject: "daten-und-signale"
section: "sensorik"
topicPath: ["sensorik-und-schnittstellen", "busse", "uart-serielle-daten"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "einfach"
tags: ["daten-und-signale", "sensorik", "sensorik-und-schnittstellen", "uart-serielle-daten"]
draft: false
---
![UART und serielle Daten](/schlaufuchs-platform/images/daten-und-signale/v202-datenqualitaet-netze/uart-serielle-daten.svg)

UART und serielle Daten ist ein wichtiger Baustein, wenn Daten und Signale nicht nur gesammelt, sondern **verständlich und prüfbar** genutzt werden sollen. Der Blick richtet sich nicht auf eine einzelne Zahl, sondern auf die Kette aus Quelle, Übertragung, Verarbeitung und Entscheidung.

## Grundidee

Serielle Daten brauchen Baudrate, Start-/Stoppbits und gemeinsame Interpretation.
...
UART und serielle Daten bedeutet: Daten nicht isoliert lesen, sondern mit Quelle, Kontext, Grenze und Folgeentscheidung verbinden.
