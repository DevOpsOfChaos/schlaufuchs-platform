---
title: "Variable sinnvoll definieren"
description: "Lerne Variable sinnvoll definieren als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Variable sinnvoll definieren als enges Unterthema."
...
commonMistakes:
  - "Es wird gerechnet, bevor klar ist, wofür die Variable steht."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Variable sinnvoll definieren wird über eine kleine Trennkante verständlich."
...
**Variable sinnvoll definieren** ist bewusst als kleines Unterthema angelegt. Lerne Variable sinnvoll definieren als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Textaufgabe enthält mehrere unbekannte Größen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-variable-sinnvoll-definieren-v113.svg" alt="Lernillustration zu Variable sinnvoll definieren." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Es wird gerechnet, bevor klar ist, wofür die Variable steht.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist die Variable mit Einheit und Bedeutung festgelegt?</span></div>
  </div>
</div>
