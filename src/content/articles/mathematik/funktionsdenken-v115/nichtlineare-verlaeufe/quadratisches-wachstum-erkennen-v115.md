---
title: "Mathematik – Quadratisches Wachstum erkennen"
description: "Trainiere Quadratisches Wachstum erkennen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: mathematik
section: "Feinstruktur Mathematik"
topicPath:
  - "funktionsdenken-v115"
  - "nichtlineare-verlaeufe"
  - "quadratisches-wachstum-erkennen-v115"
learningGoals:
  - "Du erklärst Quadratisches Wachstum erkennen an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Verdopplung der Seitenlänge wird mit Verdopplung der Fläche verwechselt."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welche Größe wird mit sich selbst multipliziert?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Quadratisches Wachstum erkennen."
...
<img src="/schlaufuchs-platform/illustrations/mathematik-quadratisches-wachstum-erkennen-v115.svg" alt="Lernillustration zu Quadratisches Wachstum erkennen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Quadratisches Wachstum erkennen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welche Größe wird mit sich selbst multipliziert?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Quadratisches Wachstum erkennen</h3>
  <p>Eine Fläche verändert sich, wenn die Seitenlänge wächst.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Quadratisches Wachstum erkennen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Verdopplung der Seitenlänge wird mit Verdopplung der Fläche verwechselt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Verdopplung der Seitenlänge wird mit Verdopplung der Fläche verwechselt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Quadratisches Wachstum erkennen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
