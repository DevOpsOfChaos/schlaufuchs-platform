...
Dieses Unterthema behandelt **Exponentielles Verdoppeln lesen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Ist der Zuwachs absolut gleich oder ist der Faktor gleich?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Exponentielles Verdoppeln lesen</h3>
  <p>Eine Menge verdoppelt sich in gleichen Zeitabständen.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Exponentielles Verdoppeln lesen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Gleiche absolute Zunahmen und gleiche Faktoren werden vermischt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Gleiche absolute Zunahmen und gleiche Faktoren werden vermischt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Exponentielles Verdoppeln lesen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
