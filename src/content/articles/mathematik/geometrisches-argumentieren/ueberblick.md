...
Geometrisches Argumentieren nutzt sichtbare Strukturen, bekannte Sätze und klare Begründungsschritte. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Geometrisches Argumentieren](/schlaufuchs-platform/images/overviews/v147/geometrisches-argumentieren.svg)

*Überblick über Begründen mit Figuren, Eigenschaften, Beziehungen und Hilfslinien.*

## Grundidee

Geometrisches Argumentieren nutzt sichtbare Strukturen, bekannte Sätze und klare Begründungsschritte. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Geometrisches Argumentieren hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Skizze:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Hilfslinie:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Satz:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Folgerung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Geometrisches Argumentieren nutzt sichtbare Strukturen, bekannte Sätze und klare Begründungsschritte. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
