---
title: "Mathematik – Median und Mittelwert fallbezogen wählen"
...
<div class="example-card">
  ...
  <h3>Eine Datenreihe enthält einen starken Ausreißer.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Median und Mittelwert beantworten unterschiedliche Fragen.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der Mittelwert wird immer als repräsentativ genutzt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Median und Mittelwert beantworten unterschiedliche Fragen.</span>
    </div>
  </div>
</div>
...
```text
Situation: Eine Datenreihe enthält einen starken Ausreißer.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Median und Mittelwert beantworten unterschiedliche Fragen.</p>
</div>
