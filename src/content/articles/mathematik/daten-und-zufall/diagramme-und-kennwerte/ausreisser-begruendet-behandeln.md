---
title: "Mathematik – Ausreißer begründet behandeln"
description: "Lerne ausreißer begründet behandeln als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst ausreißer begründet behandeln in einem klaren Kontext."
...
commonMistakes:
  - "Unpassende Werte werden ohne fachlichen Grund entfernt."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Ausreißer müssen begründet geprüft, nicht automatisch gelöscht werden."
...
**Ausreißer begründet behandeln** ist bewusst als kleines Unterthema angelegt. Lerne ausreißer begründet behandeln als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Messwert liegt deutlich außerhalb der anderen Werte.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Diagramme und Kennwerte“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Ausreißer müssen begründet geprüft, nicht automatisch gelöscht werden.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Unpassende Werte werden ohne fachlichen Grund entfernt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Ausreißer müssen begründet geprüft, nicht automatisch gelöscht werden.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Messwert liegt deutlich außerhalb der anderen Werte.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Diagramme und Kennwerte** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Ausreißer müssen begründet geprüft, nicht automatisch gelöscht werden.</p>
</div>
