---
title: "Median und Mittelwert unterscheiden"
description: "Lerne Median und Mittelwert unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Median und Mittelwert unterscheiden als enges Unterthema."
...
commonMistakes:
  - "Der Mittelwert wird als typischer Wert gedeutet, obwohl ein Ausreißer vorliegt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Median und Mittelwert unterscheiden wird über eine kleine Trennkante verständlich."
...
**Median und Mittelwert unterscheiden** ist bewusst als kleines Unterthema angelegt. Lerne Median und Mittelwert unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein einzelner sehr großer Wert verändert die Datenreihe stark.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-median-und-mittelwert-unterscheiden-v113.svg" alt="Lernillustration zu Median und Mittelwert unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Mittelwert wird als typischer Wert gedeutet, obwohl ein Ausreißer vorliegt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welcher Kennwert ist robuster gegen Ausreißer?</span></div>
  </div>
</div>
