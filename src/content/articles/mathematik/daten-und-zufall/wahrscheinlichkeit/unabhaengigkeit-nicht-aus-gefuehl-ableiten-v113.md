---
title: "Unabhängigkeit nicht aus Gefühl ableiten"
description: "Lerne Unabhängigkeit nicht aus Gefühl ableiten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Unabhängigkeit nicht aus Gefühl ableiten als enges Unterthema."
...
commonMistakes:
  - "Unabhängig wird mit thematisch ähnlich verwechselt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Unabhängigkeit nicht aus Gefühl ableiten wird über eine kleine Trennkante verständlich."
...
**Unabhängigkeit nicht aus Gefühl ableiten** ist bewusst als kleines Unterthema angelegt. Lerne Unabhängigkeit nicht aus Gefühl ableiten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Ereignisse klingen ähnlich, beeinflussen sich aber möglicherweise nicht.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-unabhaengigkeit-nicht-aus-gefuehl-ableiten-v113.svg" alt="Lernillustration zu Unabhängigkeit nicht aus Gefühl ableiten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Unabhängig wird mit thematisch ähnlich verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ändert die Information über das eine Ereignis die Wahrscheinlichkeit des anderen?</span></div>
  </div>
</div>
...
```text
Gegebenes markieren → Begriff wählen → Rechenschritt prüfen → Gegenbeispiel bilden
```
