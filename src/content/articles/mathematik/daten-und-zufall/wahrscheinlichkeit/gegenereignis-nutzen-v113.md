---
title: "Gegenereignis nutzen"
description: "Lerne Gegenereignis nutzen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Gegenereignis nutzen als enges Unterthema."
...
commonMistakes:
  - "Alle Einzelfälle werden unvollständig aufgezählt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Gegenereignis nutzen wird über eine kleine Trennkante verständlich."
...
**Gegenereignis nutzen** ist bewusst als kleines Unterthema angelegt. Lerne Gegenereignis nutzen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Gesucht ist die Wahrscheinlichkeit, dass mindestens ein Ereignis eintritt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-gegenereignis-nutzen-v113.svg" alt="Lernillustration zu Gegenereignis nutzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Alle Einzelfälle werden unvollständig aufgezählt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist das Gegenereignis einfacher zu berechnen?</span></div>
  </div>
</div>
