---
title: "Mathematik – Boxplot-Quartile ohne Einzelwerte lesen"
description: "Lerne Boxplot-Quartile als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Boxplot-Quartile als eigenes Unterthema."
...
commonMistakes:
  - "Aus dem Boxplot werden nicht sichtbare Einzelwerte erfunden."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Boxplot-Quartile wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Boxplot-Quartile** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Boxplot-Quartile als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Boxplot zeigt Median und Quartile, aber nicht alle Einzelwerte.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-boxplot-quartile-ohne-einzelwerte-lesen.svg" alt="Lernillustration zu Boxplot-Quartile." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Aus dem Boxplot werden nicht sichtbare Einzelwerte erfunden.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Formuliere nur Aussagen, die der Boxplot wirklich zeigt.</span></div>
  </div>
</div>
