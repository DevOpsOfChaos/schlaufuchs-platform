---
title: "Mathematik – Boxplot, Quartile und Spannweite getrennt lesen"
description: "Lerne Boxplot lesen als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Boxplot lesen in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Boxplot lesen wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Boxplot lesen** ist ein bewusst kleines Unterthema. Lerne Boxplot lesen als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Boxplot zeigt Median, Quartile und Spannweite, aber nicht jede einzelne Beobachtung.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v108-boxplot-quartile-und-spannweite-getrennt-lesen.svg" alt="Lernillustration zu Boxplot lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Nur Aussagen machen, die der Boxplot wirklich zeigt.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Nur Aussagen machen, die der Boxplot wirklich zeigt.</span></div>
