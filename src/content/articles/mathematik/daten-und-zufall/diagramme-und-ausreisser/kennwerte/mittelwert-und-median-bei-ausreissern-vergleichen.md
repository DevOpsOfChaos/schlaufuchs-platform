---
title: "Mathematik – Mittelwert und Median bei Ausreißern vergleichen"
description: "Lerne Kennwerte mit Ausreißern als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Kennwerte mit Ausreißern als eigenes Unterthema."
...
keyTakeaways:
  - "Kennwerte mit Ausreißern wird durch Einordnung, Trennung und Gegenprobe stabil."
...
**Kennwerte mit Ausreißern** ist ein kleines, bewusst abgegrenztes Unterthema. Lerne Kennwerte mit Ausreißern als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe. Die Seite verhindert, dass mehrere Nachbarfragen in einem breiten Sammelbegriff verschwimmen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v107-mittelwert-und-median-bei-ausreissern-vergle.svg" alt="Lernillustration zu Kennwerte mit Ausreißern." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
