---
title: "Mathematik – Parameterfälle in Gleichungen geordnet prüfen"
...
<div class="example-card">
  ...
  <h3>Eine Gleichung enthält einen Parameter im Nenner oder vor der Variablen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-parameterfaelle-in-gleichungen-geordnet-pruefen.svg" alt="Lernillustration zu Parameterfälle in Gleichungen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Es wird durch einen Ausdruck geteilt, der null sein könnte.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Prüfe zuerst den Sonderfall, dann den Normalfall.</span></div>
  </div>
</div>
