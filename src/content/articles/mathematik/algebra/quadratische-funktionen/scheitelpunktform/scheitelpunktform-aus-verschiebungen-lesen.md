---
title: "Mathematik – Scheitelpunktform aus Verschiebungen lesen"
description: "Lerne Scheitelpunktform als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "mathematik"
section: "Algebra"
topicPath:
  - "algebra"
...
learningGoals:
  - "Du erklärst Scheitelpunktform in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Scheitelpunktform wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Scheitelpunktform** ist ein bewusst kleines Unterthema. Lerne Scheitelpunktform als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Die Form a(x-d)²+e zeigt Verschiebung und Streckung direkt, wenn Vorzeichen ruhig gelesen werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v108-scheitelpunktform-aus-verschiebungen-lesen.svg" alt="Lernillustration zu Scheitelpunktform." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Vorzeichen in der Klammer nicht mit der y-Verschiebung vermischen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Vorzeichen in der Klammer nicht mit der y-Verschiebung vermischen.</span></div>
