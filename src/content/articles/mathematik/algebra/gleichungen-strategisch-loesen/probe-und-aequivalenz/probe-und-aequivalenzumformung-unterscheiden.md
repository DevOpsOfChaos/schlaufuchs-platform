---
title: "Mathematik – Probe und Äquivalenzumformung unterscheiden"
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v107-probe-und-aequivalenzumformung-unterscheiden.svg" alt="Lernillustration zu Gleichungsprobe." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
