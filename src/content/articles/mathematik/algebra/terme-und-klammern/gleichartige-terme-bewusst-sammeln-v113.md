---
title: "Gleichartige Terme bewusst sammeln"
...
<div class="example-card">
  ...
  <h3>In einem Term kommen Variablen, Zahlen und unterschiedliche Potenzen gemischt vor.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-gleichartige-terme-bewusst-sammeln-v113.svg" alt="Lernillustration zu Gleichartige Terme bewusst sammeln." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Alle Terme mit derselben Variablen werden ungeprüft zusammengefasst.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Haben die Terme wirklich dieselbe Variable mit derselben Potenz?</span></div>
  </div>
</div>
