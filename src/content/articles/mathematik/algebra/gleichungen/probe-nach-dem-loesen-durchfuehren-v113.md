---
title: "Probe nach dem Lösen durchführen"
description: "Lerne Probe nach dem Lösen durchführen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Probe nach dem Lösen durchführen als enges Unterthema."
...
commonMistakes:
  - "Das erste Ergebnis wird ohne Einsetzen übernommen."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Probe nach dem Lösen durchführen wird über eine kleine Trennkante verständlich."
...
**Probe nach dem Lösen durchführen** ist bewusst als kleines Unterthema angelegt. Lerne Probe nach dem Lösen durchführen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine lineare Gleichung liefert eine Zahl, aber ein Vorzeichenfehler ist möglich.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-probe-nach-dem-loesen-durchfuehren-v113.svg" alt="Lernillustration zu Probe nach dem Lösen durchführen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Das erste Ergebnis wird ohne Einsetzen übernommen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Erfüllt die gefundene Zahl die ursprüngliche Gleichung?</span></div>
  </div>
</div>
