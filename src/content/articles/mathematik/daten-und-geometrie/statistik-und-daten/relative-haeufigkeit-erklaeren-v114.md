---
title: Relative Häufigkeit erklären
description: Anteil und Anzahl nicht verwechseln
subject: mathematik
...
learningGoals:
- Du erklärst Relative Häufigkeit erklären als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Relative Häufigkeit erklären wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Relative Häufigkeit erklären** ist bewusst als kleines Unterthema angelegt. Anteil und Anzahl nicht verwechseln. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Gruppen haben unterschiedlich viele Personen.</h3>
  <p>Die wichtige Frage lautet: <strong>Welcher Anteil gehört zur jeweiligen Gruppengröße?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-relative-haeufigkeit-erklaeren-v114.svg" alt="Lernillustration zu Relative Häufigkeit erklären." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Absolute Trefferzahlen werden direkt verglichen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welcher Anteil gehört zur jeweiligen Gruppengröße?</span></div>
  </div>
</div>
