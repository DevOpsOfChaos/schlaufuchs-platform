---
title: Quartile als Streuungsbild lesen
description: Boxplots über Verteilung statt Einzelwerte deuten
subject: mathematik
...
learningGoals:
- Du erklärst Quartile als Streuungsbild lesen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Nur der höchste Wert wird betrachtet.
...
keyTakeaways:
- Quartile als Streuungsbild lesen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Quartile als Streuungsbild lesen** ist bewusst als kleines Unterthema angelegt. Boxplots über Verteilung statt Einzelwerte deuten. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Klasse hat sehr unterschiedliche Ergebnisse.</h3>
  <p>Die wichtige Frage lautet: <strong>Wo liegen die mittleren 50 Prozent der Daten?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-quartile-als-streuungsbild-lesen-v114.svg" alt="Lernillustration zu Quartile als Streuungsbild lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur der höchste Wert wird betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wo liegen die mittleren 50 Prozent der Daten?</span></div>
  </div>
</div>
