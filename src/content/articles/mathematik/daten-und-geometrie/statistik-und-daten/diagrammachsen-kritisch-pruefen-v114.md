---
title: Diagrammachsen kritisch prüfen
description: Skalierung als Teil der Aussage lesen
subject: mathematik
...
learningGoals:
- Du erklärst Diagrammachsen kritisch prüfen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Der optische Unterschied wird ungeprüft übernommen.
...
keyTakeaways:
- Diagrammachsen kritisch prüfen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Diagrammachsen kritisch prüfen** ist bewusst als kleines Unterthema angelegt. Skalierung als Teil der Aussage lesen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine y-Achse beginnt nicht bei null.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Skalierung verstärkt oder dämpft den Eindruck?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-diagrammachsen-kritisch-pruefen-v114.svg" alt="Lernillustration zu Diagrammachsen kritisch prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der optische Unterschied wird ungeprüft übernommen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Skalierung verstärkt oder dämpft den Eindruck?</span></div>
  </div>
</div>
