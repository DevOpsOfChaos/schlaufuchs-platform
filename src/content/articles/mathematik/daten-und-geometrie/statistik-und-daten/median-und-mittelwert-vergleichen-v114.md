...
<div class="example-card">
  ...
  <h3>Ein Ausreißer liegt weit über den übrigen Werten.</h3>
  <p>Die wichtige Frage lautet: <strong>Welcher Kennwert bleibt bei Ausreißern stabiler?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-median-und-mittelwert-vergleichen-v114.svg" alt="Lernillustration zu Median und Mittelwert vergleichen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Mittelwert wird immer als typischster Wert behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welcher Kennwert bleibt bei Ausreißern stabiler?</span></div>
  </div>
</div>
