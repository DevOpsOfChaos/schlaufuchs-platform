---
title: Richtungsvektor und Ortsvektor trennen
description: Vektoren nach ihrer Rolle im Raum unterscheiden
subject: mathematik
...
learningGoals:
- Du erklärst Richtungsvektor und Ortsvektor trennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Punkt und Richtung werden gleich behandelt.
...
keyTakeaways:
- Richtungsvektor und Ortsvektor trennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Richtungsvektor und Ortsvektor trennen** ist bewusst als kleines Unterthema angelegt. Vektoren nach ihrer Rolle im Raum unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Gerade wird durch Punkt und Richtung beschrieben.</h3>
  <p>Die wichtige Frage lautet: <strong>Beschreibt der Vektor eine Lage oder eine Verschiebung?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-richtungsvektor-und-ortsvektor-trennen-v114.svg" alt="Lernillustration zu Richtungsvektor und Ortsvektor trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Punkt und Richtung werden gleich behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Beschreibt der Vektor eine Lage oder eine Verschiebung?</span></div>
  </div>
</div>
