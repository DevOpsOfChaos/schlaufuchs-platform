---
title: Abstand Punkt-Gerade einordnen
description: Kürzeste Entfernung als senkrechte Verbindung lesen
subject: mathematik
...
learningGoals:
- Du erklärst Abstand Punkt-Gerade einordnen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Irgendeine Verbindung wird als Abstand genutzt.
...
keyTakeaways:
- Abstand Punkt-Gerade einordnen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Abstand Punkt-Gerade einordnen** ist bewusst als kleines Unterthema angelegt. Kürzeste Entfernung als senkrechte Verbindung lesen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Punkt liegt neben einer Geraden.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Strecke steht senkrecht zur Geraden?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-abstand-punkt-gerade-einordnen-v114.svg" alt="Lernillustration zu Abstand Punkt-Gerade einordnen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Irgendeine Verbindung wird als Abstand genutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Strecke steht senkrecht zur Geraden?</span></div>
  </div>
</div>
