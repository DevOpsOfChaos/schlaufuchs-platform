---
title: Skalarprodukt als Winkeltest nutzen
description: Orthogonalität rechnerisch und geometrisch verbinden
subject: mathematik
...
learningGoals:
- Du erklärst Skalarprodukt als Winkeltest nutzen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Skalarprodukt als Winkeltest nutzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Skalarprodukt als Winkeltest nutzen** ist bewusst als kleines Unterthema angelegt. Orthogonalität rechnerisch und geometrisch verbinden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Richtungen stehen möglicherweise senkrecht.</h3>
  <p>Die wichtige Frage lautet: <strong>Ist das Skalarprodukt null?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-skalarprodukt-als-winkeltest-nutzen-v114.svg" alt="Lernillustration zu Skalarprodukt als Winkeltest nutzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur die Zeichnung entscheidet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist das Skalarprodukt null?</span></div>
  </div>
</div>
