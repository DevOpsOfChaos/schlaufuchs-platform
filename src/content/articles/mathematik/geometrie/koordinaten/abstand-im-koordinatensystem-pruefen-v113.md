---
title: "Abstand im Koordinatensystem prüfen"
description: "Lerne Abstand im Koordinatensystem prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Abstand im Koordinatensystem prüfen als enges Unterthema."
...
commonMistakes:
  - "Nur die x- oder y-Differenz wird als Abstand genommen."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Abstand im Koordinatensystem prüfen wird über eine kleine Trennkante verständlich."
...
**Abstand im Koordinatensystem prüfen** ist bewusst als kleines Unterthema angelegt. Lerne Abstand im Koordinatensystem prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Punkte liegen nicht waagerecht oder senkrecht zueinander.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-abstand-im-koordinatensystem-pruefen-v113.svg" alt="Lernillustration zu Abstand im Koordinatensystem prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur die x- oder y-Differenz wird als Abstand genommen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Müssen beide Koordinatendifferenzen berücksichtigt werden?</span></div>
  </div>
</div>
