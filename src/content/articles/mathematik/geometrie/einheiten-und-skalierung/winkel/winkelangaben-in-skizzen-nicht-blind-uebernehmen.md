---
title: "Mathematik – Winkelangaben in Skizzen nicht blind übernehmen"
description: "Lerne Skizzenwinkel als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Skizzenwinkel als enges Unterthema."
...
commonMistakes:
  - "Optischer Eindruck wird als mathematische Information genutzt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Skizzenwinkel wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Skizzenwinkel** ist bewusst als kleines Unterthema angelegt. Lerne Skizzenwinkel als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Skizze wirkt rechtwinklig, aber keine Markierung bestätigt das.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-winkelangaben-in-skizzen-nicht-blind-uebernehmen.svg" alt="Lernillustration zu Skizzenwinkel." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Optischer Eindruck wird als mathematische Information genutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Nutze nur markierte oder begründete Winkelinformationen.</span></div>
  </div>
</div>
