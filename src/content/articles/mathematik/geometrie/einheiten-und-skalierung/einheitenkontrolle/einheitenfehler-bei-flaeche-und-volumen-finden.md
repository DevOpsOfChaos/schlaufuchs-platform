---
title: "Mathematik – Einheitenfehler bei Fläche und Volumen finden"
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v107-einheitenfehler-bei-flaeche-und-volumen-find.svg" alt="Lernillustration zu Einheitenkontrolle." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
