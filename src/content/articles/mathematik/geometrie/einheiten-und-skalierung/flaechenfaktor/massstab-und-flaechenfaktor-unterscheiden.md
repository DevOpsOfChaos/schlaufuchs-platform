---
title: "Mathematik – Maßstab und Flächenfaktor unterscheiden"
description: "Lerne Maßstab und Flächenfaktor als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "mathematik"
section: "Geometrie"
topicPath:
  - "geometrie"
...
learningGoals:
  - "Du erklärst Maßstab und Flächenfaktor in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Maßstab und Flächenfaktor wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Maßstab und Flächenfaktor** ist ein bewusst kleines Unterthema. Lerne Maßstab und Flächenfaktor als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Wird eine Länge mit dem Faktor k skaliert, wächst die Fläche mit k².</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v108-massstab-und-flaechenfaktor-unterscheiden.svg" alt="Lernillustration zu Maßstab und Flächenfaktor." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Längenfaktor und Flächenfaktor nicht gleichsetzen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Längenfaktor und Flächenfaktor nicht gleichsetzen.</span></div>
