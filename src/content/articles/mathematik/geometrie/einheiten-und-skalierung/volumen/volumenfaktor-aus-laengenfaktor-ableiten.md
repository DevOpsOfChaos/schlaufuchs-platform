---
title: "Mathematik – Volumenfaktor aus Längenfaktor ableiten"
description: "Lerne Volumenskalierung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Volumenskalierung als enges Unterthema."
...
**Volumenskalierung** ist bewusst als kleines Unterthema angelegt. Lerne Volumenskalierung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Körper wird im Maßstab vergrößert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-volumenfaktor-aus-laengenfaktor-ableiten.svg" alt="Lernillustration zu Volumenskalierung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Volumen wird wie Länge skaliert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Erhebe den Längenfaktor für Volumen auf die dritte Potenz.</span></div>
  </div>
</div>
