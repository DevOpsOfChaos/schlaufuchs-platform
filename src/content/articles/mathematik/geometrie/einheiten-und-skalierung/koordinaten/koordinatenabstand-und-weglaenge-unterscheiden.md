---
title: "Mathematik – Koordinatenabstand und Weglänge unterscheiden"
description: "Lerne Abstand im Koordinatensystem als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Abstand im Koordinatensystem als enges Unterthema."
...
commonMistakes:
  - "x- und y-Differenz werden direkt als Abstand genommen."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Abstand im Koordinatensystem wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Abstand im Koordinatensystem** ist bewusst als kleines Unterthema angelegt. Lerne Abstand im Koordinatensystem als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Punkte liegen nicht auf derselben Achse.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-koordinatenabstand-und-weglaenge-unterscheiden.svg" alt="Lernillustration zu Abstand im Koordinatensystem." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>x- und y-Differenz werden direkt als Abstand genommen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Nutze die Differenzen als Katheten, nicht als fertigen Abstand.</span></div>
  </div>
</div>
