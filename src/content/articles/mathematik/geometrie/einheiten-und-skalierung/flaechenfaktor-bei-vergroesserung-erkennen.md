---
title: "Mathematik – Flächenfaktor bei Vergrößerung erkennen"
description: "Lerne flächenfaktor bei vergrößerung erkennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst flächenfaktor bei vergrößerung erkennen in einem klaren Kontext."
...
**Flächenfaktor bei Vergrößerung erkennen** ist bewusst als kleines Unterthema angelegt. Lerne flächenfaktor bei vergrößerung erkennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Figur wird in jeder Länge verdoppelt.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Geometrie und Skalierung“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Flächen wachsen quadratisch mit dem Längenfaktor.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Doppelte Länge wird mit doppelter Fläche gleichgesetzt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Flächen wachsen quadratisch mit dem Längenfaktor.</span>
    </div>
  </div>
</div>
...
```text
Situation: Eine Figur wird in jeder Länge verdoppelt.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Geometrie und Skalierung** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Flächen wachsen quadratisch mit dem Längenfaktor.</p>
</div>
