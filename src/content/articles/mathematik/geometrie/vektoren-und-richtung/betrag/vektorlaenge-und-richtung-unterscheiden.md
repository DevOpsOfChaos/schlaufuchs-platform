---
title: "Mathematik – Vektorlänge und Richtung unterscheiden"
...
<div class="example-card">
  ...
  <h3>Ein Vektor enthält Länge und Richtung. Gleiche Länge bedeutet nicht automatisch gleiche Richtung.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v108-vektorlaenge-und-richtung-unterscheiden.svg" alt="Lernillustration zu Vektorlänge und Richtung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Betrag berechnen, Richtung getrennt beschreiben.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Betrag berechnen, Richtung getrennt beschreiben.</span></div>
