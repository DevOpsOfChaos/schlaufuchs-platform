---
title: "Mathematik – Skalarprodukt zur Winkelentscheidung nutzen"
description: "Lerne Skalarprodukt und Winkel als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
subject: "mathematik"
section: "Geometrie"
topicPath:
  - "geometrie"
...
learningGoals:
  - "Du erklärst Skalarprodukt und Winkel als eigenes Unterthema."
...
commonMistakes:
  - "Das Skalarprodukt wird nur als Rechenformel gesehen."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Skalarprodukt und Winkel wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Skalarprodukt und Winkel** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Skalarprodukt und Winkel als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Richtungen sollen als spitz, rechtwinklig oder stumpf eingeordnet werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-skalarprodukt-zur-winkelentscheidung-nutzen.svg" alt="Lernillustration zu Skalarprodukt und Winkel." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Das Skalarprodukt wird nur als Rechenformel gesehen.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Prüfe das Vorzeichen des Skalarprodukts.</span></div>
  </div>
</div>
