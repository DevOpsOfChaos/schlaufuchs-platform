---
title: "Volumen und Oberfläche unterscheiden"
description: "Lerne Volumen und Oberfläche unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Volumen und Oberfläche unterscheiden als enges Unterthema."
...
commonMistakes:
  - "Volumen und Oberfläche werden als gleiche Art von Größe behandelt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Volumen und Oberfläche unterscheiden wird über eine kleine Trennkante verständlich."
...
**Volumen und Oberfläche unterscheiden** ist bewusst als kleines Unterthema angelegt. Lerne Volumen und Oberfläche unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Körper wird gefüllt, aber zusätzlich wird Verpackungsmaterial erwähnt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-volumen-und-oberflaeche-unterscheiden-v113.svg" alt="Lernillustration zu Volumen und Oberfläche unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Volumen und Oberfläche werden als gleiche Art von Größe behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wird Innenraum gefüllt oder Außenfläche bedeckt?</span></div>
  </div>
</div>
