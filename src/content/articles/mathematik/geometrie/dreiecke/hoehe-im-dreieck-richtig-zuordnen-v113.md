---
title: "Höhe im Dreieck richtig zuordnen"
description: "Lerne Höhe im Dreieck richtig zuordnen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Höhe im Dreieck richtig zuordnen als enges Unterthema."
...
commonMistakes:
  - "Eine beliebige Seitenlänge wird als Höhe benutzt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Höhe im Dreieck richtig zuordnen wird über eine kleine Trennkante verständlich."
...
**Höhe im Dreieck richtig zuordnen** ist bewusst als kleines Unterthema angelegt. Lerne Höhe im Dreieck richtig zuordnen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Dreiecksfläche soll berechnet werden und mehrere Strecken sind eingezeichnet.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-hoehe-im-dreieck-richtig-zuordnen-v113.svg" alt="Lernillustration zu Höhe im Dreieck richtig zuordnen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Eine beliebige Seitenlänge wird als Höhe benutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Steht die Höhe senkrecht auf der gewählten Grundseite?</span></div>
  </div>
</div>
