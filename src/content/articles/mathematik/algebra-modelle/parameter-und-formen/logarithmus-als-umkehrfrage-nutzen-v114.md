---
title: Logarithmus als Umkehrfrage nutzen
description: Logarithmen als Frage nach dem Exponenten lesen
subject: mathematik
...
learningGoals:
- Du erklärst Logarithmus als Umkehrfrage nutzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Logarithmus wird als neue Rechenart ohne Bedeutung benutzt.
...
keyTakeaways:
- Logarithmus als Umkehrfrage nutzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Logarithmus als Umkehrfrage nutzen** ist bewusst als kleines Unterthema angelegt. Logarithmen als Frage nach dem Exponenten lesen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Gesucht ist die Zeit bis zu einer Verdopplung.</h3>
  <p>Die wichtige Frage lautet: <strong>Zu welchem Exponenten führt die Basis auf den Zielwert?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-logarithmus-als-umkehrfrage-nutzen-v114.svg" alt="Lernillustration zu Logarithmus als Umkehrfrage nutzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Logarithmus wird als neue Rechenart ohne Bedeutung benutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Zu welchem Exponenten führt die Basis auf den Zielwert?</span></div>
  </div>
</div>
