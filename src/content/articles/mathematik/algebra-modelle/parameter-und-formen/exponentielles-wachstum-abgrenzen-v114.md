---
title: Exponentielles Wachstum abgrenzen
description: Wachstumsfaktor und absolute Zunahme trennen
subject: mathematik
section: Feinstruktur Mathematik
topicPath:
- algebra-modelle
- parameter-und-formen
- exponentielles-wachstum-abgrenzen-v114
learningGoals:
- Du erklärst Exponentielles Wachstum abgrenzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Faktor und Prozentpunkte werden vermischt.
...
keyTakeaways:
- Exponentielles Wachstum abgrenzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Exponentielles Wachstum abgrenzen** ist bewusst als kleines Unterthema angelegt. Wachstumsfaktor und absolute Zunahme trennen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Bestand wächst jede Woche um denselben Faktor.</h3>
  <p>Die wichtige Frage lautet: <strong>Bleibt die absolute oder die relative Änderung gleich?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-exponentielles-wachstum-abgrenzen-v114.svg" alt="Lernillustration zu Exponentielles Wachstum abgrenzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Faktor und Prozentpunkte werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Bleibt die absolute oder die relative Änderung gleich?</span></div>
  </div>
</div>
