...
<div class="example-card">
  ...
  <h3>Eine quadrierte Gleichung liefert zwei Kandidaten.</h3>
  <p>Die wichtige Frage lautet: <strong>Erfüllt der Kandidat die ursprüngliche Gleichung?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-probe-als-teil-der-loesung-nutzen-v114.svg" alt="Lernillustration zu Probe als Teil der Lösung nutzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Probe wird als unnötiger Zusatz weggelassen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Erfüllt der Kandidat die ursprüngliche Gleichung?</span></div>
  </div>
</div>
