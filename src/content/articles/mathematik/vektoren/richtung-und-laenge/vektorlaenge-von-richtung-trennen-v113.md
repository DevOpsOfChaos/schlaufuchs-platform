---
title: "Vektorlänge von Richtung trennen"
description: "Lerne Vektorlänge von Richtung trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Vektorlänge von Richtung trennen als enges Unterthema."
...
commonMistakes:
  - "Gleiche Richtung wird mit gleichem Vektor gleichgesetzt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Vektorlänge von Richtung trennen wird über eine kleine Trennkante verständlich."
...
**Vektorlänge von Richtung trennen** ist bewusst als kleines Unterthema angelegt. Lerne Vektorlänge von Richtung trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Pfeile zeigen in dieselbe Richtung, sind aber unterschiedlich lang.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-vektorlaenge-von-richtung-trennen-v113.svg" alt="Lernillustration zu Vektorlänge von Richtung trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Gleiche Richtung wird mit gleichem Vektor gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Sind Richtung und Länge beide identisch?</span></div>
  </div>
</div>
