---
title: "Mathematik – Klammerauflösung mit Minus kontrollieren"
...
<div class="example-card">
  ...
  <h3>Vor einer Klammer steht ein Minus und mehrere Summanden liegen darin.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-klammeraufloesung-mit-minus-kontrollieren.svg" alt="Lernillustration zu Minus vor Klammern." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur der erste Summand wird mit dem Minus verändert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Setze gedanklich den Faktor -1 vor die ganze Klammer.</span></div>
  </div>
</div>
