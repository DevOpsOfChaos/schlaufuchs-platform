---
title: "Mathematik – Ergebnisgrößenordnung vor Detailrechnung schätzen"
description: "Lerne Größenordnungsschätzung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Größenordnungsschätzung als enges Unterthema."
...
commonMistakes:
  - "Genauigkeit wird mit Richtigkeit verwechselt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Größenordnungsschätzung wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Größenordnungsschätzung** ist bewusst als kleines Unterthema angelegt. Lerne Größenordnungsschätzung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Rechnung liefert ein sehr genaues, aber offensichtlich unplausibles Ergebnis.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-ergebnisgroessenordnung-vor-detailrechnung-schaetzen.svg" alt="Lernillustration zu Größenordnungsschätzung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Genauigkeit wird mit Richtigkeit verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Schätze vor dem Rechnen eine Größenordnung und vergleiche danach.</span></div>
  </div>
</div>
