---
title: "Mathematik – Baumdiagramm in Stufen lesen"
description: "Trainiere Baumdiagramm in Stufen lesen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: mathematik
...
learningGoals:
  - "Du erklärst Baumdiagramm in Stufen lesen an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Zweigwahrscheinlichkeiten verschiedener Stufen werden addiert."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Folgen die Ereignisse nacheinander?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Baumdiagramm in Stufen lesen."
...
<img src="/schlaufuchs-platform/illustrations/mathematik-baumdiagramm-in-stufen-lesen-v115.svg" alt="Lernillustration zu Baumdiagramm in Stufen lesen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Baumdiagramm in Stufen lesen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Folgen die Ereignisse nacheinander?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Baumdiagramm in Stufen lesen</h3>
  <p>Ein zweistufiges Experiment wird beschrieben.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Baumdiagramm in Stufen lesen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Zweigwahrscheinlichkeiten verschiedener Stufen werden addiert.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Zweigwahrscheinlichkeiten verschiedener Stufen werden addiert. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Baumdiagramm in Stufen lesen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
