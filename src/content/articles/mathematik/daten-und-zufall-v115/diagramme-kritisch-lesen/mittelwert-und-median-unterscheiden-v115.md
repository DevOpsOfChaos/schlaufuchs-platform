---
title: "Mathematik – Mittelwert und Median unterscheiden"
description: "Trainiere Mittelwert und Median unterscheiden als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: mathematik
...
learningGoals:
  - "Du erklärst Mittelwert und Median unterscheiden an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Der Mittelwert wird als typischer Wert behandelt, obwohl ein Ausreißer dominiert."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welcher Kennwert ist robuster gegen Ausreißer?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Mittelwert und Median unterscheiden."
...
<img src="/schlaufuchs-platform/illustrations/mathematik-mittelwert-und-median-unterscheiden-v115.svg" alt="Lernillustration zu Mittelwert und Median unterscheiden" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Mittelwert und Median unterscheiden** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welcher Kennwert ist robuster gegen Ausreißer?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Mittelwert und Median unterscheiden</h3>
  <p>Eine kleine Datenreihe enthält einen Ausreißer.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Mittelwert und Median unterscheiden sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Der Mittelwert wird als typischer Wert behandelt, obwohl ein Ausreißer dominiert.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Der Mittelwert wird als typischer Wert behandelt, obwohl ein Ausreißer dominiert. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Mittelwert und Median unterscheiden bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
