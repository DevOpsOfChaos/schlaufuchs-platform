---
title: "Mathematik – Relative Häufigkeit deuten"
description: "Trainiere Relative Häufigkeit deuten als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: mathematik
...
learningGoals:
  - "Du erklärst Relative Häufigkeit deuten an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Absolute Trefferzahlen werden direkt verglichen."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Müssen die Treffer auf die Gruppengröße bezogen werden?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Relative Häufigkeit deuten."
...
<img src="/schlaufuchs-platform/illustrations/mathematik-relative-haeufigkeit-deuten-v115.svg" alt="Lernillustration zu Relative Häufigkeit deuten" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Relative Häufigkeit deuten** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Müssen die Treffer auf die Gruppengröße bezogen werden?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Relative Häufigkeit deuten</h3>
  <p>In zwei Gruppen gibt es unterschiedlich viele Beobachtungen.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Relative Häufigkeit deuten sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Absolute Trefferzahlen werden direkt verglichen.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Absolute Trefferzahlen werden direkt verglichen. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Relative Häufigkeit deuten bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
