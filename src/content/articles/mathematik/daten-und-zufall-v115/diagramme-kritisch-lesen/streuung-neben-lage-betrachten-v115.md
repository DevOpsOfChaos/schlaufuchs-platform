---
title: "Mathematik – Streuung neben Lage betrachten"
description: "Trainiere Streuung neben Lage betrachten als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: mathematik
...
learningGoals:
  - "Du erklärst Streuung neben Lage betrachten an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Gleicher Mittelwert wird mit gleicher Verteilung verwechselt."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Wie weit liegen die Werte auseinander?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Streuung neben Lage betrachten."
...
<img src="/schlaufuchs-platform/illustrations/mathematik-streuung-neben-lage-betrachten-v115.svg" alt="Lernillustration zu Streuung neben Lage betrachten" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Streuung neben Lage betrachten** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Wie weit liegen die Werte auseinander?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Streuung neben Lage betrachten</h3>
  <p>Zwei Klassen haben denselben Durchschnitt.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Streuung neben Lage betrachten sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Gleicher Mittelwert wird mit gleicher Verteilung verwechselt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Gleicher Mittelwert wird mit gleicher Verteilung verwechselt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Streuung neben Lage betrachten bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
