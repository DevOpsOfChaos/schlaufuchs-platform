---
title: "Mathematik – Prozent und Prozentpunkte nicht verwechseln"
description: "Lerne Prozent und Prozentpunkte als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "mathematik"
section: "Grundlagen"
topicPath:
  - "grundlagen"
...
learningGoals:
  - "Du erklärst Prozent und Prozentpunkte in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Prozent und Prozentpunkte wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Prozent und Prozentpunkte** ist ein bewusst kleines Unterthema. Lerne Prozent und Prozentpunkte als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Rabatt von 20 % und eine Erhöhung um 20 Prozentpunkte beschreiben nicht dieselbe Operation.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v108-prozent-und-prozentpunkte-nicht-verwechseln.svg" alt="Lernillustration zu Prozent und Prozentpunkte." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
```text
Gegebenes Beispiel → passende Darstellung → Rechnung → Probe
```
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Differenz in Prozentpunkten und relative Veränderung getrennt nennen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Differenz in Prozentpunkten und relative Veränderung getrennt nennen.</span></div>
