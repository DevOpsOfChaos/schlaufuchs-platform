---
title: "Mathematik – Prozentwert und Grundwert in Textaufgaben trennen"
description: "Lerne Prozentwert und Grundwert als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
subject: "mathematik"
section: "Grundlagen"
topicPath:
  - "grundlagen"
...
learningGoals:
  - "Du erklärst Prozentwert und Grundwert als eigenes Unterthema."
...
commonMistakes:
  - "Prozentwert und Grundwert werden vertauscht."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Prozentwert und Grundwert wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Prozentwert und Grundwert** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Prozentwert und Grundwert als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Rabatt, ein alter Preis und ein neuer Preis werden gemeinsam genannt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-prozentwert-und-grundwert-in-textaufgaben-trennen.svg" alt="Lernillustration zu Prozentwert und Grundwert." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Prozentwert und Grundwert werden vertauscht.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Frage: Wovon werden die Prozent genommen?</span></div>
  </div>
</div>
