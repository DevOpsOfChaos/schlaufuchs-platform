---
title: "Mathematik – Prozentpunkte und Prozent sauber unterscheiden"
description: "Lerne Prozentpunkte und Prozent als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
subject: "mathematik"
section: "Grundlagen"
...
**Prozentpunkte und Prozent** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Prozentpunkte und Prozent als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Anteil steigt von 20 % auf 25 %.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-prozentpunkte-und-prozent-sauber-unterscheiden.svg" alt="Lernillustration zu Prozentpunkte und Prozent." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Der Unterschied wird fälschlich als 25 % Wachstum beschrieben.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Rechne absolute Prozentpunkte und relatives Wachstum getrennt.</span></div>
  </div>
</div>
