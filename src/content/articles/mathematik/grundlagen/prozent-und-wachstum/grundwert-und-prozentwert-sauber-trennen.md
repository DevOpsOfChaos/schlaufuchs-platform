---
title: "Mathematik – Grundwert und Prozentwert sauber trennen"
...
<div class="example-card">
  ...
  <h3>Ein Rabatt wird berechnet, aber Ausgangswert und Ergebniswert werden verwechselt.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Grundwert ist die Bezugsgröße; Prozentwert ist der berechnete Anteil.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der Endpreis wird für den ursprünglichen Preis gehalten.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Grundwert ist die Bezugsgröße; Prozentwert ist der berechnete Anteil.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Rabatt wird berechnet, aber Ausgangswert und Ergebniswert werden verwechselt.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Grundwert ist die Bezugsgröße; Prozentwert ist der berechnete Anteil.</p>
</div>
