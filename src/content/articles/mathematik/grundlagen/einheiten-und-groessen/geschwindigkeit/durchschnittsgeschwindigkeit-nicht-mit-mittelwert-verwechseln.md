---
title: "Mathematik – Durchschnittsgeschwindigkeit nicht mit Mittelwert verwechseln"
description: "Lerne Durchschnittsgeschwindigkeit als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
subject: "mathematik"
section: "Grundlagen"
topicPath:
  - "grundlagen"
...
learningGoals:
  - "Du erklärst Durchschnittsgeschwindigkeit als eigenes Unterthema."
...
commonMistakes:
  - "Geschwindigkeiten werden einfach arithmetisch gemittelt."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Durchschnittsgeschwindigkeit wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Durchschnittsgeschwindigkeit** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Durchschnittsgeschwindigkeit als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Weg besteht aus zwei unterschiedlich langen Teilstrecken.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-durchschnittsgeschwindigkeit-nicht-mit-mittelwert-verwechseln.svg" alt="Lernillustration zu Durchschnittsgeschwindigkeit." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Geschwindigkeiten werden einfach arithmetisch gemittelt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Teile Gesamtweg durch Gesamtzeit.</span></div>
  </div>
</div>
