---
title: "Mathematik – Skalierung bei Karten lesen"
description: "Lerne skalierung bei karten lesen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst skalierung bei karten lesen in einem klaren Kontext."
...
commonMistakes:
  - "Zentimeter auf der Karte werden direkt als Meter in der Realität gelesen."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Skalierung ist ein Verhältnis zwischen Darstellung und Wirklichkeit."
...
**Skalierung bei Karten lesen** ist bewusst als kleines Unterthema angelegt. Lerne skalierung bei karten lesen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Maßstab verbindet Kartenlänge und reale Entfernung.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Skalierung ist ein Verhältnis zwischen Darstellung und Wirklichkeit.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Zentimeter auf der Karte werden direkt als Meter in der Realität gelesen.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Skalierung ist ein Verhältnis zwischen Darstellung und Wirklichkeit.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Maßstab verbindet Kartenlänge und reale Entfernung.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Skalierung ist ein Verhältnis zwischen Darstellung und Wirklichkeit.</p>
</div>
