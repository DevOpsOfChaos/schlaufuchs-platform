---
title: "Mathematik – Zusammengesetzte Einheiten zerlegen"
description: "Lerne zusammengesetzte einheiten zerlegen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst zusammengesetzte einheiten zerlegen in einem klaren Kontext."
...
commonMistakes:
  - "Die Einheit wird wie ein bloßer Textzusatz behandelt."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Zusammengesetzte Einheiten bestehen aus mehreren Größenbeziehungen."
...
**Zusammengesetzte Einheiten zerlegen** ist bewusst als kleines Unterthema angelegt. Lerne zusammengesetzte einheiten zerlegen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Geschwindigkeit wird in Kilometer pro Stunde angegeben.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Einheiten und Größen“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Zusammengesetzte Einheiten bestehen aus mehreren Größenbeziehungen.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Die Einheit wird wie ein bloßer Textzusatz behandelt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Zusammengesetzte Einheiten bestehen aus mehreren Größenbeziehungen.</span>
    </div>
  </div>
</div>
...
```text
Situation: Eine Geschwindigkeit wird in Kilometer pro Stunde angegeben.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Einheiten und Größen** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Zusammengesetzte Einheiten bestehen aus mehreren Größenbeziehungen.</p>
</div>
