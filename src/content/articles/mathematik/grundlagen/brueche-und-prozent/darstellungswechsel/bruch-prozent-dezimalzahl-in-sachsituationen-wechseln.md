---
title: "Mathematik – Bruch, Prozent und Dezimalzahl in Sachsituationen wechseln"
description: "Lerne Darstellungswechsel bei Anteilen als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe."
subject: "mathematik"
section: "Grundlagen"
topicPath:
  - "grundlagen"
...
learningGoals:
  - "Du erklärst Darstellungswechsel bei Anteilen als eigenes Unterthema."
...
keyTakeaways:
  - "Darstellungswechsel bei Anteilen wird durch Einordnung, Trennung und Gegenprobe stabil."
...
**Darstellungswechsel bei Anteilen** ist ein kleines, bewusst abgegrenztes Unterthema. Lerne Darstellungswechsel bei Anteilen als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe. Die Seite verhindert, dass mehrere Nachbarfragen in einem breiten Sammelbegriff verschwimmen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v107-bruch-prozent-dezimalzahl-in-sachsituationen.svg" alt="Lernillustration zu Darstellungswechsel bei Anteilen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
```text
Darstellung → Regel → Rechnung → Probe
```
