---
title: "Prozentuale Änderung mit Vorzeichen lesen"
description: "Lerne Prozentuale Änderung mit Vorzeichen lesen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Prozentuale Änderung mit Vorzeichen lesen als enges Unterthema."
...
commonMistakes:
  - "Zwei Prozentänderungen werden einfach addiert."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Prozentuale Änderung mit Vorzeichen lesen wird über eine kleine Trennkante verständlich."
...
**Prozentuale Änderung mit Vorzeichen lesen** ist bewusst als kleines Unterthema angelegt. Lerne Prozentuale Änderung mit Vorzeichen lesen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Wert sinkt zuerst und steigt danach wieder, aber die Bezugsgröße ändert sich.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-prozentuale-aenderung-mit-vorzeichen-lesen-v113.svg" alt="Lernillustration zu Prozentuale Änderung mit Vorzeichen lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Zwei Prozentänderungen werden einfach addiert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Auf welche Bezugsgröße bezieht sich jede Prozentangabe?</span></div>
  </div>
</div>
