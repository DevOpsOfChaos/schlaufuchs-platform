---
title: "Durchschnittliche Änderungsrate deuten"
description: "Lerne Durchschnittliche Änderungsrate deuten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
**Durchschnittliche Änderungsrate deuten** ist bewusst als kleines Unterthema angelegt. Lerne Durchschnittliche Änderungsrate deuten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Strecke wird über ein Zeitintervall betrachtet.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-durchschnittliche-aenderungsrate-deuten-v113.svg" alt="Lernillustration zu Durchschnittliche Änderungsrate deuten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Momentane und durchschnittliche Geschwindigkeit werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Bezieht sich die Aussage auf ein Intervall oder einen einzelnen Zeitpunkt?</span></div>
  </div>
</div>
