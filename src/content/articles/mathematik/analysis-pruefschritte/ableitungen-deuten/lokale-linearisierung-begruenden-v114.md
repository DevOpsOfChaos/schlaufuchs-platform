---
title: Lokale Linearisierung begründen
description: Kleine Änderungen mit Tangentenidee abschätzen
subject: mathematik
...
learningGoals:
- Du erklärst Lokale Linearisierung begründen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Die Näherung wird weit außerhalb des Punktes benutzt.
...
keyTakeaways:
- Lokale Linearisierung begründen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Lokale Linearisierung begründen** ist bewusst als kleines Unterthema angelegt. Kleine Änderungen mit Tangentenidee abschätzen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Messwert ändert sich nur wenig um einen Arbeitspunkt.</h3>
  <p>Die wichtige Frage lautet: <strong>Wie nah bleibt die Abschätzung am Bezugspunkt?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-lokale-linearisierung-begruenden-v114.svg" alt="Lernillustration zu Lokale Linearisierung begründen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Näherung wird weit außerhalb des Punktes benutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wie nah bleibt die Abschätzung am Bezugspunkt?</span></div>
  </div>
</div>
