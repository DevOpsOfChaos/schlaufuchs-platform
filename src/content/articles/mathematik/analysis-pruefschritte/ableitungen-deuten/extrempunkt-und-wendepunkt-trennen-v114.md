---
title: Extrempunkt und Wendepunkt trennen
description: Hochpunkt, Tiefpunkt und Krümmungswechsel nicht verwechseln
subject: mathematik
...
learningGoals:
- Du erklärst Extrempunkt und Wendepunkt trennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Jede waagerechte Tangente wird als Maximum gelesen.
...
keyTakeaways:
- Extrempunkt und Wendepunkt trennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Extrempunkt und Wendepunkt trennen** ist bewusst als kleines Unterthema angelegt. Hochpunkt, Tiefpunkt und Krümmungswechsel nicht verwechseln. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Graph wird flacher, fällt aber weiterhin.</h3>
  <p>Die wichtige Frage lautet: <strong>Wechselt der Funktionswert die Richtung oder nur die Krümmung?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-extrempunkt-und-wendepunkt-trennen-v114.svg" alt="Lernillustration zu Extrempunkt und Wendepunkt trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jede waagerechte Tangente wird als Maximum gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wechselt der Funktionswert die Richtung oder nur die Krümmung?</span></div>
  </div>
</div>
...
Dieses Thema gehört zu **Ableitungen Deuten**, aber es soll nicht das ganze Unterthema ersetzen. Die Seite beantwortet eine einzelne Prüffrage. Andere Seiten können danach benachbarte Fälle, Sonderfälle oder Vertiefungen übernehmen.
