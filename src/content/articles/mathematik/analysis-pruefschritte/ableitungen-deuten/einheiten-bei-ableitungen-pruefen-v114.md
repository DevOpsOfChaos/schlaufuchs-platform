---
title: Einheiten bei Ableitungen prüfen
description: Ableitungseinheiten aus Ausgangsgrößen ableiten
subject: mathematik
...
learningGoals:
- Du erklärst Einheiten bei Ableitungen prüfen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Die Ableitung bekommt dieselbe Einheit wie die Funktion.
...
keyTakeaways:
- Einheiten bei Ableitungen prüfen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Einheiten bei Ableitungen prüfen** ist bewusst als kleines Unterthema angelegt. Ableitungseinheiten aus Ausgangsgrößen ableiten. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Weg wird in Metern und Zeit in Sekunden angegeben.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Einheit entsteht aus y-Einheit geteilt durch x-Einheit?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-einheiten-bei-ableitungen-pruefen-v114.svg" alt="Lernillustration zu Einheiten bei Ableitungen prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Ableitung bekommt dieselbe Einheit wie die Funktion.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Einheit entsteht aus y-Einheit geteilt durch x-Einheit?</span></div>
  </div>
</div>
