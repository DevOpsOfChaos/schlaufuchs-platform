---
title: Tangentensteigung ohne Graphenfehler lesen
description: Steigung als lokale Information statt als Gesamttrend verstehen
subject: mathematik
...
learningGoals:
- Du erklärst Tangentensteigung ohne Graphenfehler lesen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Die ganze Kurve wird als eine Gerade gelesen.
...
keyTakeaways:
- Tangentensteigung ohne Graphenfehler lesen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Tangentensteigung ohne Graphenfehler lesen** ist bewusst als kleines Unterthema angelegt. Steigung als lokale Information statt als Gesamttrend verstehen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Graph ist nur skizziert, aber die Tangente ist eingezeichnet.</h3>
  <p>Die wichtige Frage lautet: <strong>An welcher Stelle soll die Steigung gelten?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-tangentensteigung-ohne-graphenfehler-lesen-v114.svg" alt="Lernillustration zu Tangentensteigung ohne Graphenfehler lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die ganze Kurve wird als eine Gerade gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>An welcher Stelle soll die Steigung gelten?</span></div>
  </div>
</div>
