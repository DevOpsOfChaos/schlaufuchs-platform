---
title: Stammfunktion als Rückweg lesen
description: Ableiten und Aufleiten als zusammengehörige Operationen nutzen
subject: mathematik
section: Feinstruktur Mathematik
topicPath:
- analysis-pruefschritte
- integral-und-flaeche
- stammfunktion-als-rueckweg-lesen-v114
learningGoals:
- Du erklärst Stammfunktion als Rückweg lesen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Stammfunktion als Rückweg lesen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Stammfunktion als Rückweg lesen** ist bewusst als kleines Unterthema angelegt. Ableiten und Aufleiten als zusammengehörige Operationen nutzen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Änderungsrate ist gegeben, der Bestand wird gesucht.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Funktion hätte diese Änderungsrate?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-stammfunktion-als-rueckweg-lesen-v114.svg" alt="Lernillustration zu Stammfunktion als Rückweg lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Konstante wird vergessen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Funktion hätte diese Änderungsrate?</span></div>
  </div>
</div>
