---
title: Fläche unter dem Graphen deuten
description: Integral als aufsummierte Größe verstehen
subject: mathematik
...
learningGoals:
- Du erklärst Fläche unter dem Graphen deuten als klar abgegrenztes Unterthema.
...
commonMistakes:
- Fläche wird nur als geometrische Form gelesen.
...
keyTakeaways:
- Fläche unter dem Graphen deuten wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Fläche unter dem Graphen deuten** ist bewusst als kleines Unterthema angelegt. Integral als aufsummierte Größe verstehen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Leistungskurve beschreibt Verbrauch pro Zeit.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Größe entsteht durch Aufsummieren über die x-Achse?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v114-flaeche-unter-dem-graphen-deuten-v114.svg" alt="Lernillustration zu Fläche unter dem Graphen deuten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Fläche wird nur als geometrische Form gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Größe entsteht durch Aufsummieren über die x-Achse?</span></div>
  </div>
</div>
