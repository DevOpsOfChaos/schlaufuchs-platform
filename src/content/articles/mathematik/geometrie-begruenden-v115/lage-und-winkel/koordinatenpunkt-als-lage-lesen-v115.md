---
title: "Mathematik – Koordinatenpunkt als Lage lesen"
description: "Trainiere Koordinatenpunkt als Lage lesen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: mathematik
...
learningGoals:
  - "Du erklärst Koordinatenpunkt als Lage lesen an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "x- und y-Koordinate werden vertauscht."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welche Bewegung gehört zur ersten und welche zur zweiten Koordinate?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Koordinatenpunkt als Lage lesen."
...
<img src="/schlaufuchs-platform/illustrations/mathematik-koordinatenpunkt-als-lage-lesen-v115.svg" alt="Lernillustration zu Koordinatenpunkt als Lage lesen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Koordinatenpunkt als Lage lesen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welche Bewegung gehört zur ersten und welche zur zweiten Koordinate?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Koordinatenpunkt als Lage lesen</h3>
  <p>Ein Punkt liegt im Koordinatensystem und soll beschrieben werden.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Koordinatenpunkt als Lage lesen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>x- und y-Koordinate werden vertauscht.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: x- und y-Koordinate werden vertauscht. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Koordinatenpunkt als Lage lesen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
