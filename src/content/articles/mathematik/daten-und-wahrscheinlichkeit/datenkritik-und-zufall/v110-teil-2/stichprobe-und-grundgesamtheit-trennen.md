---
title: "Mathematik – Stichprobe und Grundgesamtheit trennen"
description: "Lerne Stichprobe und Grundgesamtheit trennen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Stichprobe und Grundgesamtheit trennen als eigenes Unterthema."
...
commonMistakes:
  - "Das Ergebnis wird direkt auf alle Menschen übertragen."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Stichprobe und Grundgesamtheit trennen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Stichprobe und Grundgesamtheit trennen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Umfrage befragt nur eine kleine Gruppe einer Schule.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v110-stichprobe-und-grundgesamtheit-trennen.svg" alt="Lernillustration zu Stichprobe und Grundgesamtheit trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Das Ergebnis wird direkt auf alle Menschen übertragen.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Frage, wer befragt wurde und für wen die Aussage gelten soll.</span></div>
  </div>
</div>
