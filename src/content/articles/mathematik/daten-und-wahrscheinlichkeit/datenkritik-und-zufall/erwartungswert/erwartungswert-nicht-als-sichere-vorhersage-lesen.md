---
title: "Mathematik – Erwartungswert nicht als sichere Vorhersage lesen"
description: "Lerne Erwartungswert als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Erwartungswert als enges Unterthema."
...
keyTakeaways:
  - "Erwartungswert wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Erwartungswert** ist bewusst als kleines Unterthema angelegt. Lerne Erwartungswert als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Spiel hat einen positiven Erwartungswert über viele Runden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-erwartungswert-nicht-als-sichere-vorhersage-lesen.svg" alt="Lernillustration zu Erwartungswert." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Erwartungswert wird als Ergebnis der nächsten Runde verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Trenne langfristigen Mittelwert und einzelnes Zufallsergebnis.</span></div>
  </div>
</div>
