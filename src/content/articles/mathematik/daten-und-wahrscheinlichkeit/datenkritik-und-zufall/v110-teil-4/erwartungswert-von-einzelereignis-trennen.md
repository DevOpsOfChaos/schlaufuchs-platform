---
title: "Mathematik – Erwartungswert von Einzelereignis trennen"
description: "Lerne Erwartungswert von Einzelereignis trennen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Erwartungswert von Einzelereignis trennen als eigenes Unterthema."
...
commonMistakes:
  - "Der Erwartungswert wird als Ergebnis der nächsten Runde verstanden."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Erwartungswert von Einzelereignis trennen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Erwartungswert von Einzelereignis trennen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Spiel hat langfristig einen mittleren Gewinn, aber einzelne Runden schwanken.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v110-erwartungswert-von-einzelereignis-trennen.svg" alt="Lernillustration zu Erwartungswert von Einzelereignis trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Der Erwartungswert wird als Ergebnis der nächsten Runde verstanden.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Deute den Erwartungswert als langfristigen Durchschnitt vieler Wiederholungen.</span></div>
  </div>
</div>
...
```text
Schätzen → Rechnen → Einheit prüfen → Gegenprobe
```
