---
title: "Mathematik – Gegenereignis gezielt nutzen"
description: "Lerne Gegenereignis als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
topicPath:
  ...
  - "wahrscheinlichkeit"
  - "gegenereignis-gezielt-nutzen"
learningGoals:
  - "Du erklärst Gegenereignis als enges Unterthema."
...
commonMistakes:
  - "Alle passenden Fälle werden umständlich einzeln gezählt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Gegenereignis wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Gegenereignis** ist bewusst als kleines Unterthema angelegt. Lerne Gegenereignis als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Mindestens ein Treffer soll berechnet werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-gegenereignis-gezielt-nutzen.svg" alt="Lernillustration zu Gegenereignis." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Alle passenden Fälle werden umständlich einzeln gezählt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob das Gegenereignis einfacher ist.</span></div>
  </div>
</div>
