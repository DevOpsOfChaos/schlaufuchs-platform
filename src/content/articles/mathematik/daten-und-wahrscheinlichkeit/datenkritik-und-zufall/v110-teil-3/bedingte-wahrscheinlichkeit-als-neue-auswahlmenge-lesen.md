---
title: "Mathematik – Bedingte Wahrscheinlichkeit als neue Auswahlmenge lesen"
description: "Lerne Bedingte Wahrscheinlichkeit als neue Auswahlmenge lesen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Bedingte Wahrscheinlichkeit als neue Auswahlmenge lesen als eigenes Unterthema."
...
commonMistakes:
  - "Die ursprüngliche Gesamtmenge wird weiter als Nenner genutzt."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Bedingte Wahrscheinlichkeit als neue Auswahlmenge lesen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Bedingte Wahrscheinlichkeit als neue Auswahlmenge lesen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Gesucht ist die Wahrscheinlichkeit unter einer Zusatzbedingung.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v110-bedingte-wahrscheinlichkeit-als-neue-auswahlmenge-lesen.svg" alt="Lernillustration zu Bedingte Wahrscheinlichkeit als neue Auswahlmenge lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Die ursprüngliche Gesamtmenge wird weiter als Nenner genutzt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Begrenze zuerst die Auswahlmenge auf die Bedingung.</span></div>
  </div>
</div>
