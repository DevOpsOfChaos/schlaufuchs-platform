---
title: "Mathematik – Verzerrte Stichprobe erkennen"
description: "Lerne Verzerrte Stichprobe als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Verzerrte Stichprobe als enges Unterthema."
...
commonMistakes:
  - "Jedes Umfrageergebnis wird als repräsentativ behandelt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Verzerrte Stichprobe wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Verzerrte Stichprobe** ist bewusst als kleines Unterthema angelegt. Lerne Verzerrte Stichprobe als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Umfrage wird nur in einer sehr speziellen Gruppe durchgeführt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-verzerrte-stichprobe-erkennen.svg" alt="Lernillustration zu Verzerrte Stichprobe." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jedes Umfrageergebnis wird als repräsentativ behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Vergleiche Stichprobe und Grundgesamtheit ausdrücklich.</span></div>
  </div>
</div>
