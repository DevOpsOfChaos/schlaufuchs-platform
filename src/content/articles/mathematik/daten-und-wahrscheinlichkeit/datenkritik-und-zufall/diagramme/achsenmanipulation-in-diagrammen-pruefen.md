---
title: "Mathematik – Achsenmanipulation in Diagrammen prüfen"
description: "Lerne Diagrammachse als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Diagrammachse als enges Unterthema."
...
commonMistakes:
  - "Die optische Wirkung wird direkt als großer Unterschied gelesen."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Diagrammachse wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Diagrammachse** ist bewusst als kleines Unterthema angelegt. Lerne Diagrammachse als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Säulendiagramm beginnt nicht bei null und wirkt dramatisch.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-achsenmanipulation-in-diagrammen-pruefen.svg" alt="Lernillustration zu Diagrammachse." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die optische Wirkung wird direkt als großer Unterschied gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe Achsenstart, Skalierung und absolute Werte.</span></div>
  </div>
</div>
