---
title: "Mathematik – Funktionswert und Änderungsrate unterscheiden"
description: "Lerne Funktionswert und Änderungsrate als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Funktionswert und Änderungsrate als enges Unterthema."
...
commonMistakes:
  - "Höhe und Geschwindigkeit werden gleichgesetzt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Funktionswert und Änderungsrate wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Funktionswert und Änderungsrate** ist bewusst als kleines Unterthema angelegt. Lerne Funktionswert und Änderungsrate als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Graph zeigt Höhe über Zeit und die Steigung wird gefragt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-funktionswert-und-aenderungsrate-unterscheiden.svg" alt="Lernillustration zu Funktionswert und Änderungsrate." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Höhe und Geschwindigkeit werden gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Frage, ob ein Wert am Graphen oder eine Änderung pro Einheit gesucht ist.</span></div>
  </div>
</div>
...
```text
Gegebenes markieren → Fachbegriff wählen → Rechnung prüfen → Gegenbeispiel bilden
```
