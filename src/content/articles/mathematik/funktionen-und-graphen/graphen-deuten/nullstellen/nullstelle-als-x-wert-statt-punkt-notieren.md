---
title: "Mathematik – Nullstelle als x-Wert statt Punkt notieren"
...
<div class="example-card">
  ...
  <h3>Ein Graph schneidet die x-Achse bei einem sichtbaren Punkt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v111-nullstelle-als-x-wert-statt-punkt-notieren.svg" alt="Lernillustration zu Nullstelle als x-Wert." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Nullstelle wird als ganzer Punkt oder als y-Wert notiert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe: Bei einer Nullstelle gilt f(x) = 0, gesucht ist der x-Wert.</span></div>
  </div>
</div>
