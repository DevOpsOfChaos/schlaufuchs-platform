---
title: "Mathematik – Steigung im Sachkontext als Änderung pro Einheit lesen"
description: "Lerne Steigung im Sachkontext als Änderung pro Einheit lesen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "mathematik"
section: "Funktionen"
...
**Steigung im Sachkontext als Änderung pro Einheit lesen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Graph beschreibt Kosten pro gefahrenem Kilometer.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v110-steigung-im-sachkontext-als-aenderung-pro-einheit-lesen.svg" alt="Lernillustration zu Steigung im Sachkontext als Änderung pro Einheit lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Steigung wird nur als Zahl ohne Bedeutung gelesen.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Formuliere die Einheit der Steigung als Änderung pro x-Einheit.</span></div>
  </div>
</div>
