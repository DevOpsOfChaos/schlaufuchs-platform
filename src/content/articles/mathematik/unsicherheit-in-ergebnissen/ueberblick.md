...
Unsicherheit bedeutet nicht Unwissen, sondern beschreibt, wie genau oder belastbar ein Ergebnis im gegebenen Kontext ist. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Unsicherheit in Ergebnissen](/schlaufuchs-platform/images/overviews/v147/unsicherheit-in-ergebnissen.svg)

*Überblick über Unsicherheit als Bestandteil von Messungen, Datenanalysen, Modellen und Prognosen.*

## Grundidee

Unsicherheit bedeutet nicht Unwissen, sondern beschreibt, wie genau oder belastbar ein Ergebnis im gegebenen Kontext ist. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Unsicherheit in Ergebnissen hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Messfehler:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Stichprobe:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Modellannahme:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Intervall:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Unsicherheit bedeutet nicht Unwissen, sondern beschreibt, wie genau oder belastbar ein Ergebnis im gegebenen Kontext ist. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
