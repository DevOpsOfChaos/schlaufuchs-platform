---
title: "Mathematik – Modellannahmen bei Funktionen offenlegen"
description: "Prüfe bei Funktionsmodellen, welche Annahmen gelten, welcher Bereich sinnvoll ist und wo das Modell nicht mehr passt."
subject: "mathematik"
section: "Funktionen"
topicPath:
  - "funktionen"
...
learningGoals:
  - "Du erklärst die Kernidee von „Modellieren“ in eigenen Worten."
...
commonMistakes:
  - "negative Werte unkritisch nutzen"
  - "Formel ohne Kontext übernehmen"
  - "Modell und Wirklichkeit verwechseln"
keyTakeaways:
  - "Modellieren wird klarer, wenn Zustand, Ursache und Prüfschritt getrennt werden."
...
<div class="example-card">
  ...
  <h3>Modellieren: kleine Frage statt Sammelbox</h3>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <ul>
        <li>Einheiten werden genannt</li>
        <li>Definitionsbereich passt zur Situation</li>
        <li>Modellgrenze ist sichtbar</li>
      </ul>
    </div>
    <div class="compare-item">
      <strong>Typische Stolperstelle</strong>
      <ul>
        <li>negative Werte unkritisch nutzen</li>
        <li>Formel ohne Kontext übernehmen</li>
        <li>Modell und Wirklichkeit verwechseln</li>
      </ul>
    </div>
  </div>
</div>
...
Diese Seite gehört zum Unterthema **funktionen / modellieren-und-pruefen**. Sie soll nicht alle angrenzenden Fragen mitlösen. Genau diese Trennung macht den Bereich übersichtlicher: erst die kleine Denkentscheidung verstehen, dann bei Bedarf zum nächsten Unterthema wechseln.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Modellieren bleibt lernbar, wenn es als eigenes Unterthema mit klarer Gegenprobe behandelt wird.</p>
</div>
