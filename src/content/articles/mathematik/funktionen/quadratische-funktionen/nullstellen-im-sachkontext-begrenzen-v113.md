---
title: "Nullstellen im Sachkontext begrenzen"
description: "Lerne Nullstellen im Sachkontext begrenzen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Nullstellen im Sachkontext begrenzen als enges Unterthema."
...
commonMistakes:
  - "Beide rechnerischen Lösungen werden ungeprüft übernommen."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Nullstellen im Sachkontext begrenzen wird über eine kleine Trennkante verständlich."
...
**Nullstellen im Sachkontext begrenzen** ist bewusst als kleines Unterthema angelegt. Lerne Nullstellen im Sachkontext begrenzen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine quadratische Gleichung liefert zwei Lösungen, aber nur eine passt zur Situation.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-nullstellen-im-sachkontext-begrenzen-v113.svg" alt="Lernillustration zu Nullstellen im Sachkontext begrenzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Beide rechnerischen Lösungen werden ungeprüft übernommen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Lösung passt zum Sachkontext und zu den Einheiten?</span></div>
  </div>
</div>
