---
title: "Steigung aus zwei Punkten bestimmen"
description: "Lerne Steigung aus zwei Punkten bestimmen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst Steigung aus zwei Punkten bestimmen als enges Unterthema."
...
commonMistakes:
  - "Gesamtänderung und Änderung pro x-Schritt werden verwechselt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Steigung aus zwei Punkten bestimmen wird über eine kleine Trennkante verständlich."
...
**Steigung aus zwei Punkten bestimmen** ist bewusst als kleines Unterthema angelegt. Lerne Steigung aus zwei Punkten bestimmen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Messpunkte liegen auf einer Geraden und die Änderung pro Schritt ist gesucht.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v113-steigung-aus-zwei-punkten-bestimmen-v113.svg" alt="Lernillustration zu Steigung aus zwei Punkten bestimmen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Gesamtänderung und Änderung pro x-Schritt werden verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Teilst du die y-Änderung durch die x-Änderung?</span></div>
  </div>
</div>
