---
title: "Mathematik – Integral als Bilanz statt nur Fläche lesen"
description: "Lerne Integral als Bilanz als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
subject: "mathematik"
section: "Funktionen"
topicPath:
  - "funktionen"
...
learningGoals:
  - "Du erklärst Integral als Bilanz als eigenes Unterthema."
...
commonMistakes:
  - "Alle Flächen werden ohne Vorzeichen addiert."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Integral als Bilanz wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Integral als Bilanz** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Integral als Bilanz als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Graph liegt teils über und teils unter der Achse.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-integral-als-bilanz-statt-nur-flaeche-lesen.svg" alt="Lernillustration zu Integral als Bilanz." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Alle Flächen werden ohne Vorzeichen addiert.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Trenne geometrische Fläche und orientierte Bilanz.</span></div>
  </div>
</div>
