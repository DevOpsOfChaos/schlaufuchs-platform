---
title: "Mathematik – Ableitung als lokale Änderung deuten"
...
<div class="example-card">
  ...
  <h3>Eine Kurve zeigt an verschiedenen Stellen verschiedene Steigungen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/mathematik-v109-ableitung-als-lokale-aenderung-deuten.svg" alt="Lernillustration zu Lokale Änderungsrate." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Durchschnittliche und lokale Änderung werden vermischt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Vergleiche Sekante und Tangente.</span></div>
  </div>
</div>
