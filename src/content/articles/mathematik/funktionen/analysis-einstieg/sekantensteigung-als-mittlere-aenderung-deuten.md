---
title: "Mathematik – Sekantensteigung als mittlere Änderung deuten"
description: "Lerne sekantensteigung als mittlere änderung deuten als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "mathematik"
...
learningGoals:
  - "Du erklärst sekantensteigung als mittlere änderung deuten in einem klaren Kontext."
...
commonMistakes:
  - "Die mittlere Änderung wird als Momentanwert gelesen."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Die Sekante beschreibt eine durchschnittliche Änderung über ein Intervall."
...
**Sekantensteigung als mittlere Änderung deuten** ist bewusst als kleines Unterthema angelegt. Lerne sekantensteigung als mittlere änderung deuten als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwischen zwei Zeitpunkten ändert sich ein Messwert.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Analysis-Einstieg“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Die Sekante beschreibt eine durchschnittliche Änderung über ein Intervall.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Die mittlere Änderung wird als Momentanwert gelesen.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Die Sekante beschreibt eine durchschnittliche Änderung über ein Intervall.</span>
    </div>
  </div>
</div>
...
```text
Situation: Zwischen zwei Zeitpunkten ändert sich ein Messwert.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Analysis-Einstieg** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Die Sekante beschreibt eine durchschnittliche Änderung über ein Intervall.</p>
</div>
