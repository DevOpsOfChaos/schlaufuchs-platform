---
title: "Angreiferannahme formulieren"
description: "Lerne Angreiferannahme formulieren als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Angreiferannahme formulieren als enges Unterthema."
...
commonMistakes:
  - "Sicherheit wird allgemein behauptet."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Angreiferannahme formulieren wird über eine kleine Trennkante verständlich."
...
**Angreiferannahme formulieren** ist bewusst als kleines Unterthema angelegt. Lerne Angreiferannahme formulieren als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine App soll sicher sein, aber der mögliche Angriff ist nicht beschrieben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-angreiferannahme-formulieren-v113.svg" alt="Lernillustration zu Angreiferannahme formulieren." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Sicherheit wird allgemein behauptet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Fähigkeit hat der Angreifer in diesem Szenario?</span></div>
  </div>
</div>
