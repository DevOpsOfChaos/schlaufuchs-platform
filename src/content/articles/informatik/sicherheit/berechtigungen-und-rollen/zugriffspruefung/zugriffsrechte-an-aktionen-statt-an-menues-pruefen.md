---
title: "Informatik – Zugriffsrechte an Aktionen statt an Menüs prüfen"
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v107-zugriffsrechte-an-aktionen-statt-an-menues-p.svg" alt="Lernillustration zu Zugriffsprüfung." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
