---
title: "Informatik – API-Vertrag für Eingabe und Ausgabe beschreiben"
description: "Lerne API-Vertrag als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "informatik"
section: "Sicherheit"
topicPath:
  - "sicherheit"
...
learningGoals:
  - "Du erklärst API-Vertrag in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "API-Vertrag wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**API-Vertrag** ist ein bewusst kleines Unterthema. Lerne API-Vertrag als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Schnittstelle wird stabiler, wenn Eingaben, Ausgaben und Fehlerfälle ausdrücklich beschrieben sind.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v108-api-vertrag-fuer-eingabe-und-ausgabe-beschreiben.svg" alt="Lernillustration zu API-Vertrag." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Erfolgspfad und Fehlerpfad gemeinsam dokumentieren.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Erfolgspfad und Fehlerpfad gemeinsam dokumentieren.</span></div>
