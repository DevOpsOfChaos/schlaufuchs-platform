---
title: "Informatik – Beispielaufruf vor Implementierung schreiben"
description: "Lerne beispielaufruf vor implementierung schreiben als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "informatik"
...
learningGoals:
  - "Du erklärst beispielaufruf vor implementierung schreiben in einem klaren Kontext."
...
**Beispielaufruf vor Implementierung schreiben** ist bewusst als kleines Unterthema angelegt. Lerne beispielaufruf vor implementierung schreiben als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Vor dem Code wird gezeigt, wie die Funktion benutzt werden soll.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Ein Beispielaufruf klärt Namen, Parameter und Rückgabe.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Die Implementierung entsteht ohne Nutzersicht.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Ein Beispielaufruf klärt Namen, Parameter und Rückgabe.</span>
    </div>
  </div>
</div>
...
```text
Situation: Vor dem Code wird gezeigt, wie die Funktion benutzt werden soll.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Ein Beispielaufruf klärt Namen, Parameter und Rückgabe.</p>
</div>
