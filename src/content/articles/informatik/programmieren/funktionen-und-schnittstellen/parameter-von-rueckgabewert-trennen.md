---
title: "Informatik – Parameter von Rückgabewert trennen"
description: "Lerne parameter von rückgabewert trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "informatik"
...
learningGoals:
  - "Du erklärst parameter von rückgabewert trennen in einem klaren Kontext."
...
commonMistakes:
  - "Eine Variable im Inneren wird mit der Schnittstelle verwechselt."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Parameter sind Eingaben; Rückgabewerte sind Ausgaben der Funktion."
...
**Parameter von Rückgabewert trennen** ist bewusst als kleines Unterthema angelegt. Lerne parameter von rückgabewert trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Funktion bekommt einen Wert und liefert ein Ergebnis.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Parameter sind Eingaben; Rückgabewerte sind Ausgaben der Funktion.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Eine Variable im Inneren wird mit der Schnittstelle verwechselt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Parameter sind Eingaben; Rückgabewerte sind Ausgaben der Funktion.</span>
    </div>
  </div>
</div>
...
```text
Situation: Eine Funktion bekommt einen Wert und liefert ein Ergebnis.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Parameter sind Eingaben; Rückgabewerte sind Ausgaben der Funktion.</p>
</div>
