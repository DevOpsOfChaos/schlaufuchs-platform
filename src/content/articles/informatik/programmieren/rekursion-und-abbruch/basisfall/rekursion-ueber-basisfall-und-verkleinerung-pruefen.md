...
description: "Lerne Rekursionsbasis als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Rekursionsbasis in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Rekursionsbasis wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Rekursionsbasis** ist ein bewusst kleines Unterthema. Lerne Rekursionsbasis als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Rekursion braucht einen Basisfall und einen Schritt, der das Problem wirklich kleiner macht.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v108-rekursion-ueber-basisfall-und-verkleinerung-pruefe.svg" alt="Lernillustration zu Rekursionsbasis." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Basisfall und Verkleinerung getrennt markieren.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Basisfall und Verkleinerung getrennt markieren.</span></div>
