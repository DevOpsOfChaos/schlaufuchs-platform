---
title: "Schleifenvariable nicht im Rumpf verstecken"
description: "Lerne Schleifenvariable nicht im Rumpf verstecken als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Schleifenvariable nicht im Rumpf verstecken als enges Unterthema."
...
commonMistakes:
  - "Die Zählregel im Schleifenkopf wird allein betrachtet."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Schleifenvariable nicht im Rumpf verstecken wird über eine kleine Trennkante verständlich."
...
**Schleifenvariable nicht im Rumpf verstecken** ist bewusst als kleines Unterthema angelegt. Lerne Schleifenvariable nicht im Rumpf verstecken als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Schleife verändert ihren Zähler zusätzlich im Inneren.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-schleifenvariable-nicht-im-rumpf-verstecken-v113.svg" alt="Lernillustration zu Schleifenvariable nicht im Rumpf verstecken." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Zählregel im Schleifenkopf wird allein betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wird die Schleifenvariable im Rumpf noch einmal verändert?</span></div>
  </div>
</div>
