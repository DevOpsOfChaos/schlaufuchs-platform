---
title: "Ganzzahl und Kommazahl trennen"
description: "Lerne Ganzzahl und Kommazahl trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
**Ganzzahl und Kommazahl trennen** ist bewusst als kleines Unterthema angelegt. Lerne Ganzzahl und Kommazahl trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Division soll einen Anteil liefern, aber beide Operanden sind ganze Zahlen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-ganzzahl-und-kommazahl-trennen-v113.svg" alt="Lernillustration zu Ganzzahl und Kommazahl trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Mathematische Division und Programmiersprachen-Division werden verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Datentypen haben die Operanden beim Teilen?</span></div>
  </div>
</div>
