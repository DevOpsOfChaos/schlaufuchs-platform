---
title: "Informatik – Normalisierung als Anti-Doppelungsstrategie nutzen"
...
<div class="example-card">
  ...
  <h3>Kundendaten stehen in vielen Bestellzeilen mehrfach.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v110-normalisierung-als-anti-doppelungsstrategie-nutzen.svg" alt="Lernillustration zu Normalisierung als Anti-Doppelungsstrategie nutzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Doppelung wird als praktisch empfunden, bis Änderung nötig wird.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Lagere wiederholte Stammdaten in eine eigene Tabelle aus.</span></div>
  </div>
</div>
