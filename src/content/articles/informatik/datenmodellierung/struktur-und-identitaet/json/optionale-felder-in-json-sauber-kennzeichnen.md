---
title: "Informatik – Optionale Felder in JSON sauber kennzeichnen"
description: "Lerne Optionale Datenfelder als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Optionale Datenfelder als enges Unterthema."
...
commonMistakes:
  - "Fehlendes Feld und leerer Wert werden gleich behandelt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Optionale Datenfelder wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Optionale Datenfelder** ist bewusst als kleines Unterthema angelegt. Lerne Optionale Datenfelder als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein API-Objekt enthält manchmal eine Telefonnummer und manchmal nicht.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-optionale-felder-in-json-sauber-kennzeichnen.svg" alt="Lernillustration zu Optionale Datenfelder." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Fehlendes Feld und leerer Wert werden gleich behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Unterscheide nicht vorhanden, leer und unbekannt.</span></div>
  </div>
</div>
