---
title: "Informatik – Arrange, Act, Assert in Tests erkennen"
...
<div class="example-card">
  ...
  <h3>Ein Test legt Daten an, führt Code aus und prüft ein Ergebnis.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v109-arrange-act-assert-in-tests-erkennen.svg" alt="Lernillustration zu Arrange, Act, Assert." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Vorbereitung und Prüfung stehen durcheinander.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Gliedere Testdaten, Aktion und Erwartung.</span></div>
  </div>
</div>
