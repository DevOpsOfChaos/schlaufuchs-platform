---
title: "Informatik – Zustandsautomat mit Übergangstabelle prüfen"
description: "Lerne Übergangstabelle als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "informatik"
section: "Algorithmen"
topicPath:
  - "algorithmen"
...
learningGoals:
  - "Du erklärst Übergangstabelle in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Übergangstabelle wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Übergangstabelle** ist ein bewusst kleines Unterthema. Lerne Übergangstabelle als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Automat wird verständlich, wenn Zustand, Eingabe und Folgezustand tabellarisch geprüft werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v108-zustandsautomat-mit-uebergangstabelle-pruefen.svg" alt="Lernillustration zu Übergangstabelle." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Keine Aktion ohne definierten Zustand.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Keine Aktion ohne definierten Zustand.</span></div>
