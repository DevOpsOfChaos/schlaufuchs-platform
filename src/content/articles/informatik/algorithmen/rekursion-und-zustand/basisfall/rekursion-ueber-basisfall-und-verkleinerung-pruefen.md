---
title: "Informatik – Rekursion über Basisfall und Verkleinerung prüfen"
description: "Lerne Rekursionsbasis und Verkleinerung als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
subject: "informatik"
section: "Algorithmen"
topicPath:
  - "algorithmen"
...
learningGoals:
  - "Du erklärst Rekursionsbasis und Verkleinerung als eigenes Unterthema."
...
commonMistakes:
  - "Nur der Selbstaufruf wird gesehen, nicht der Stoppfall."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Rekursionsbasis und Verkleinerung wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Rekursionsbasis und Verkleinerung** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Rekursionsbasis und Verkleinerung als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Funktion ruft sich selbst mit kleinerem Wert auf.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v109-rekursion-ueber-basisfall-und-verkleinerung-pruefen.svg" alt="Lernillustration zu Rekursionsbasis und Verkleinerung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Nur der Selbstaufruf wird gesehen, nicht der Stoppfall.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Prüfe Basisfall und Annäherung daran.</span></div>
  </div>
</div>
...
```text
Eingabe → Regel → Ausgabe → Randfall
```
