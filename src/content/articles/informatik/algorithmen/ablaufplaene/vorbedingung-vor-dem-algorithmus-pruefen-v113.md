---
title: "Vorbedingung vor dem Algorithmus prüfen"
description: "Lerne Vorbedingung vor dem Algorithmus prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Vorbedingung vor dem Algorithmus prüfen als enges Unterthema."
...
commonMistakes:
  - "Der Ablauf wird isoliert betrachtet."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Vorbedingung vor dem Algorithmus prüfen wird über eine kleine Trennkante verständlich."
...
**Vorbedingung vor dem Algorithmus prüfen** ist bewusst als kleines Unterthema angelegt. Lerne Vorbedingung vor dem Algorithmus prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Algorithmus sortiert nur korrekt, wenn die Eingabe bestimmte Eigenschaften hat.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-vorbedingung-vor-dem-algorithmus-pruefen-v113.svg" alt="Lernillustration zu Vorbedingung vor dem Algorithmus prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Ablauf wird isoliert betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Bedingung muss vor dem Start gelten?</span></div>
  </div>
</div>
