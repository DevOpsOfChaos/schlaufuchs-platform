---
title: "Abbruchbedingung sichtbar machen"
description: "Lerne Abbruchbedingung sichtbar machen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
**Abbruchbedingung sichtbar machen** ist bewusst als kleines Unterthema angelegt. Lerne Abbruchbedingung sichtbar machen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Schleife verarbeitet Daten, könnte aber endlos laufen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-abbruchbedingung-sichtbar-machen-v113.svg" alt="Lernillustration zu Abbruchbedingung sichtbar machen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Schleifenrumpf wird erklärt, der Abbruch aber nicht.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wodurch wird garantiert, dass die Schleife endet?</span></div>
  </div>
</div>
