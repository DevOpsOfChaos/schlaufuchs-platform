---
title: "Stabilität beim Sortieren deuten"
description: "Lerne Stabilität beim Sortieren deuten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Stabilität beim Sortieren deuten als enges Unterthema."
...
commonMistakes:
  - "Sortieren wird nur nach Ergebniswerten bewertet."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Stabilität beim Sortieren deuten wird über eine kleine Trennkante verständlich."
...
**Stabilität beim Sortieren deuten** ist bewusst als kleines Unterthema angelegt. Lerne Stabilität beim Sortieren deuten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Datensätze haben gleiche Schlüssel, aber ihre Reihenfolge soll erhalten bleiben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-stabilitaet-beim-sortieren-deuten-v113.svg" alt="Lernillustration zu Stabilität beim Sortieren deuten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Sortieren wird nur nach Ergebniswerten bewertet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Bleibt die Reihenfolge gleicher Schlüssel erhalten?</span></div>
  </div>
</div>
