---
title: "Informatik – Bedingungen mit Wahrheitstabelle prüfen"
description: "Lerne bedingungen mit wahrheitstabelle prüfen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "informatik"
...
learningGoals:
  - "Du erklärst bedingungen mit wahrheitstabelle prüfen in einem klaren Kontext."
...
**Bedingungen mit Wahrheitstabelle prüfen** ist bewusst als kleines Unterthema angelegt. Lerne bedingungen mit wahrheitstabelle prüfen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine if-Bedingung enthält UND und ODER.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Eine Wahrheitstabelle macht alle Fälle sichtbar.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Nur der gewünschte Fall wird getestet.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Eine Wahrheitstabelle macht alle Fälle sichtbar.</span>
    </div>
  </div>
</div>
...
```text
Situation: Eine if-Bedingung enthält UND und ODER.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Eine Wahrheitstabelle macht alle Fälle sichtbar.</p>
</div>
