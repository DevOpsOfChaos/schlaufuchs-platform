...
Schnittstellenevolution beschreibt die kontrollierte Veränderung einer API über die Zeit. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Schnittstellenevolution](/schlaufuchs-platform/images/overviews/v147/schnittstellenevolution.svg)

*Überblick darüber, wie APIs und Datenformate weiterentwickelt werden, ohne bestehende Nutzer unnötig zu brechen.*

## Grundidee

Schnittstellenevolution beschreibt die kontrollierte Veränderung einer API über die Zeit. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Schnittstellenevolution hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Rückwärtskompatibilität:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Versionierung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Deprecation:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Migrationspfad:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Schnittstellenevolution beschreibt die kontrollierte Veränderung einer API über die Zeit. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
