---
title: Liste und Set unterscheiden
description: Duplikate und Reihenfolge als Auswahlkriterium nutzen
subject: informatik
section: Feinstruktur Informatik
topicPath:
- datenstrukturen
- listen-maps-sets
- liste-und-set-unterscheiden-v114
learningGoals:
- Du erklärst Liste und Set unterscheiden als klar abgegrenztes Unterthema.
...
commonMistakes:
- Ein Set wird verwendet, obwohl Reihenfolge ausgewertet werden soll.
...
keyTakeaways:
- Liste und Set unterscheiden wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Liste und Set unterscheiden** ist bewusst als kleines Unterthema angelegt. Duplikate und Reihenfolge als Auswahlkriterium nutzen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Sammlung enthält Benutzernamen.</h3>
  <p>Die wichtige Frage lautet: <strong>Sind doppelte Werte erlaubt und ist Reihenfolge wichtig?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-liste-und-set-unterscheiden-v114.svg" alt="Lernillustration zu Liste und Set unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Ein Set wird verwendet, obwohl Reihenfolge ausgewertet werden soll.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Sind doppelte Werte erlaubt und ist Reihenfolge wichtig?</span></div>
  </div>
</div>
...
Dieses Thema gehört zu **Listen Maps Sets**, aber es soll nicht das ganze Unterthema ersetzen. Die Seite beantwortet eine einzelne Prüffrage. Andere Seiten können danach benachbarte Fälle, Sonderfälle oder Vertiefungen übernehmen.
