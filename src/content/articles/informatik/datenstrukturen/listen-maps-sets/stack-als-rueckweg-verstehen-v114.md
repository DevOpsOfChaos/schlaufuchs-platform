---
title: Stack als Rückweg verstehen
description: Last-in-first-out an Alltagssituationen erklären
subject: informatik
...
learningGoals:
- Du erklärst Stack als Rückweg verstehen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Stack und Queue werden nur als englische Wörter gelernt.
...
keyTakeaways:
- Stack als Rückweg verstehen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Stack als Rückweg verstehen** ist bewusst als kleines Unterthema angelegt. Last-in-first-out an Alltagssituationen erklären. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Browser-Zurück arbeitet über zuletzt besuchte Seiten.</h3>
  <p>Die wichtige Frage lautet: <strong>Welches Element kommt als nächstes wieder heraus?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-stack-als-rueckweg-verstehen-v114.svg" alt="Lernillustration zu Stack als Rückweg verstehen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Stack und Queue werden nur als englische Wörter gelernt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welches Element kommt als nächstes wieder heraus?</span></div>
  </div>
</div>
