---
title: "Informatik – Array-Zugriff und Listen-Einfügen vergleichen"
description: "Lerne Zugriffskosten als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Zugriffskosten in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Zugriffskosten wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Zugriffskosten** ist ein bewusst kleines Unterthema. Lerne Zugriffskosten als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Datenstrukturen unterscheiden sich danach, welcher Zugriff schnell und welche Änderung teuer ist.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v108-array-zugriff-und-listen-einfuegen-vergleichen.svg" alt="Lernillustration zu Zugriffskosten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Operation nennen, dann passende Struktur begründen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Operation nennen, dann passende Struktur begründen.</span></div>
