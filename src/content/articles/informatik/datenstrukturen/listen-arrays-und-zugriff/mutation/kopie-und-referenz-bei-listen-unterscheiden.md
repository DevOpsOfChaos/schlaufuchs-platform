---
title: "Informatik – Kopie und Referenz bei Listen unterscheiden"
description: "Lerne Mutation als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Mutation als enges Unterthema."
...
**Mutation** ist bewusst als kleines Unterthema angelegt. Lerne Mutation als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Liste wird an eine Funktion übergeben und danach verändert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-kopie-und-referenz-bei-listen-unterscheiden.svg" alt="Lernillustration zu Mutation." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Kopie und gemeinsamer Verweis werden verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob beide Namen auf dieselbe Datenstruktur zeigen.</span></div>
  </div>
</div>
