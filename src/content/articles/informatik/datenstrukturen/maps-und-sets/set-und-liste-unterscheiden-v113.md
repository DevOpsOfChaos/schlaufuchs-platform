---
title: "Set und Liste unterscheiden"
description: "Lerne Set und Liste unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Set und Liste unterscheiden als enges Unterthema."
...
commonMistakes:
  - "Eine Liste wird benutzt und Dopplungen werden später gesucht."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Set und Liste unterscheiden wird über eine kleine Trennkante verständlich."
...
**Set und Liste unterscheiden** ist bewusst als kleines Unterthema angelegt. Lerne Set und Liste unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Doppelte Werte sollen automatisch vermieden werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-set-und-liste-unterscheiden-v113.svg" alt="Lernillustration zu Set und Liste unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Eine Liste wird benutzt und Dopplungen werden später gesucht.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist die Eindeutigkeit Teil der Datenstruktur?</span></div>
  </div>
</div>
