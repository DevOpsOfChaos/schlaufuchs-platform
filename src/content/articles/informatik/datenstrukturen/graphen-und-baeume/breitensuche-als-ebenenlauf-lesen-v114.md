...
learningGoals:
- Du erklärst Breitensuche als Ebenenlauf lesen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Ein tiefer Pfad wird zuerst verfolgt.
...
keyTakeaways:
- Breitensuche als Ebenenlauf lesen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
