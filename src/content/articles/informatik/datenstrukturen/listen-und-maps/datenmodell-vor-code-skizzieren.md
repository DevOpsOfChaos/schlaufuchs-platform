---
title: "Informatik – Datenmodell vor Code skizzieren"
description: "Lerne datenmodell vor code skizzieren als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "informatik"
...
learningGoals:
  - "Du erklärst datenmodell vor code skizzieren in einem klaren Kontext."
...
commonMistakes:
  - "Einzelvariablen wachsen unkontrolliert nebeneinander."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Ein kleines Datenmodell verhindert zufällige Mischstrukturen."
...
**Datenmodell vor Code skizzieren** ist bewusst als kleines Unterthema angelegt. Lerne datenmodell vor code skizzieren als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Namen, Punkte und Status sollen gespeichert werden.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Listen und Maps“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Ein kleines Datenmodell verhindert zufällige Mischstrukturen.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Einzelvariablen wachsen unkontrolliert nebeneinander.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Ein kleines Datenmodell verhindert zufällige Mischstrukturen.</span>
    </div>
  </div>
</div>
...
```text
Situation: Namen, Punkte und Status sollen gespeichert werden.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Listen und Maps** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Ein kleines Datenmodell verhindert zufällige Mischstrukturen.</p>
</div>
