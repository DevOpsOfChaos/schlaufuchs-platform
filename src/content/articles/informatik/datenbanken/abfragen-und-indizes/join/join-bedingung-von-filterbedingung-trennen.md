---
title: "Informatik – Join-Bedingung von Filterbedingung trennen"
description: "Lerne SQL Join als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
topicPath:
  ...
  - "join"
  - "join-bedingung-von-filterbedingung-trennen"
learningGoals:
  - "Du erklärst SQL Join als enges Unterthema."
...
**SQL Join** ist bewusst als kleines Unterthema angelegt. Lerne SQL Join als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Tabellen werden verbunden und zusätzlich gefiltert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-join-bedingung-von-filterbedingung-trennen.svg" alt="Lernillustration zu SQL Join." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Join-Logik und Auswahlbedingung stehen unklar zusammen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Trenne, welche Spalten Tabellen verbinden und welche Zeilen ausgewählt werden.</span></div>
  </div>
</div>
