---
title: "Informatik – WHERE und HAVING in SQL unterscheiden"
...
<div class="example-card">
  ...
  <h3>WHERE filtert Zeilen vor der Gruppierung, HAVING filtert Gruppen nach der Aggregation.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v108-where-und-having-in-sql-unterscheiden.svg" alt="Lernillustration zu WHERE und HAVING." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Vor oder nach GROUP BY entscheiden.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Vor oder nach GROUP BY entscheiden.</span></div>
