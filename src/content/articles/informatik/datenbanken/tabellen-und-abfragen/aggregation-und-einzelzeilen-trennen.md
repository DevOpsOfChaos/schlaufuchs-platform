---
title: "Informatik – Aggregation und Einzelzeilen trennen"
description: "Lerne aggregation und einzelzeilen trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "informatik"
...
learningGoals:
  - "Du erklärst aggregation und einzelzeilen trennen in einem klaren Kontext."
...
**Aggregation und Einzelzeilen trennen** ist bewusst als kleines Unterthema angelegt. Lerne aggregation und einzelzeilen trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Umsätze sollen nach Kategorie summiert werden.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Tabellen und Abfragen“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Aggregation fasst mehrere Zeilen zu Gruppenwerten zusammen.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Summen werden mit einzelnen Datensätzen vermischt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Aggregation fasst mehrere Zeilen zu Gruppenwerten zusammen.</span>
    </div>
  </div>
</div>
...
```text
Situation: Umsätze sollen nach Kategorie summiert werden.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Tabellen und Abfragen** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Aggregation fasst mehrere Zeilen zu Gruppenwerten zusammen.</p>
</div>
