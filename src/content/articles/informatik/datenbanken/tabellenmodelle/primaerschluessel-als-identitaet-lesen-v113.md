---
title: "Primärschlüssel als Identität lesen"
...
<div class="example-card">
  ...
  <h3>Zwei Personen haben denselben Namen, sollen aber getrennte Datensätze bleiben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-primaerschluessel-als-identitaet-lesen-v113.svg" alt="Lernillustration zu Primärschlüssel als Identität lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Name wird als eindeutiger Schlüssel benutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Spalte identifiziert jeden Datensatz eindeutig?</span></div>
  </div>
</div>
