---
title: "Filter und Sortierung trennen"
...
<div class="example-card">
  ...
  <h3>Eine Tabelle soll nur passende Zeilen zeigen und danach geordnet werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-filter-und-sortierung-trennen-v113.svg" alt="Lernillustration zu Filter und Sortierung trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Sortieren wird mit Auswählen verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Werden Zeilen entfernt oder nur in andere Reihenfolge gebracht?</span></div>
  </div>
</div>
