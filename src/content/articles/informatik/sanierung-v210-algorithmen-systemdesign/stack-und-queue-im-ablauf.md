---
title: "Stack und Queue im Ablauf – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Stack und Queue im Ablauf: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "datenstrukturen"
topicPath: ["datenstrukturen", "stack-und-queue-im-ablauf"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "datenstrukturen", "stack-und-queue-im-ablauf", "systemdesign", "v210"]
draft: false
---
![Stack und Queue im Ablauf](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/stack-und-queue-im-ablauf.svg)

## Worum es hier geht

**Stack und Queue im Ablauf** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Stack und Queue im Ablauf wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
