---
title: "Problem in Schritte zerlegen – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Problem in Schritte zerlegen: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "algorithmen"
topicPath: ["algorithmen", "problem-in-schritte-zerlegen"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "algorithmen", "problem-in-schritte-zerlegen", "systemdesign", "v210"]
draft: false
---
![Problem in Schritte zerlegen](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/problem-in-schritte-zerlegen.svg)

## Worum es hier geht

**Problem in Schritte zerlegen** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Problem in Schritte zerlegen wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
