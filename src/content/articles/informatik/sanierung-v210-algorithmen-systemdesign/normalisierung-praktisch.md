---
title: "Normalisierung praktisch – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Normalisierung praktisch: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "datenbanken"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "datenbanken", "normalisierung-praktisch", "systemdesign", "v210"]
draft: false
---
![Normalisierung praktisch](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/normalisierung-praktisch.svg)

## Worum es hier geht

**Normalisierung praktisch** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Normalisierung praktisch wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
