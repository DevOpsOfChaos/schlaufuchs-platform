---
title: "Secrets und Konfiguration – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Secrets und Konfiguration: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "sicherheit"
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "sicherheit", "secrets-und-konfiguration", "systemdesign", "v210"]
draft: false
---
![Secrets und Konfiguration](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/secrets-und-konfiguration.svg)

## Worum es hier geht

**Secrets und Konfiguration** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Secrets und Konfiguration wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
