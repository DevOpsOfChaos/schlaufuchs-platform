---
title: "Begründung für Datenstruktur – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Begründung für Datenstruktur: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "prueftraining"
topicPath: ["prueftraining", "begruendung-fuer-datenstruktur"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "prueftraining", "begruendung-fuer-datenstruktur", "systemdesign", "v210"]
draft: false
---
![Begründung für Datenstruktur](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/begruendung-fuer-datenstruktur.svg)

## Worum es hier geht

**Begründung für Datenstruktur** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Begründung für Datenstruktur wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
