---
title: "Latenz und Durchsatz trennen – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Latenz und Durchsatz trennen: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "netzwerke"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "netzwerke", "latenz-und-durchsatz-trennen", "systemdesign", "v210"]
draft: false
---
![Latenz und Durchsatz trennen](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/latenz-und-durchsatz-trennen.svg)

## Worum es hier geht

**Latenz und Durchsatz trennen** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Latenz und Durchsatz trennen wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
