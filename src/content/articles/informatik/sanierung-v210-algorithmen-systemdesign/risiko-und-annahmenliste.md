---
title: "Risiko und Annahmenliste – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Risiko und Annahmenliste: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "projektpraxis"
topicPath: ["projektpraxis", "risiko-und-annahmenliste"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "projektpraxis", "risiko-und-annahmenliste", "systemdesign", "v210"]
draft: false
---
![Risiko und Annahmenliste](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/risiko-und-annahmenliste.svg)

## Worum es hier geht

**Risiko und Annahmenliste** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Risiko und Annahmenliste wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
