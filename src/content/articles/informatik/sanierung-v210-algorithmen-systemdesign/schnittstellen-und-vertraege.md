---
title: "Schnittstellen und Verträge – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Schnittstellen und Verträge: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
tags: ["informatik", "softwareentwurf", "schnittstellen-und-vertraege", "systemdesign", "v210"]
draft: false
---
![Schnittstellen und Verträge](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/schnittstellen-und-vertraege.svg)

## Worum es hier geht

**Schnittstellen und Verträge** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Schnittstellen und Verträge wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
