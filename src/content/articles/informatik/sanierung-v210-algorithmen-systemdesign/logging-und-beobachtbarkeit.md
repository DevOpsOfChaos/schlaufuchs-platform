---
title: "Logging und Beobachtbarkeit – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Logging und Beobachtbarkeit: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "tests-debugging", "logging-und-beobachtbarkeit", "systemdesign", "v210"]
draft: false
---
![Logging und Beobachtbarkeit](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/logging-und-beobachtbarkeit.svg)

## Worum es hier geht

**Logging und Beobachtbarkeit** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Logging und Beobachtbarkeit wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
