---
title: "Prozess, Thread und Scheduler – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Prozess, Thread und Scheduler: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "systeme"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "systeme", "prozess-thread-und-scheduler", "systemdesign", "v210"]
draft: false
---
![Prozess, Thread und Scheduler](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/prozess-thread-und-scheduler.svg)

## Worum es hier geht

**Prozess, Thread und Scheduler** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Prozess, Thread und Scheduler wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
