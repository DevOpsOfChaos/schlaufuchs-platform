---
title: "Bias und Repräsentation – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Bias und Repräsentation: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "ki-datenpraxis"
topicPath: ["ki-datenpraxis", "bias-und-repraesentation"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "ki-datenpraxis", "bias-und-repraesentation", "systemdesign", "v210"]
draft: false
---
![Bias und Repräsentation](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/bias-und-repraesentation.svg)

## Worum es hier geht

**Bias und Repräsentation** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Bias und Repräsentation wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
