---
title: "Wartbarkeit im Team – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Wartbarkeit im Team: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "projektpraxis"
topicPath: ["projektpraxis", "wartbarkeit-im-team"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "projektpraxis", "wartbarkeit-im-team", "systemdesign", "v210"]
draft: false
---
![Wartbarkeit im Team](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/wartbarkeit-im-team.svg)

## Worum es hier geht

**Wartbarkeit im Team** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Wartbarkeit im Team wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
