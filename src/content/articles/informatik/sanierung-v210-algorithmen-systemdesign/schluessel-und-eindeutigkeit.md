---
title: "Schlüssel und Eindeutigkeit – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Schlüssel und Eindeutigkeit: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "datenbanken"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "datenbanken", "schluessel-und-eindeutigkeit", "systemdesign", "v210"]
draft: false
---
![Schlüssel und Eindeutigkeit](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/schluessel-und-eindeutigkeit.svg)

## Worum es hier geht

**Schlüssel und Eindeutigkeit** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Schlüssel und Eindeutigkeit wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
