---
title: "Entscheidungsprotokoll ADR – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Entscheidungsprotokoll ADR: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
tags: ["informatik", "projektpraxis", "entscheidungsprotokoll-adr", "systemdesign", "v210"]
draft: false
---
![Entscheidungsprotokoll ADR](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/entscheidungsprotokoll-adr.svg)

## Worum es hier geht

**Entscheidungsprotokoll ADR** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Entscheidungsprotokoll ADR wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
