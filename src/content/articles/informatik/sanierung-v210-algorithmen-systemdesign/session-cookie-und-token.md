---
title: "Session, Cookie und Token – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Session, Cookie und Token: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "web-systeme"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "web-systeme", "session-cookie-und-token", "systemdesign", "v210"]
draft: false
---
![Session, Cookie und Token](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/session-cookie-und-token.svg)

## Worum es hier geht

**Session, Cookie und Token** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Session, Cookie und Token wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
