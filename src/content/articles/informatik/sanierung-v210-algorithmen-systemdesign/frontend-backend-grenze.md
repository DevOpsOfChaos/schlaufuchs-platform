---
title: "Frontend-Backend-Grenze – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Frontend-Backend-Grenze: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "web-systeme"
topicPath: ["web-systeme", "frontend-backend-grenze"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "web-systeme", "frontend-backend-grenze", "systemdesign", "v210"]
draft: false
---
![Frontend-Backend-Grenze](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/frontend-backend-grenze.svg)

## Worum es hier geht

**Frontend-Backend-Grenze** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Frontend-Backend-Grenze wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
