---
title: "Graphen, Knoten und Kanten – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Graphen, Knoten und Kanten: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "datenstrukturen"
topicPath: ["datenstrukturen", "graphen-knoten-und-kanten"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
tags: ["informatik", "datenstrukturen", "graphen-knoten-und-kanten", "systemdesign", "v210"]
draft: false
---
![Graphen, Knoten und Kanten](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/graphen-knoten-und-kanten.svg)

## Worum es hier geht

**Graphen, Knoten und Kanten** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Graphen, Knoten und Kanten wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
