---
title: "Ressourcenlimit und Backpressure – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Ressourcenlimit und Backpressure: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "systeme"
...
tags: ["informatik", "systeme", "ressourcenlimit-und-backpressure", "systemdesign", "v210"]
draft: false
---
![Ressourcenlimit und Backpressure](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/ressourcenlimit-und-backpressure.svg)

## Worum es hier geht

**Ressourcenlimit und Backpressure** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Ressourcenlimit und Backpressure wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
