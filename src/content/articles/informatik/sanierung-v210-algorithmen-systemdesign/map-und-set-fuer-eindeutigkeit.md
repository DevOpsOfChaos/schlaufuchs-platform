---
title: "Map und Set für Eindeutigkeit – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Map und Set für Eindeutigkeit: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "datenstrukturen"
topicPath: ["datenstrukturen", "map-und-set-fuer-eindeutigkeit"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "datenstrukturen", "map-und-set-fuer-eindeutigkeit", "systemdesign", "v210"]
draft: false
---
![Map und Set für Eindeutigkeit](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/map-und-set-fuer-eindeutigkeit.svg)

## Worum es hier geht

**Map und Set für Eindeutigkeit** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Map und Set für Eindeutigkeit wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
