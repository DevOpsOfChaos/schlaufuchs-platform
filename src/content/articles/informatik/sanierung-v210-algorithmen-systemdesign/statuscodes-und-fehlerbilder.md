---
title: "Statuscodes und Fehlerbilder – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Statuscodes und Fehlerbilder: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "netzwerke"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "netzwerke", "statuscodes-und-fehlerbilder", "systemdesign", "v210"]
draft: false
---
![Statuscodes und Fehlerbilder](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/statuscodes-und-fehlerbilder.svg)

## Worum es hier geht

**Statuscodes und Fehlerbilder** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Statuscodes und Fehlerbilder wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
