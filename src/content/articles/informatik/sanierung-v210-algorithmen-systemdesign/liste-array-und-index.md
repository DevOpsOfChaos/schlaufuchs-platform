---
title: "Liste, Array und Index – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Liste, Array und Index: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "datenstrukturen"
topicPath: ["datenstrukturen", "liste-array-und-index"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
tags: ["informatik", "datenstrukturen", "liste-array-und-index", "systemdesign", "v210"]
draft: false
---
![Liste, Array und Index](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/liste-array-und-index.svg)

## Worum es hier geht

**Liste, Array und Index** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Liste, Array und Index wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
