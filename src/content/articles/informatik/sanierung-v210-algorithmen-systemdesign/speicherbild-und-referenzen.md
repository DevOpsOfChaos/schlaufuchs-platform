---
title: "Speicherbild und Referenzen – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Speicherbild und Referenzen: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "datenstrukturen", "speicherbild-und-referenzen", "systemdesign", "v210"]
draft: false
---
![Speicherbild und Referenzen](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/speicherbild-und-referenzen.svg)

## Worum es hier geht

**Speicherbild und Referenzen** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Speicherbild und Referenzen wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
