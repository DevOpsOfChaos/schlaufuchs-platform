---
title: "Aufgabe lesen vor Code – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Aufgabe lesen vor Code: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "prueftraining"
topicPath: ["prueftraining", "aufgabe-lesen-vor-code"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "prueftraining", "aufgabe-lesen-vor-code", "systemdesign", "v210"]
draft: false
---
![Aufgabe lesen vor Code](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/aufgabe-lesen-vor-code.svg)

## Worum es hier geht

**Aufgabe lesen vor Code** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Aufgabe lesen vor Code wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
