---
title: "Regressionen verhindern – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Regressionen verhindern: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "tests-debugging", "regressionen-verhindern", "systemdesign", "v210"]
draft: false
---
![Regressionen verhindern](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/regressionen-verhindern.svg)

## Worum es hier geht

**Regressionen verhindern** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Regressionen verhindern wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
