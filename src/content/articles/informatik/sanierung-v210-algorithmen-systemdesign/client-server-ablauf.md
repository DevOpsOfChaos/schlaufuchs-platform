---
title: "Client-Server-Ablauf – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Client-Server-Ablauf: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "netzwerke"
...
tags: ["informatik", "netzwerke", "client-server-ablauf", "systemdesign", "v210"]
draft: false
---
![Client-Server-Ablauf](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/client-server-ablauf.svg)

## Worum es hier geht

**Client-Server-Ablauf** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Client-Server-Ablauf wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
