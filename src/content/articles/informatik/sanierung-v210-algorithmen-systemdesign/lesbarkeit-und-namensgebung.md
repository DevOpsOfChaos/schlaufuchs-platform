---
title: "Lesbarkeit und Namensgebung – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Lesbarkeit und Namensgebung: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "softwareentwurf"
topicPath: ["softwareentwurf", "lesbarkeit-und-namensgebung"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "softwareentwurf", "lesbarkeit-und-namensgebung", "systemdesign", "v210"]
draft: false
---
![Lesbarkeit und Namensgebung](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/lesbarkeit-und-namensgebung.svg)

## Worum es hier geht

**Lesbarkeit und Namensgebung** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Lesbarkeit und Namensgebung wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
