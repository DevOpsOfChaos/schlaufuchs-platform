---
title: "Request, Response und Zustand – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Request, Response und Zustand: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "web-systeme"
...
tags: ["informatik", "web-systeme", "request-response-und-zustand", "systemdesign", "v210"]
draft: false
---
![Request, Response und Zustand](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/request-response-und-zustand.svg)

## Worum es hier geht

**Request, Response und Zustand** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Request, Response und Zustand wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
