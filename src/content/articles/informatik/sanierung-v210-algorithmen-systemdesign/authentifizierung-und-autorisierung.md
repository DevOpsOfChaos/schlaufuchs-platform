---
title: "Authentifizierung und Autorisierung – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Authentifizierung und Autorisierung: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "sicherheit"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "sicherheit", "authentifizierung-und-autorisierung", "systemdesign", "v210"]
draft: false
---
![Authentifizierung und Autorisierung](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/authentifizierung-und-autorisierung.svg)

## Worum es hier geht

**Authentifizierung und Autorisierung** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Authentifizierung und Autorisierung wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
