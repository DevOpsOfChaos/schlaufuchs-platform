---
title: "Dateisystem und Rechte – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Dateisystem und Rechte: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "systeme"
topicPath: ["systeme", "dateisystem-und-rechte"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
tags: ["informatik", "systeme", "dateisystem-und-rechte", "systemdesign", "v210"]
draft: false
---
![Dateisystem und Rechte](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/dateisystem-und-rechte.svg)

## Worum es hier geht

**Dateisystem und Rechte** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Dateisystem und Rechte wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
