---
title: "Rekursion und Abbruch – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Rekursion und Abbruch: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "algorithmen"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "algorithmen", "rekursion-und-abbruch", "systemdesign", "v210"]
draft: false
---
![Rekursion und Abbruch](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/rekursion-und-abbruch.svg)

## Worum es hier geht

**Rekursion und Abbruch** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Rekursion und Abbruch wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
