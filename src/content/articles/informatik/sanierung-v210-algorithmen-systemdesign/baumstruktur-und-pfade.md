---
title: "Baumstruktur und Pfade – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Baumstruktur und Pfade: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "datenstrukturen", "baumstruktur-und-pfade", "systemdesign", "v210"]
draft: false
---
![Baumstruktur und Pfade](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/baumstruktur-und-pfade.svg)

## Worum es hier geht

**Baumstruktur und Pfade** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Baumstruktur und Pfade wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
