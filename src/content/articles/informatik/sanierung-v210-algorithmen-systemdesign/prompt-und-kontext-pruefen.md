---
title: "Prompt und Kontext prüfen – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Prompt und Kontext prüfen: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "ki-datenpraxis"
topicPath: ["ki-datenpraxis", "prompt-und-kontext-pruefen"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "ki-datenpraxis", "prompt-und-kontext-pruefen", "systemdesign", "v210"]
draft: false
---
![Prompt und Kontext prüfen](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/prompt-und-kontext-pruefen.svg)

## Worum es hier geht

**Prompt und Kontext prüfen** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Prompt und Kontext prüfen wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
