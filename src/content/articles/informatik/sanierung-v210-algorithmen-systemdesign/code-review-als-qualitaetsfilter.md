---
title: "Code Review als Qualitätsfilter – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Code Review als Qualitätsfilter: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
tags: ["informatik", "tests-debugging", "code-review-als-qualitaetsfilter", "systemdesign", "v210"]
draft: false
---
![Code Review als Qualitätsfilter](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/code-review-als-qualitaetsfilter.svg)

## Worum es hier geht

**Code Review als Qualitätsfilter** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Code Review als Qualitätsfilter wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
