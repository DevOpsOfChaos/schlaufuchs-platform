---
title: "Fehleranalyse statt Raten – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Fehleranalyse statt Raten: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
tags: ["informatik", "prueftraining", "fehleranalyse-statt-raten", "systemdesign", "v210"]
draft: false
---
![Fehleranalyse statt Raten](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/fehleranalyse-statt-raten.svg)

## Worum es hier geht

**Fehleranalyse statt Raten** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Fehleranalyse statt Raten wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
