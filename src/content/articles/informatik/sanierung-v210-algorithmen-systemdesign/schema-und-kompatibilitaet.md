---
title: "Schema und Kompatibilität – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Schema und Kompatibilität: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "web-systeme"
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "web-systeme", "schema-und-kompatibilitaet", "systemdesign", "v210"]
draft: false
---
![Schema und Kompatibilität](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/schema-und-kompatibilitaet.svg)

## Worum es hier geht

**Schema und Kompatibilität** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Schema und Kompatibilität wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
