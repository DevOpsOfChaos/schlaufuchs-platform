---
title: "Randfall und Negativfall – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Randfall und Negativfall: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "tests-debugging"
topicPath: ["tests-debugging", "randfall-und-negativfall"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "tests-debugging", "randfall-und-negativfall", "systemdesign", "v210"]
draft: false
---
![Randfall und Negativfall](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/randfall-und-negativfall.svg)

## Worum es hier geht

**Randfall und Negativfall** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Randfall und Negativfall wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
