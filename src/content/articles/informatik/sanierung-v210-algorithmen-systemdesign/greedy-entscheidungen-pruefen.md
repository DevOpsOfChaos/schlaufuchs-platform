---
title: "Greedy-Entscheidungen prüfen – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Greedy-Entscheidungen prüfen: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "algorithmen"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "algorithmen", "greedy-entscheidungen-pruefen", "systemdesign", "v210"]
draft: false
---
![Greedy-Entscheidungen prüfen](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/greedy-entscheidungen-pruefen.svg)

## Worum es hier geht

**Greedy-Entscheidungen prüfen** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Greedy-Entscheidungen prüfen wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
