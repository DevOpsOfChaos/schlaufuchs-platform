---
title: "Speicher, CPU und I/O – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Speicher, CPU und I/O: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "systeme"
...
selfCheckPoints: []
level: "einfach"
tags: ["informatik", "systeme", "speicher-cpu-und-io", "systemdesign", "v210"]
draft: false
---
![Speicher, CPU und I/O](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/speicher-cpu-und-io.svg)

## Worum es hier geht

**Speicher, CPU und I/O** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Speicher, CPU und I/O wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
