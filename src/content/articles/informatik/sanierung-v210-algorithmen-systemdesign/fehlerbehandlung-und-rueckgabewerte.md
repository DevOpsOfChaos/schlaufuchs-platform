---
title: "Fehlerbehandlung und Rückgabewerte – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Fehlerbehandlung und Rückgabewerte: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "softwareentwurf", "fehlerbehandlung-und-rueckgabewerte", "systemdesign", "v210"]
draft: false
---
![Fehlerbehandlung und Rückgabewerte](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/fehlerbehandlung-und-rueckgabewerte.svg)

## Worum es hier geht

**Fehlerbehandlung und Rückgabewerte** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Fehlerbehandlung und Rückgabewerte wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
