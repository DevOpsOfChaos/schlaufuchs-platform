---
title: "Sortieren vergleichen und begründen – Überblick"
description: "Ein ruhiger Informatik-Überblick zu Sortieren vergleichen und begründen: Ziel, Daten, Entscheidung und Kontrolle werden getrennt aufgebaut."
subject: "informatik"
section: "algorithmen"
topicPath: ["algorithmen", "sortieren-vergleichen-und-begruenden"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
tags: ["informatik", "algorithmen", "sortieren-vergleichen-und-begruenden", "systemdesign", "v210"]
draft: false
---
![Sortieren vergleichen und begründen](/schlaufuchs-platform/images/informatik/sanierung-v210-algorithmen-systemdesign/sortieren-vergleichen-und-begruenden.svg)

## Worum es hier geht

**Sortieren vergleichen und begründen** ist ein Baustein, um Informatik nicht als Sammlung einzelner Befehle zu lesen, sondern als geordneten Denkweg. Wichtig ist, Eingaben, Regeln, Zustände, Schnittstellen und Kontrollen bewusst voneinander zu trennen.
...
Sortieren vergleichen und begründen wird verständlich, wenn Ablauf, Daten, Entscheidung und Kontrolle getrennt beschrieben werden.
