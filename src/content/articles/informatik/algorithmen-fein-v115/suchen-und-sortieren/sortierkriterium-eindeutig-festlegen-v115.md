---
title: "Informatik – Sortierkriterium eindeutig festlegen"
description: "Trainiere Sortierkriterium eindeutig festlegen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: informatik
section: "Feinstruktur Informatik"
topicPath:
  - "algorithmen-fein-v115"
  - "suchen-und-sortieren"
  - "sortierkriterium-eindeutig-festlegen-v115"
learningGoals:
  - "Du erklärst Sortierkriterium eindeutig festlegen an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welches Kriterium entscheidet zuerst?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Sortierkriterium eindeutig festlegen."
...
<img src="/schlaufuchs-platform/illustrations/informatik-sortierkriterium-eindeutig-festlegen-v115.svg" alt="Lernillustration zu Sortierkriterium eindeutig festlegen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Sortierkriterium eindeutig festlegen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welches Kriterium entscheidet zuerst?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Sortierkriterium eindeutig festlegen</h3>
  <p>Datensätze sollen nach Datum und Name sortiert werden.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Sortierkriterium eindeutig festlegen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Zwei Kriterien werden unklar gemischt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Zwei Kriterien werden unklar gemischt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Sortierkriterium eindeutig festlegen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
