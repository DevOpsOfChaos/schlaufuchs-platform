---
title: "Kopie und Referenz unterscheiden"
description: "Lerne Kopie und Referenz unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Kopie und Referenz unterscheiden als enges Unterthema."
...
commonMistakes:
  - "Übergabe wird immer als Kopie verstanden."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Kopie und Referenz unterscheiden wird über eine kleine Trennkante verständlich."
...
**Kopie und Referenz unterscheiden** ist bewusst als kleines Unterthema angelegt. Lerne Kopie und Referenz unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Datenstruktur wird an eine Funktion übergeben und danach ist das Original verändert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-kopie-und-referenz-unterscheiden-v113.svg" alt="Lernillustration zu Kopie und Referenz unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Übergabe wird immer als Kopie verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Arbeitet die Funktion auf einer Kopie oder auf demselben Objekt?</span></div>
  </div>
</div>
