---
title: "Lebensdauer von Daten beachten"
description: "Lerne Lebensdauer von Daten beachten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Lebensdauer von Daten beachten als enges Unterthema."
...
commonMistakes:
  - "Adresse wird mit dauerhaft gültigem Objekt verwechselt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Lebensdauer von Daten beachten wird über eine kleine Trennkante verständlich."
...
**Lebensdauer von Daten beachten** ist bewusst als kleines Unterthema angelegt. Lerne Lebensdauer von Daten beachten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Zeiger oder Verweis zeigt auf Daten, die nicht mehr gültig sind.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-lebensdauer-von-daten-beachten-v113.svg" alt="Lernillustration zu Lebensdauer von Daten beachten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Adresse wird mit dauerhaft gültigem Objekt verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Existiert das referenzierte Objekt noch?</span></div>
  </div>
</div>
