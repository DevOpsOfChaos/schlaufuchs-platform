---
title: "Fixes klein und prüfbar halten"
description: "Verstehe korrekturen begrenzen und direkt absichern als ruhigen Informatik-Baustein für Qualität, Tests und nachvollziehbare Änderungen."
subject: "informatik"
...
keyTakeaways:
  - "Ein kleiner Fix hat ein klares Ziel."
  - "Vorher-nachher-Tests zeigen Wirkung."
  - "Nebenwirkungen brauchen gezielte Zusatzprüfung."
recognizeSignals:
...
![Didaktische Skizze zu Fixes klein und prüfbar halten](/schlaufuchs-platform/images/informatik/sanierung-v193/fixes-klein-und-pruefbar-halten.svg)

Fixes klein und prüfbar halten gehört zur Informatik-Sanierung v193. Die Seite behandelt das Thema nicht als isolierten Programmiertrick, sondern als Qualitätsentscheidung: Was soll der Code leisten, woran erkennt man korrektes Verhalten und wie bleibt die Änderung später verständlich?

## Worum es geht

Der Kern ist: **korrekturen begrenzen und direkt absichern**. Gute Informatik-Praxis beginnt damit, ein Problem klein genug zu beschreiben, damit es geprüft werden kann. Danach werden Daten, Zustände, Fehlerfälle und Schnittstellen bewusst benannt.
