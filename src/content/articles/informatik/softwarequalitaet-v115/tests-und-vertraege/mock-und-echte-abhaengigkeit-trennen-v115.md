---
title: "Informatik – Mock und echte Abhängigkeit trennen"
description: "Trainiere Mock und echte Abhängigkeit trennen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: informatik
...
learningGoals:
  - "Du erklärst Mock und echte Abhängigkeit trennen an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welche Abhängigkeit soll im Test ersetzt werden?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Mock und echte Abhängigkeit trennen."
...
<img src="/schlaufuchs-platform/illustrations/informatik-mock-und-echte-abhaengigkeit-trennen-v115.svg" alt="Lernillustration zu Mock und echte Abhängigkeit trennen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Mock und echte Abhängigkeit trennen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welche Abhängigkeit soll im Test ersetzt werden?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Mock und echte Abhängigkeit trennen</h3>
  <p>Ein Test greift auf Netzwerkdaten zu.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Mock und echte Abhängigkeit trennen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Instabile Außenwelt wird als normaler Testbestandteil akzeptiert.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Instabile Außenwelt wird als normaler Testbestandteil akzeptiert. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Mock und echte Abhängigkeit trennen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
