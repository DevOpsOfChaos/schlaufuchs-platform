---
title: "Informatik – Seiteneffekt sichtbar machen"
description: "Trainiere Seiteneffekt sichtbar machen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: informatik
...
learningGoals:
  - "Du erklärst Seiteneffekt sichtbar machen an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Sie wird wie eine reine Berechnung verwendet."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Ändert die Funktion außer ihrem Rückgabewert noch etwas?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Seiteneffekt sichtbar machen."
...
<img src="/schlaufuchs-platform/illustrations/informatik-seiteneffekt-sichtbar-machen-v115.svg" alt="Lernillustration zu Seiteneffekt sichtbar machen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Seiteneffekt sichtbar machen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Ändert die Funktion außer ihrem Rückgabewert noch etwas?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Seiteneffekt sichtbar machen</h3>
  <p>Eine Funktion verändert zusätzlich globale Daten.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Seiteneffekt sichtbar machen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Sie wird wie eine reine Berechnung verwendet.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Sie wird wie eine reine Berechnung verwendet. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Seiteneffekt sichtbar machen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
