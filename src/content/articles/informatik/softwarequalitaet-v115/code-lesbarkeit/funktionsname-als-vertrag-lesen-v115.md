---
title: "Informatik – Funktionsname als Vertrag lesen"
description: "Trainiere Funktionsname als Vertrag lesen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: informatik
section: "Feinstruktur Informatik"
topicPath:
  - "softwarequalitaet-v115"
  - "code-lesbarkeit"
  - "funktionsname-als-vertrag-lesen-v115"
learningGoals:
  - "Du erklärst Funktionsname als Vertrag lesen an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Kann man aus dem Namen die Hauptwirkung erkennen?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Funktionsname als Vertrag lesen."
...
<img src="/schlaufuchs-platform/illustrations/informatik-funktionsname-als-vertrag-lesen-v115.svg" alt="Lernillustration zu Funktionsname als Vertrag lesen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Funktionsname als Vertrag lesen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Kann man aus dem Namen die Hauptwirkung erkennen?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Funktionsname als Vertrag lesen</h3>
  <p>Eine Funktion tut mehr, als ihr Name verspricht.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Funktionsname als Vertrag lesen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Der Name wird als Dekoration behandelt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Der Name wird als Dekoration behandelt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Funktionsname als Vertrag lesen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
