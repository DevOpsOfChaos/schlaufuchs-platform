...
learningGoals:
  - "Du erklärst Doppelte Logik extrahieren an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Kann die gemeinsame Regel an einer Stelle stehen?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Doppelte Logik extrahieren."
