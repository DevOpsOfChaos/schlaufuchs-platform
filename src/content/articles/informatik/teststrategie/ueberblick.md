...
Eine Teststrategie beschreibt, welche Tests auf welcher Ebene sinnvoll sind und welches Risiko sie abdecken. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Teststrategie](/schlaufuchs-platform/images/overviews/v147/teststrategie.svg)

*Überblick über Teststrategie als geordnete Kombination aus Testarten, Risiken, Ebenen und Feedbackgeschwindigkeit.*

## Grundidee

Eine Teststrategie beschreibt, welche Tests auf welcher Ebene sinnvoll sind und welches Risiko sie abdecken. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Teststrategie hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Unit-Test:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Integrationstest:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **End-to-End-Test:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **manuelle Prüfung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Eine Teststrategie beschreibt, welche Tests auf welcher Ebene sinnvoll sind und welches Risiko sie abdecken. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
