---
title: "Informatik – Request und Response im HTTP-Ablauf trennen"
...
<div class="example-card">
  ...
  <h3>Ein Browser ruft eine Seite ab und erhält Daten zurück.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v109-request-und-response-in-http-ablauf-trennen.svg" alt="Lernillustration zu HTTP Request und Response." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Client- und Serverrolle werden vermischt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Markiere Richtung, Sender und Inhalt jeder Nachricht.</span></div>
  </div>
</div>
