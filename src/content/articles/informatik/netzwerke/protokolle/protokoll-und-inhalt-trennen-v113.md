---
title: "Protokoll und Inhalt trennen"
description: "Lerne Protokoll und Inhalt trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Protokoll und Inhalt trennen als enges Unterthema."
...
commonMistakes:
  - "Transportregel und Datenformat werden vermischt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Protokoll und Inhalt trennen wird über eine kleine Trennkante verständlich."
...
**Protokoll und Inhalt trennen** ist bewusst als kleines Unterthema angelegt. Lerne Protokoll und Inhalt trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Nachricht wird über HTTP übertragen, enthält aber JSON-Daten.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-protokoll-und-inhalt-trennen-v113.svg" alt="Lernillustration zu Protokoll und Inhalt trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Transportregel und Datenformat werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Was regelt die Übertragung und was beschreibt den Inhalt?</span></div>
  </div>
</div>
