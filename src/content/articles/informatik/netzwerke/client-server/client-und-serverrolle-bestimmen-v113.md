---
title: "Client und Serverrolle bestimmen"
description: "Lerne Client und Serverrolle bestimmen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Client und Serverrolle bestimmen als enges Unterthema."
...
commonMistakes:
  - "Client und Server werden nach Hardware statt nach Rolle benannt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Client und Serverrolle bestimmen wird über eine kleine Trennkante verständlich."
...
**Client und Serverrolle bestimmen** ist bewusst als kleines Unterthema angelegt. Lerne Client und Serverrolle bestimmen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Browser fragt eine API an und wartet auf Antwort.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-client-und-serverrolle-bestimmen-v113.svg" alt="Lernillustration zu Client und Serverrolle bestimmen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Client und Server werden nach Hardware statt nach Rolle benannt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wer startet die Anfrage und wer liefert die Antwort?</span></div>
  </div>
</div>
