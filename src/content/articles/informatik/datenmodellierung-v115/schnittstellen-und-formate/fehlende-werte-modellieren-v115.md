...
learningGoals:
  - "Du erklärst Fehlende Werte modellieren an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Ist der Wert unbekannt oder bewusst leer?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Fehlende Werte modellieren."
