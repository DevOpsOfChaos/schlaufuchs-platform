---
title: "Informatik – JSON-Feldnamen stabil halten"
description: "Trainiere JSON-Feldnamen stabil halten als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: informatik
...
learningGoals:
  - "Du erklärst JSON-Feldnamen stabil halten an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welche Namen erwarten andere Programmteile?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach JSON-Feldnamen stabil halten."
...
<img src="/schlaufuchs-platform/illustrations/informatik-json-feldnamen-stabil-halten-v115.svg" alt="Lernillustration zu JSON-Feldnamen stabil halten" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **JSON-Feldnamen stabil halten** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welche Namen erwarten andere Programmteile?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: JSON-Feldnamen stabil halten</h3>
  <p>Eine Webschnittstelle liefert strukturierte Daten.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>JSON-Feldnamen stabil halten sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Feldnamen werden nebenbei geändert.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Feldnamen werden nebenbei geändert. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> JSON-Feldnamen stabil halten bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
