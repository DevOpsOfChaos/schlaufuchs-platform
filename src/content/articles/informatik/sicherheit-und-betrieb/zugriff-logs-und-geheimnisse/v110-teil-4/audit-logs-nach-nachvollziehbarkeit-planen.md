---
title: "Informatik – Audit-Logs nach Nachvollziehbarkeit planen"
description: "Lerne Audit-Logs nach Nachvollziehbarkeit planen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "informatik"
...
**Audit-Logs nach Nachvollziehbarkeit planen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine kritische Änderung soll später erklärbar sein.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v110-audit-logs-nach-nachvollziehbarkeit-planen.svg" alt="Lernillustration zu Audit-Logs nach Nachvollziehbarkeit planen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Logs enthalten technische Details, aber keine handelnde Person.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Notiere wer, was, wann und mit welchem Ergebnis.</span></div>
  </div>
</div>
