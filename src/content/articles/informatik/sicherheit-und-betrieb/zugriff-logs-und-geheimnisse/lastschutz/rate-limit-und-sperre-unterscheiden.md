---
title: "Informatik – Rate Limit und Sperre unterscheiden"
description: "Lerne Missbrauchsschutz als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Missbrauchsschutz als enges Unterthema."
...
commonMistakes:
  - "Jede Begrenzung wird als vollständige Kontosperre verstanden."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Missbrauchsschutz wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Missbrauchsschutz** ist bewusst als kleines Unterthema angelegt. Lerne Missbrauchsschutz als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Viele Anfragen kommen in kurzer Zeit von derselben Quelle.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-rate-limit-und-sperre-unterscheiden.svg" alt="Lernillustration zu Missbrauchsschutz." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jede Begrenzung wird als vollständige Kontosperre verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob nur Tempo begrenzt oder Zugriff dauerhaft entzogen wird.</span></div>
  </div>
</div>
