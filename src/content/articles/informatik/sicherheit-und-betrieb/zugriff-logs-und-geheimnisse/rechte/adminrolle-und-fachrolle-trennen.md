---
title: "Informatik – Adminrolle und Fachrolle trennen"
...
<div class="example-card">
  ...
  <h3>Ein Nutzer soll Rechnungen prüfen, aber nicht Systeme konfigurieren.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-adminrolle-und-fachrolle-trennen.svg" alt="Lernillustration zu Rollenmodell." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Eine Adminrolle wird als schnelle Lösung vergeben.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Vergleiche die benötigte Handlung mit der tatsächlich vergebenen Berechtigung.</span></div>
  </div>
</div>
