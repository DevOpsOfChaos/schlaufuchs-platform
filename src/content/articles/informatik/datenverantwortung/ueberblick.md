...
Datenverantwortung klärt, wer Daten erzeugt, verändert, prüft, löscht und fachlich versteht. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Datenverantwortung](/schlaufuchs-platform/images/overviews/v147/datenverantwortung.svg)

*Überblick über Besitz, Pflege, Qualität und Lebenszyklus von Daten in Software-Systemen.*

## Grundidee

Datenverantwortung klärt, wer Daten erzeugt, verändert, prüft, löscht und fachlich versteht. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Datenverantwortung hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Datenquelle:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Verantwortliche Rolle:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Qualitätsregeln:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Archivierung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Datenverantwortung klärt, wer Daten erzeugt, verändert, prüft, löscht und fachlich versteht. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
