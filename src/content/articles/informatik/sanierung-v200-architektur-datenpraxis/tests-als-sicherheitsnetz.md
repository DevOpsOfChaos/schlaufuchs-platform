...
description: "Tests schützen Verhalten, wenn Systeme wachsen, refaktoriert oder erweitert werden."
subject: "informatik"
section: "softwarequalitaet"
topicPath: ["softwarequalitaet", "tests"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "softwarequalitaet", "tests", "sanierung-v200"]
draft: false
---
![Tests als Sicherheitsnetz](/schlaufuchs-platform/images/informatik/sanierung-v200-architektur-datenpraxis/tests-als-sicherheitsnetz.svg)

Tests schützen Verhalten, wenn Systeme wachsen, refaktoriert oder erweitert werden.
...
Tests als Sicherheitsnetz wird tragfähig, wenn Verantwortung, Datenfluss und Fehlerfälle vor der Umsetzung bewusst getrennt werden.
