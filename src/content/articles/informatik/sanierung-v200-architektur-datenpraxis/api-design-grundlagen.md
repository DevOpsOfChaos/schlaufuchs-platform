---
title: "API-Design-Grundlagen"
description: "APIs werden stabil, wenn Ressourcen, Aktionen, Statuscodes und Fehlermeldungen vorher sauber gedacht werden."
subject: "informatik"
section: "api-design"
topicPath: ["api-design", "grundlagen"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["informatik", "api-design", "grundlagen", "sanierung-v200"]
draft: false
---
![API-Design-Grundlagen](/schlaufuchs-platform/images/informatik/sanierung-v200-architektur-datenpraxis/api-design-grundlagen.svg)

APIs werden stabil, wenn Ressourcen, Aktionen, Statuscodes und Fehlermeldungen vorher sauber gedacht werden.
...
API-Design-Grundlagen wird tragfähig, wenn Verantwortung, Datenfluss und Fehlerfälle vor der Umsetzung bewusst getrennt werden.
