---
title: Laufzeit grob abschätzen
description: Schleifenstruktur statt Maschinendetails zuerst lesen
subject: informatik
section: Feinstruktur Informatik
topicPath:
- system-und-architektur
- speicher-und-laufzeit
- laufzeit-grob-abschaetzen-v114
learningGoals:
- Du erklärst Laufzeit grob abschätzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Nur die Anzahl der Codezeilen wird betrachtet.
...
keyTakeaways:
- Laufzeit grob abschätzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Laufzeit grob abschätzen** ist bewusst als kleines Unterthema angelegt. Schleifenstruktur statt Maschinendetails zuerst lesen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine doppelte Schleife vergleicht alle Paare.</h3>
  <p>Die wichtige Frage lautet: <strong>Wie oft wächst die zentrale Operation?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-laufzeit-grob-abschaetzen-v114.svg" alt="Lernillustration zu Laufzeit grob abschätzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur die Anzahl der Codezeilen wird betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wie oft wächst die zentrale Operation?</span></div>
  </div>
</div>
