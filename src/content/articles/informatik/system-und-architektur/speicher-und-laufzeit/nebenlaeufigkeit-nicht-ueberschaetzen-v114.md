---
title: Nebenläufigkeit nicht überschätzen
description: Parallelität und Wartezeit unterscheiden
subject: informatik
...
learningGoals:
- Du erklärst Nebenläufigkeit nicht überschätzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Mehr Threads werden automatisch als schneller angenommen.
...
keyTakeaways:
- Nebenläufigkeit nicht überschätzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Nebenläufigkeit nicht überschätzen** ist bewusst als kleines Unterthema angelegt. Parallelität und Wartezeit unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Programm wartet auf Netzwerkantworten.</h3>
  <p>Die wichtige Frage lautet: <strong>Wartet das Programm auf CPU oder auf etwas Externes?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-nebenlaeufigkeit-nicht-ueberschaetzen-v114.svg" alt="Lernillustration zu Nebenläufigkeit nicht überschätzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Mehr Threads werden automatisch als schneller angenommen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wartet das Programm auf CPU oder auf etwas Externes?</span></div>
  </div>
</div>
...
Dieses Thema gehört zu **Speicher Und Laufzeit**, aber es soll nicht das ganze Unterthema ersetzen. Die Seite beantwortet eine einzelne Prüffrage. Andere Seiten können danach benachbarte Fälle, Sonderfälle oder Vertiefungen übernehmen.
