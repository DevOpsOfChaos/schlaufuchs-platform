---
title: Fehlercode und Fehlertext trennen
description: Maschinenlesbare und menschenlesbare Fehler unterscheiden
subject: informatik
...
learningGoals:
- Du erklärst Fehlercode und Fehlertext trennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Nur ein schöner Satz wird zurückgegeben.
...
keyTakeaways:
- Fehlercode und Fehlertext trennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Fehlercode und Fehlertext trennen** ist bewusst als kleines Unterthema angelegt. Maschinenlesbare und menschenlesbare Fehler unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine API antwortet mit Status und Nachricht.</h3>
  <p>Die wichtige Frage lautet: <strong>Was wertet der Client automatisch aus?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-fehlercode-und-fehlertext-trennen-v114.svg" alt="Lernillustration zu Fehlercode und Fehlertext trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur ein schöner Satz wird zurückgegeben.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Was wertet der Client automatisch aus?</span></div>
  </div>
</div>
