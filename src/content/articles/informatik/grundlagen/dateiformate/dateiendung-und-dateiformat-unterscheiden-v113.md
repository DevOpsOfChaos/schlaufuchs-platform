---
title: "Dateiendung und Dateiformat unterscheiden"
description: "Lerne Dateiendung und Dateiformat unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Dateiendung und Dateiformat unterscheiden als enges Unterthema."
...
commonMistakes:
  - "Die Endung wird mit dem tatsächlichen Format verwechselt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Dateiendung und Dateiformat unterscheiden wird über eine kleine Trennkante verständlich."
...
**Dateiendung und Dateiformat unterscheiden** ist bewusst als kleines Unterthema angelegt. Lerne Dateiendung und Dateiformat unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Datei heißt umbenannt anders, lässt sich aber nicht korrekt öffnen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-dateiendung-und-dateiformat-unterscheiden-v113.svg" alt="Lernillustration zu Dateiendung und Dateiformat unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Endung wird mit dem tatsächlichen Format verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Entspricht der Inhalt wirklich dem angegebenen Format?</span></div>
  </div>
</div>
