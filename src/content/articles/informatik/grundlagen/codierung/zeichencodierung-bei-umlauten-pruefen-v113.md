---
title: "Zeichencodierung bei Umlauten prüfen"
...
<div class="example-card">
  ...
  <h3>Ein deutscher Text wird falsch angezeigt und Umlaute erscheinen beschädigt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-zeichencodierung-bei-umlauten-pruefen-v113.svg" alt="Lernillustration zu Zeichencodierung bei Umlauten prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Fehler wird für einen Tippfehler gehalten.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Sind Sender, Datei und Anzeige auf dieselbe Codierung eingestellt?</span></div>
  </div>
</div>
