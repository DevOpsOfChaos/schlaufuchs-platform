---
title: "Informatik – Binären Übertrag schrittweise protokollieren"
...
<div class="example-card">
  ...
  <h3>Zwei Binärzahlen werden addiert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v109-binaeren-uebertrag-schrittweise-protokollieren.svg" alt="Lernillustration zu Binärer Übertrag." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Der Übertrag wird eine Stelle zu früh oder zu spät genutzt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Notiere Übertrag und Ergebnisbit getrennt.</span></div>
  </div>
</div>
