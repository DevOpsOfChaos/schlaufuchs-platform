---
title: "Daten und Bedeutung trennen"
description: "Lerne Daten und Bedeutung trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Daten und Bedeutung trennen als enges Unterthema."
...
commonMistakes:
  - "Datenwert und Information werden gleichgesetzt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Daten und Bedeutung trennen wird über eine kleine Trennkante verständlich."
...
**Daten und Bedeutung trennen** ist bewusst als kleines Unterthema angelegt. Lerne Daten und Bedeutung trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Zahl wird gespeichert, aber erst der Kontext macht daraus eine Temperatur.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v113-daten-und-bedeutung-trennen-v113.svg" alt="Lernillustration zu Daten und Bedeutung trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Datenwert und Information werden gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Bedeutung erhält der Wert durch Kontext und Einheit?</span></div>
  </div>
</div>
