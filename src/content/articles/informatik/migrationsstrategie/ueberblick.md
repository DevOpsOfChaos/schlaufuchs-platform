...
Eine Migrationsstrategie sorgt dafür, dass Strukturänderungen an Datenbanken nachvollziehbar und kontrollierbar bleiben. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Migrationsstrategie](/schlaufuchs-platform/images/overviews/v147/migrationsstrategie.svg)

*Überblick über Strategien, Datenmodelle und Datenbestände kontrolliert zu verändern.*

## Grundidee

Eine Migrationsstrategie sorgt dafür, dass Strukturänderungen an Datenbanken nachvollziehbar und kontrollierbar bleiben. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Migrationsstrategie hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Schemaänderung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Datenmigration:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Kompatibilität:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Rückfallplan:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Eine Migrationsstrategie sorgt dafür, dass Strukturänderungen an Datenbanken nachvollziehbar und kontrollierbar bleiben. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
