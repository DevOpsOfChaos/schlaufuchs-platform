---
title: "Informatik – Endlosschleife über Fortschritt erkennen"
description: "Lerne Schleifenfortschritt als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Schleifenfortschritt als enges Unterthema."
...
commonMistakes:
  - "Eine korrekte Bedingung wird mit sicherem Ende verwechselt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Schleifenfortschritt wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Schleifenfortschritt** ist bewusst als kleines Unterthema angelegt. Lerne Schleifenfortschritt als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine while-Schleife prüft eine Bedingung, verändert aber keinen passenden Wert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-endlosschleife-ueber-fortschritt-erkennen.svg" alt="Lernillustration zu Schleifenfortschritt." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Eine korrekte Bedingung wird mit sicherem Ende verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, welcher Wert sich dem Abbruch nähert.</span></div>
  </div>
</div>
