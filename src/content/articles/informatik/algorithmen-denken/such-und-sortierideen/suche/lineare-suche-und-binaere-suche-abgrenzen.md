---
title: "Informatik – Lineare Suche und binäre Suche abgrenzen"
description: "Lerne Suchstrategie als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Suchstrategie als enges Unterthema."
...
commonMistakes:
  - "Binäre Suche wird auch bei unsortierten Daten erwartet."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Suchstrategie wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Suchstrategie** ist bewusst als kleines Unterthema angelegt. Lerne Suchstrategie als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine sortierte Liste soll durchsucht werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-lineare-suche-und-binaere-suche-abgrenzen.svg" alt="Lernillustration zu Suchstrategie." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Binäre Suche wird auch bei unsortierten Daten erwartet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe zuerst, ob die Daten sortiert und direkt zugreifbar sind.</span></div>
  </div>
</div>
