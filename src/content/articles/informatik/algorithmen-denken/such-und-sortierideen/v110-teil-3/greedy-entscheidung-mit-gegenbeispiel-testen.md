---
title: "Informatik – Greedy-Entscheidung mit Gegenbeispiel testen"
description: "Lerne Greedy-Entscheidung mit Gegenbeispiel testen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "informatik"
section: "Algorithmen"
topicPath:
  - "algorithmen-denken"
...
learningGoals:
  - "Du erklärst Greedy-Entscheidung mit Gegenbeispiel testen als eigenes Unterthema."
...
commonMistakes:
  - "Lokal optimal wird automatisch als global optimal angenommen."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Greedy-Entscheidung mit Gegenbeispiel testen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Greedy-Entscheidung mit Gegenbeispiel testen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Immer der lokal beste Schritt wirkt plausibel.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v110-greedy-entscheidung-mit-gegenbeispiel-testen.svg" alt="Lernillustration zu Greedy-Entscheidung mit Gegenbeispiel testen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Lokal optimal wird automatisch als global optimal angenommen.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Suche ein kleines Gegenbeispiel mit späterem Nachteil.</span></div>
  </div>
</div>
