---
title: "Informatik – Stabile Sortierung am Beispiel erklären"
description: "Lerne Stabile Sortierung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
**Stabile Sortierung** ist bewusst als kleines Unterthema angelegt. Lerne Stabile Sortierung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Personen werden erst nach Name und dann nach Gruppe sortiert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-stabile-sortierung-am-beispiel-erklaeren.svg" alt="Lernillustration zu Stabile Sortierung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die zweite Sortierung zerstört unbeabsichtigt die erste Ordnung.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob gleiche Schlüssel ihre relative Reihenfolge behalten.</span></div>
  </div>
</div>
