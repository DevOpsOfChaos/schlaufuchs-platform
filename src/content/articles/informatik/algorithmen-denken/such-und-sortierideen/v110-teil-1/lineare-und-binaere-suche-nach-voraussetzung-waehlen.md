---
title: "Informatik – Lineare und binäre Suche nach Voraussetzung wählen"
description: "Lerne Lineare und binäre Suche nach Voraussetzung wählen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "informatik"
section: "Algorithmen"
topicPath:
  - "algorithmen-denken"
...
learningGoals:
  - "Du erklärst Lineare und binäre Suche nach Voraussetzung wählen als eigenes Unterthema."
...
commonMistakes:
  - "Binäre Suche wird gewählt, weil sie schneller klingt."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Lineare und binäre Suche nach Voraussetzung wählen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Lineare und binäre Suche nach Voraussetzung wählen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Liste soll durchsucht werden, ist aber nicht sortiert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v110-lineare-und-binaere-suche-nach-voraussetzung-waehlen.svg" alt="Lernillustration zu Lineare und binäre Suche nach Voraussetzung wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Binäre Suche wird gewählt, weil sie schneller klingt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Prüfe zuerst, ob die Daten sortiert sind.</span></div>
  </div>
</div>
