...
learningGoals:
- Du erklärst Minimalen Testfall bauen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Der komplette Produktionsfall wird ungefiltert getestet.
...
keyTakeaways:
- Minimalen Testfall bauen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
