---
title: Testdaten von Testlogik trennen
description: Tests lesbar und wartbar strukturieren
subject: informatik
...
learningGoals:
- Du erklärst Testdaten von Testlogik trennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Daten und Erwartung stehen versteckt im Testcode.
...
keyTakeaways:
- Testdaten von Testlogik trennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Testdaten von Testlogik trennen** ist bewusst als kleines Unterthema angelegt. Tests lesbar und wartbar strukturieren. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Mehrere Fälle prüfen dieselbe Regel.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Fälle gehören als Tabelle zusammen?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-testdaten-von-testlogik-trennen-v114.svg" alt="Lernillustration zu Testdaten von Testlogik trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Daten und Erwartung stehen versteckt im Testcode.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Fälle gehören als Tabelle zusammen?</span></div>
  </div>
</div>
