---
title: Parameter sinnvoll benennen
description: Namen als Teil der Lesbarkeit nutzen
subject: informatik
section: Feinstruktur Informatik
topicPath:
- programmierpraxis
- funktionen-und-schnittstellen
- parameter-sinnvoll-benennen-v114
learningGoals:
- Du erklärst Parameter sinnvoll benennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Parameter heißen nur a, b und c ohne Kontext.
...
keyTakeaways:
- Parameter sinnvoll benennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Parameter sinnvoll benennen** ist bewusst als kleines Unterthema angelegt. Namen als Teil der Lesbarkeit nutzen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Funktion bekommt mehrere Zahlenwerte.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Rolle hat der Wert in der Funktion?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-parameter-sinnvoll-benennen-v114.svg" alt="Lernillustration zu Parameter sinnvoll benennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Parameter heißen nur a, b und c ohne Kontext.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Rolle hat der Wert in der Funktion?</span></div>
  </div>
</div>
