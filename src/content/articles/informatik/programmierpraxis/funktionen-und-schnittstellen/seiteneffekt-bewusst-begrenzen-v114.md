---
title: Seiteneffekt bewusst begrenzen
description: Datenänderung und Berechnung getrennt halten
subject: informatik
...
learningGoals:
- Du erklärst Seiteneffekt bewusst begrenzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Aufrufer erwarten eine neue Liste, bekommen aber eine veränderte alte.
...
keyTakeaways:
- Seiteneffekt bewusst begrenzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Seiteneffekt bewusst begrenzen** ist bewusst als kleines Unterthema angelegt. Datenänderung und Berechnung getrennt halten. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Funktion sortiert eine Liste direkt um.</h3>
  <p>Die wichtige Frage lautet: <strong>Wird ein vorhandenes Objekt verändert?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v114-seiteneffekt-bewusst-begrenzen-v114.svg" alt="Lernillustration zu Seiteneffekt bewusst begrenzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Aufrufer erwarten eine neue Liste, bekommen aber eine veränderte alte.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wird ein vorhandenes Objekt verändert?</span></div>
  </div>
</div>
