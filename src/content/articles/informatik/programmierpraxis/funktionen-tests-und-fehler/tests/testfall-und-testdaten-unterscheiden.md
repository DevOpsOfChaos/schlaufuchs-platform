---
title: "Informatik – Testfall und Testdaten unterscheiden"
description: "Lerne Testfall und Testdaten als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Testfall und Testdaten als enges Unterthema."
...
commonMistakes:
  - "Neue Daten werden automatisch als neuer Testfall gewertet."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Testfall und Testdaten wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Testfall und Testdaten** ist bewusst als kleines Unterthema angelegt. Lerne Testfall und Testdaten als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Mehrere Tests verwenden dieselben Beispielwerte.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-testfall-und-testdaten-unterscheiden.svg" alt="Lernillustration zu Testfall und Testdaten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Neue Daten werden automatisch als neuer Testfall gewertet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Beschreibe, welche Regel jeder Testfall prüft.</span></div>
  </div>
</div>
