---
title: "Informatik – Pure Functions und Seiteneffekte trennen"
...
<div class="example-card">
  ...
  <h3>Eine Funktion berechnet einen Wert und schreibt zusätzlich in eine Datei.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v110-pure-functions-und-seiteneffekte-trennen.svg" alt="Lernillustration zu Pure Functions und Seiteneffekte trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Jede Funktion mit Rückgabewert wird automatisch als reine Funktion gelesen.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Prüfe, ob außer der Rückgabe noch Zustand verändert wird.</span></div>
  </div>
</div>
