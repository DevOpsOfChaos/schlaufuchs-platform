---
title: "Informatik – Fehlerhypothese vor Codeänderung formulieren"
description: "Lerne Debugging-Hypothese als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Debugging-Hypothese als enges Unterthema."
...
**Debugging-Hypothese** ist bewusst als kleines Unterthema angelegt. Lerne Debugging-Hypothese als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Programm verhält sich falsch und es wird sofort Code geändert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-fehlerhypothese-vor-codeaenderung-formulieren.svg" alt="Lernillustration zu Debugging-Hypothese." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Ausprobieren ersetzt gezielte Fehlersuche.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Schreibe vor dem Fix auf, welche Ursache du prüfst.</span></div>
  </div>
</div>
