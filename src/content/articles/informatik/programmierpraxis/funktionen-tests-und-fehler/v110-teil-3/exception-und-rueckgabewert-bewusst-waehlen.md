---
title: "Informatik – Exception und Rückgabewert bewusst wählen"
description: "Lerne Exception und Rückgabewert bewusst wählen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "informatik"
...
learningGoals:
  - "Du erklärst Exception und Rückgabewert bewusst wählen als eigenes Unterthema."
...
commonMistakes:
  - "Jeder Sonderfall wird als normaler Rückgabewert versteckt."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Exception und Rückgabewert bewusst wählen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Exception und Rückgabewert bewusst wählen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein ungültiger Eingabewert kann nicht sinnvoll verarbeitet werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v110-exception-und-rueckgabewert-bewusst-waehlen.svg" alt="Lernillustration zu Exception und Rückgabewert bewusst wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Jeder Sonderfall wird als normaler Rückgabewert versteckt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Entscheide, ob der Fall erwartbar ist oder den Ablauf wirklich unterbricht.</span></div>
  </div>
</div>
