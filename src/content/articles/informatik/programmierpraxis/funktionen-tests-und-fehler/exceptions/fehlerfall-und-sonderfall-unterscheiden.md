---
title: "Informatik – Fehlerfall und Sonderfall unterscheiden"
description: "Lerne Fehlerfall vs Sonderfall als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "informatik"
...
**Fehlerfall vs Sonderfall** ist bewusst als kleines Unterthema angelegt. Lerne Fehlerfall vs Sonderfall als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Funktion bekommt eine leere Liste.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/informatik-v111-fehlerfall-und-sonderfall-unterscheiden.svg" alt="Lernillustration zu Fehlerfall vs Sonderfall." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jeder ungewöhnliche Fall wird als Ausnahme behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob der Fall fachlich erlaubt oder wirklich fehlerhaft ist.</span></div>
  </div>
</div>
