...
Dieses Unterthema behandelt **Gültigkeitsbereich von Variablen beachten** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **In welchem Bereich existiert die Variable?**
...
<div class="compare-card">
  ...
  <h3>Gültigkeitsbereich von Variablen beachten sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Sie wird außerhalb des Blocks weiter erwartet.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Sie wird außerhalb des Blocks weiter erwartet. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Gültigkeitsbereich von Variablen beachten bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
