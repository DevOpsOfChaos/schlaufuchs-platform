---
title: "Linux – cp -a bei Rechten und Zeitstempeln begründen"
description: "Lerne cp -a als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst cp -a als enges Unterthema."
...
commonMistakes:
  - "Normales cp wird für jede Sicherung als ausreichend betrachtet."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "cp -a wird durch Kontext, Abgrenzung und Prüfung klar."
...
**cp -a** ist bewusst als kleines Unterthema angelegt. Lerne cp -a als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Verzeichnis soll als Arbeitskopie mit Metadaten erhalten bleiben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-cp-a-bei-rechten-und-zeitstempeln-begruenden.svg" alt="Lernillustration zu cp -a." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Normales cp wird für jede Sicherung als ausreichend betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob Rechte, Besitzer, Links und Zeitstempel wichtig sind.</span></div>
  </div>
</div>
