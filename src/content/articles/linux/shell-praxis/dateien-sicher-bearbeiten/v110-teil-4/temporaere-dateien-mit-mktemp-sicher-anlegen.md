---
title: "Linux – Temporäre Dateien mit mktemp sicher anlegen"
description: "Lerne Temporäre Dateien mit mktemp sicher anlegen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "linux"
section: "Shell"
topicPath:
  - "shell-praxis"
...
learningGoals:
  - "Du erklärst Temporäre Dateien mit mktemp sicher anlegen als eigenes Unterthema."
...
commonMistakes:
  - "Ein fester Dateiname in /tmp wird mehrfach verwendet."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Temporäre Dateien mit mktemp sicher anlegen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Temporäre Dateien mit mktemp sicher anlegen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Skript braucht eine Zwischenablage im Dateisystem.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v110-temporaere-dateien-mit-mktemp-sicher-anlegen.svg" alt="Lernillustration zu Temporäre Dateien mit mktemp sicher anlegen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Ein fester Dateiname in /tmp wird mehrfach verwendet.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Erzeuge eindeutige temporäre Dateien mit mktemp.</span></div>
  </div>
</div>
