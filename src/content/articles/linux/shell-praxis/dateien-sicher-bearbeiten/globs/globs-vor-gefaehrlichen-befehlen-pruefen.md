---
title: "Linux – Globs vor gefährlichen Befehlen prüfen"
description: "Lerne Globbing als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Globbing als enges Unterthema."
...
commonMistakes:
  - "Das Muster wird als Text verstanden oder zu breit ausgeweitet."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Globbing wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Globbing** ist bewusst als kleines Unterthema angelegt. Lerne Globbing als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Muster wie *.log soll Dateien auswählen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-globs-vor-gefaehrlichen-befehlen-pruefen.svg" alt="Lernillustration zu Globbing." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Das Muster wird als Text verstanden oder zu breit ausgeweitet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Zeige die Auswahl vor rm oder mv mit printf oder ls an.</span></div>
  </div>
</div>
