---
title: "Restore-Probe"
description: "Eine Restore-Probe zeigt, ob ein Backup im Ernstfall wirklich nutzbar ist."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "restore"]
draft: false
---
![Restore-Probe](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/restore-probe.svg)

## Worum es geht

Eine Restore-Probe zeigt, ob ein Backup im Ernstfall wirklich nutzbar ist. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Restore-Probe wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
