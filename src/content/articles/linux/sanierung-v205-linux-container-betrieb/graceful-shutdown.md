...
description: "Graceful Shutdown schützt laufende Arbeit beim Stoppen oder Aktualisieren."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "graceful"]
draft: false
---
![Graceful Shutdown](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/graceful-shutdown.svg)

## Worum es geht

Graceful Shutdown schützt laufende Arbeit beim Stoppen oder Aktualisieren. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Graceful Shutdown wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
