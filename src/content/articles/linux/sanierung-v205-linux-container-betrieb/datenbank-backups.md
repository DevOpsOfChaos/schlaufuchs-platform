...
description: "Backups sind erst dann belastbar, wenn Wiederherstellung und Konsistenz geprüft werden."
subject: "linux"
section: "speicher-backup"
topicPath: ["speicher-backup", "datenbank-backups"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "datenbank"]
draft: false
---
![Datenbank-Backups](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/datenbank-backups.svg)

## Worum es geht

Backups sind erst dann belastbar, wenn Wiederherstellung und Konsistenz geprüft werden. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Datenbank-Backups wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
