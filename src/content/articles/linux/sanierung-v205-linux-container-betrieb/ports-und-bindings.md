---
title: "Ports und Bindings"
description: "Portbindung entscheidet, ob ein Dienst nur intern oder öffentlich erreichbar ist."
subject: "linux"
section: "netzwerk-sicherheit"
topicPath: ["netzwerk-sicherheit", "ports-und-bindings"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "ports"]
draft: false
---
![Ports und Bindings](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/ports-und-bindings.svg)

## Worum es geht

Portbindung entscheidet, ob ein Dienst nur intern oder öffentlich erreichbar ist. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Ports und Bindings wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
