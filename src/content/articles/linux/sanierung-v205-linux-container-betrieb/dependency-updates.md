...
description: "Updates sind Betriebsarbeit: Risiko, Testbarkeit und Dringlichkeit müssen bewertet werden."
subject: "linux"
section: "netzwerk-sicherheit"
topicPath: ["netzwerk-sicherheit", "dependency-updates"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "dependency"]
draft: false
---
![Dependency-Updates](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/dependency-updates.svg)

## Worum es geht

Updates sind Betriebsarbeit: Risiko, Testbarkeit und Dringlichkeit müssen bewertet werden. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Dependency-Updates wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
