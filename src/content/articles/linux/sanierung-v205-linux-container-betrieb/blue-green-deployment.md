...
description: "Blue-Green trennt alte und neue Version, damit Umschalten kontrollierbar bleibt."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "blue"]
draft: false
---
![Blue-Green-Deployment](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/blue-green-deployment.svg)

## Worum es geht

Blue-Green trennt alte und neue Version, damit Umschalten kontrollierbar bleibt. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Blue-Green-Deployment wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
