---
title: "Ressourcenmessung"
description: "CPU, Speicher, I/O und Netzwerk müssen getrennt beobachtet werden."
subject: "linux"
section: "linux-betriebssystemnah"
topicPath: ["linux-betriebssystemnah", "ressourcenmessung"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "ressourcenmessung"]
draft: false
---
![Ressourcenmessung](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/ressourcenmessung.svg)

## Worum es geht

CPU, Speicher, I/O und Netzwerk müssen getrennt beobachtet werden. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Ressourcenmessung wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
