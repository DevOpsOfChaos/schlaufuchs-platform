---
title: "Fehlerbudget"
description: "Ein Fehlerbudget macht Stabilität und Entwicklung gegeneinander abwägbar."
subject: "linux"
section: "service-qualitaet"
topicPath: ["service-qualitaet", "fehlerbudget"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "fehlerbudget"]
draft: false
---
![Fehlerbudget](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/fehlerbudget.svg)

## Worum es geht

Ein Fehlerbudget macht Stabilität und Entwicklung gegeneinander abwägbar. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Fehlerbudget wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
