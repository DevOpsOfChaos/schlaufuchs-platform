...
description: "TLS scheitert oft nicht an Verschlüsselung, sondern an Ablaufdaten, Namen und Ketten."
subject: "linux"
section: "netzwerk-sicherheit"
topicPath: ["netzwerk-sicherheit", "tls-zertifikate"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "tls"]
draft: false
---
![TLS-Zertifikate](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/tls-zertifikate.svg)

## Worum es geht

TLS scheitert oft nicht an Verschlüsselung, sondern an Ablaufdaten, Namen und Ketten. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
TLS-Zertifikate wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
