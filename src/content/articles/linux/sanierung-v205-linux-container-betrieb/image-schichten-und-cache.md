---
title: "Image-Schichten und Cache"
description: "Image-Schichten erklären, warum kleine Änderungen Builds beschleunigen oder verlangsamen."
subject: "linux"
section: "container-grundlagen"
topicPath: ["container-grundlagen", "image-schichten-und-cache"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "image"]
draft: false
---
![Image-Schichten und Cache](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/image-schichten-und-cache.svg)

## Worum es geht

Image-Schichten erklären, warum kleine Änderungen Builds beschleunigen oder verlangsamen. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Image-Schichten und Cache wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
