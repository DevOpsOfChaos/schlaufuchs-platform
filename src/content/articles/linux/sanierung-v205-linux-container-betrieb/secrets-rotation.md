...
description: "Secrets müssen austauschbar bleiben, ohne den Betrieb unnötig zu gefährden."
subject: "linux"
section: "netzwerk-sicherheit"
topicPath: ["netzwerk-sicherheit", "secrets-rotation"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "secrets"]
draft: false
---
![Secrets-Rotation](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/secrets-rotation.svg)

## Worum es geht

Secrets müssen austauschbar bleiben, ohne den Betrieb unnötig zu gefährden. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Secrets-Rotation wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
