...
description: "Compose beschreibt mehrere Dienste mit Abhängigkeiten, Netzwerken und Volumes als zusammenhängenden Betrieb."
subject: "linux"
section: "container-grundlagen"
topicPath: ["container-grundlagen", "compose-services"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "compose"]
draft: false
---
![Compose-Services](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/compose-services.svg)

## Worum es geht

Compose beschreibt mehrere Dienste mit Abhängigkeiten, Netzwerken und Volumes als zusammenhängenden Betrieb. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Compose-Services wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
