...
description: "Rollback ist ein geplanter Weg zurück, nicht eine spontane Panikmaßnahme."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "rollback"]
draft: false
---
![Rollback-Strategie](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/rollback-strategie.svg)

## Worum es geht

Rollback ist ein geplanter Weg zurück, nicht eine spontane Panikmaßnahme. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Rollback-Strategie wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
