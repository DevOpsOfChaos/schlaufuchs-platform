...
description: "Jeder Dienst sollte nur die Rechte besitzen, die er tatsächlich benötigt."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "least"]
draft: false
---
![Least Privilege](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/least-privilege.svg)

## Worum es geht

Jeder Dienst sollte nur die Rechte besitzen, die er tatsächlich benötigt. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Least Privilege wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
