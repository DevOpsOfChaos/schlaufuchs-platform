---
title: "CI-Pipeline im Betrieb"
description: "Pipelines verbinden Prüfung, Artefakte und Auslieferung zu einem wiederholbaren Ablauf."
subject: "linux"
section: "automation-iac"
topicPath: ["automation-iac", "ci-pipeline-betrieb"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "ci"]
draft: false
---
![CI-Pipeline im Betrieb](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/ci-pipeline-betrieb.svg)

## Worum es geht

Pipelines verbinden Prüfung, Artefakte und Auslieferung zu einem wiederholbaren Ablauf. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
CI-Pipeline im Betrieb wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
