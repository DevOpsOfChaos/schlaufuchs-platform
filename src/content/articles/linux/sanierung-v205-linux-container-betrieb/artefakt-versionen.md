---
title: "Artefakt-Versionen"
description: "Ein Artefakt muss eindeutig identifizierbar sein, damit Fehler wirklich zurückverfolgt werden können."
subject: "linux"
section: "deployment-betrieb"
topicPath: ["deployment-betrieb", "artefakt-versionen"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "artefakt"]
draft: false
---
![Artefakt-Versionen](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/artefakt-versionen.svg)

## Worum es geht

Ein Artefakt muss eindeutig identifizierbar sein, damit Fehler wirklich zurückverfolgt werden können. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Artefakt-Versionen wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
