---
title: "Capabilities und Privilegien"
description: "Privilegien sollten gezielt vergeben werden, statt Container pauschal privilegiert zu starten."
subject: "linux"
section: "linux-betriebssystemnah"
topicPath: ["linux-betriebssystemnah", "capabilities-und-privilegien"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "capabilities"]
draft: false
---
![Capabilities und Privilegien](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/capabilities-und-privilegien.svg)

## Worum es geht

Privilegien sollten gezielt vergeben werden, statt Container pauschal privilegiert zu starten. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Capabilities und Privilegien wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
