...
description: "Wartungsfenster schaffen Erwartungssicherheit, wenn Eingriffe sichtbar riskant sind."
subject: "linux"
section: "deployment-betrieb"
topicPath: ["deployment-betrieb", "wartungsfenster"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "wartungsfenster"]
draft: false
---
![Wartungsfenster](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/wartungsfenster.svg)

## Worum es geht

Wartungsfenster schaffen Erwartungssicherheit, wenn Eingriffe sichtbar riskant sind. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Wartungsfenster wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
