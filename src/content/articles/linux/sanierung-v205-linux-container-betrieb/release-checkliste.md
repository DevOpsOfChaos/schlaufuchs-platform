...
description: "Eine Release-Checkliste reduziert Überraschungen vor, während und nach dem Ausrollen."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "release"]
draft: false
---
![Release-Checkliste](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/release-checkliste.svg)

## Worum es geht

Eine Release-Checkliste reduziert Überraschungen vor, während und nach dem Ausrollen. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Release-Checkliste wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
