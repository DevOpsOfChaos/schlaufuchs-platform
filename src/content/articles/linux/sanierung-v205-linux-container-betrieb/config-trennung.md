---
title: "Config-Trennung"
description: "Konfiguration gehört von Code getrennt, damit Umgebungen reproduzierbar bleiben."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "betrieb", "container", "v205", "config"]
draft: false
---
![Config-Trennung](/schlaufuchs-platform/images/linux/sanierung-v205-linux-container-betrieb/config-trennung.svg)

## Worum es geht

Konfiguration gehört von Code getrennt, damit Umgebungen reproduzierbar bleiben. Im Linux- und Containerbetrieb ist das Thema wichtig, weil kleine Unterschiede zwischen Entwicklung, Test und Produktion schnell echte Auswirkungen haben.
...
Config-Trennung wird beherrschbar, wenn Zielzustand, Beobachtung, Änderung und Rückfallweg getrennt betrachtet werden.
