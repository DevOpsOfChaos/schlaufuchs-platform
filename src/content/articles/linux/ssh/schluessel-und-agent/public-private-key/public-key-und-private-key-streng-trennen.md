---
title: "Linux – Public Key und Private Key streng trennen"
...
<div class="example-card">
  ...
  <h3>Ein SSH-Schlüssel soll auf einem Server eingerichtet werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v109-public-key-und-private-key-streng-trennen.svg" alt="Lernillustration zu Public und Private Key." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Der private Schlüssel wird kopiert oder geteilt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Nur der öffentliche Schlüssel gehört auf den Server.</span></div>
  </div>
</div>
