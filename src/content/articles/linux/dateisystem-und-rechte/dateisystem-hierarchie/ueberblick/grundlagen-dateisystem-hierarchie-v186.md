...
**Dateisystem-Hierarchie** ist ein wichtiges Linux-Thema, weil es nicht nur aus einem einzelnen Befehl besteht. Entscheidend ist, welche Rolle das Thema im System spielt, welcher Kontext geprüft werden muss und welche Grenzen es gibt.

## Warum das Thema wichtig ist

Linux beginnt im Wurzelverzeichnis und ordnet Dateien nach Zweck. Systemdateien, Nutzerdaten und temporäre Daten liegen an unterschiedlichen Orten. Dadurch lassen sich Befehle, Ausgaben und Fehlersituationen geordneter lesen.
...
Nicht jedes Verzeichnis ist für persönliche Dateien gedacht. Diese Abgrenzung verhindert, dass ein einzelnes Symptom vorschnell als Ursache behandelt wird.
