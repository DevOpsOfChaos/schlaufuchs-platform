...
description: "Verstehe fernzugriff kontrolliert und nachvollziehbar halten als ruhigen Linux-Baustein für Betrieb, Diagnose und sichere Änderungen."
subject: "linux"
...
learningGoals:
  - "Fernzugriff kontrolliert und nachvollziehbar halten"
  - "Beobachtung, Änderung und Kontrolle trennen"
  - "einen einfachen Rückweg oder Prüfpunkt benennen"
practiceIdeas:
  - "Erstelle eine kleine SSH-Härtungscheckliste."
...
keyTakeaways:
  - "SSH verbindet entfernte Anmeldung und Dateiübertragung."
...
![Didaktische Skizze zu SSH-Zugang absichern](/schlaufuchs-platform/images/linux/sanierung-v192/ssh-zugang-absichern.svg)

SSH-Zugang absichern gehört zur Linux-Sanierung v192. Die Seite behandelt das Thema nicht als Befehlsliste, sondern als Betriebsentscheidung: Was ist der aktuelle Zustand, welche Änderung ist wirklich nötig und wie wird danach geprüft, ob das System stabil bleibt?

## Worum es geht

Der Kern ist: **fernzugriff kontrolliert und nachvollziehbar halten**. Linux-Administration wird sicherer, wenn Beobachtung und Eingriff getrennt bleiben. Erst werden Zustand, Kontext und Risiko gelesen; danach folgt eine kleine Änderung mit klarer Kontrolle.

Wichtige Leitgedanken:

- SSH verbindet entfernte Anmeldung und Dateiübertragung.
- Schlüssel sind oft sicherer als Passwörter.
- Zugriffe sollten auf nötige Benutzer begrenzt sein.
...
SSH-Zugang absichern ist verstanden, wenn Zustand, Ursache, Eingriff, Kontrolle und Rückweg getrennt beschrieben werden können.
