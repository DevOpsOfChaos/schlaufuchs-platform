---
title: "Cronjobs und Timer"
description: "Verstehe geplante aufgaben sichtbar und kontrollierbar machen als ruhigen Linux-Baustein für Betrieb, Diagnose und sichere Änderungen."
subject: "linux"
...
topicPath:
  ...
  - "cronjobs-und-timer"
learningGoals:
  - "Geplante Aufgaben sichtbar und kontrollierbar machen"
  - "Beobachtung, Änderung und Kontrolle trennen"
  - "einen einfachen Rückweg oder Prüfpunkt benennen"
practiceIdeas:
  - "Prüfe einen geplanten Job auf Nachvollziehbarkeit."
...
keyTakeaways:
  - "Geplante Jobs brauchen Besitzer, Zeitpunkt und Logpfad."
...
![Didaktische Skizze zu Cronjobs und Timer](/schlaufuchs-platform/images/linux/sanierung-v192/cronjobs-und-timer.svg)

Cronjobs und Timer gehört zur Linux-Sanierung v192. Die Seite behandelt das Thema nicht als Befehlsliste, sondern als Betriebsentscheidung: Was ist der aktuelle Zustand, welche Änderung ist wirklich nötig und wie wird danach geprüft, ob das System stabil bleibt?

## Worum es geht

Der Kern ist: **geplante aufgaben sichtbar und kontrollierbar machen**. Linux-Administration wird sicherer, wenn Beobachtung und Eingriff getrennt bleiben. Erst werden Zustand, Kontext und Risiko gelesen; danach folgt eine kleine Änderung mit klarer Kontrolle.

Wichtige Leitgedanken:

- Geplante Jobs brauchen Besitzer, Zeitpunkt und Logpfad.
- systemd Timer können Cron ergänzen oder ersetzen.
- Fehler in Jobs bleiben ohne Logging oft unbemerkt.
...
Cronjobs und Timer ist verstanden, wenn Zustand, Ursache, Eingriff, Kontrolle und Rückweg getrennt beschrieben werden können.
