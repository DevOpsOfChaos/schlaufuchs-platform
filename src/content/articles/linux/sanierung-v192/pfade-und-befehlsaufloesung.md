---
title: "Pfade und Befehlsauflösung"
description: "Verstehe path und absolute pfade unterscheiden als ruhigen Linux-Baustein für Betrieb, Diagnose und sichere Änderungen."
subject: "linux"
...
learningGoals:
  - "PATH und absolute Pfade unterscheiden"
  - "Beobachtung, Änderung und Kontrolle trennen"
  - "einen einfachen Rückweg oder Prüfpunkt benennen"
practiceIdeas:
  - "Diagnostiziere einen Befehl, der nur für einen Benutzer gefunden wird."
...
keyTakeaways:
  - "Die Shell sucht Befehle über PATH."
...
![Didaktische Skizze zu Pfade und Befehlsauflösung](/schlaufuchs-platform/images/linux/sanierung-v192/pfade-und-befehlsaufloesung.svg)

Pfade und Befehlsauflösung gehört zur Linux-Sanierung v192. Die Seite behandelt das Thema nicht als Befehlsliste, sondern als Betriebsentscheidung: Was ist der aktuelle Zustand, welche Änderung ist wirklich nötig und wie wird danach geprüft, ob das System stabil bleibt?

## Worum es geht

Der Kern ist: **path und absolute pfade unterscheiden**. Linux-Administration wird sicherer, wenn Beobachtung und Eingriff getrennt bleiben. Erst werden Zustand, Kontext und Risiko gelesen; danach folgt eine kleine Änderung mit klarer Kontrolle.

Wichtige Leitgedanken:

- Die Shell sucht Befehle über PATH.
- Absolute Pfade umgehen die Suche.
- Gleichnamige Befehle können zu falschen Annahmen führen.
...
Pfade und Befehlsauflösung ist verstanden, wenn Zustand, Ursache, Eingriff, Kontrolle und Rückweg getrennt beschrieben werden können.
