...
description: "Verstehe einhängepunkte bewusst lesen als ruhigen Linux-Baustein für Betrieb, Diagnose und sichere Änderungen."
subject: "linux"
...
keyTakeaways:
  - "Ein Mount verbindet ein Dateisystem mit einem Pfad."
...
![Didaktische Skizze zu Mounts und Dateisysteme](/schlaufuchs-platform/images/linux/sanierung-v192/mounts-und-dateisysteme.svg)

Mounts und Dateisysteme gehört zur Linux-Sanierung v192. Die Seite behandelt das Thema nicht als Befehlsliste, sondern als Betriebsentscheidung: Was ist der aktuelle Zustand, welche Änderung ist wirklich nötig und wie wird danach geprüft, ob das System stabil bleibt?

## Worum es geht

Der Kern ist: **einhängepunkte bewusst lesen**. Linux-Administration wird sicherer, wenn Beobachtung und Eingriff getrennt bleiben. Erst werden Zustand, Kontext und Risiko gelesen; danach folgt eine kleine Änderung mit klarer Kontrolle.

Wichtige Leitgedanken:

- Ein Mount verbindet ein Dateisystem mit einem Pfad.
- Der gleiche Pfad kann je nach Mount anderes zeigen.
- /etc/fstab beeinflusst den Start.
...
Mounts und Dateisysteme ist verstanden, wenn Zustand, Ursache, Eingriff, Kontrolle und Rückweg getrennt beschrieben werden können.
