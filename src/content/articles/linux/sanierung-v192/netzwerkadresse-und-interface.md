---
title: "Netzwerkadresse und Interface"
description: "Verstehe adresse, interface und route unterscheiden als ruhigen Linux-Baustein für Betrieb, Diagnose und sichere Änderungen."
subject: "linux"
...
learningGoals:
  - "Adresse, Interface und Route unterscheiden"
  - "Beobachtung, Änderung und Kontrolle trennen"
  - "einen einfachen Rückweg oder Prüfpunkt benennen"
practiceIdeas:
  - "Erkläre eine ip-addr-Ausgabe für ein kleines System."
...
keyTakeaways:
  - "Interfaces verbinden das System mit Netzen."
...
![Didaktische Skizze zu Netzwerkadresse und Interface](/schlaufuchs-platform/images/linux/sanierung-v192/netzwerkadresse-und-interface.svg)

Netzwerkadresse und Interface gehört zur Linux-Sanierung v192. Die Seite behandelt das Thema nicht als Befehlsliste, sondern als Betriebsentscheidung: Was ist der aktuelle Zustand, welche Änderung ist wirklich nötig und wie wird danach geprüft, ob das System stabil bleibt?

## Worum es geht

Der Kern ist: **adresse, interface und route unterscheiden**. Linux-Administration wird sicherer, wenn Beobachtung und Eingriff getrennt bleiben. Erst werden Zustand, Kontext und Risiko gelesen; danach folgt eine kleine Änderung mit klarer Kontrolle.

Wichtige Leitgedanken:

- Interfaces verbinden das System mit Netzen.
- IP-Adresse, Maske und Gateway erfüllen verschiedene Rollen.
- Mehrere Interfaces können Diagnose verwirren.
...
Netzwerkadresse und Interface ist verstanden, wenn Zustand, Ursache, Eingriff, Kontrolle und Rückweg getrennt beschrieben werden können.
