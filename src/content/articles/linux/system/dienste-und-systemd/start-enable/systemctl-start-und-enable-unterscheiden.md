---
title: "Linux – systemctl start und enable unterscheiden"
description: "Lerne start und enable als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "linux"
section: "System"
topicPath:
  - "system"
...
learningGoals:
  - "Du erklärst start und enable in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "start und enable wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**start und enable** ist ein bewusst kleines Unterthema. Lerne start und enable als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>start startet jetzt, enable sorgt für den Start beim Booten.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v108-systemctl-start-und-enable-unterscheiden.svg" alt="Lernillustration zu start und enable." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Jetzt-Zustand und Boot-Zustand trennen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Jetzt-Zustand und Boot-Zustand trennen.</span></div>
