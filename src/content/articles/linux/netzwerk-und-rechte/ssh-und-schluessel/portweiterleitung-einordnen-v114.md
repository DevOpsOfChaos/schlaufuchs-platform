---
title: Portweiterleitung einordnen
description: Lokale und entfernte Ports bewusst trennen
subject: linux
...
learningGoals:
- Du erklärst Portweiterleitung einordnen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Portweiterleitung einordnen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Portweiterleitung einordnen** ist bewusst als kleines Unterthema angelegt. Lokale und entfernte Ports bewusst trennen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Dienst ist nur intern erreichbar.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Seite öffnet welchen Port?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-portweiterleitung-einordnen-v114.svg" alt="Lernillustration zu Portweiterleitung einordnen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Portseiten werden vertauscht.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Seite öffnet welchen Port?</span></div>
  </div>
</div>
