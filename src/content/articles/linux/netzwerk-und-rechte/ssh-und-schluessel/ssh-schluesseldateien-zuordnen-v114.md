---
title: SSH-Schlüsseldateien zuordnen
description: Private und öffentliche Schlüssel nicht verwechseln
subject: linux
...
learningGoals:
- Du erklärst SSH-Schlüsseldateien zuordnen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- SSH-Schlüsseldateien zuordnen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**SSH-Schlüsseldateien zuordnen** ist bewusst als kleines Unterthema angelegt. Private und öffentliche Schlüssel nicht verwechseln. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Public Key soll auf einen Server kopiert werden.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Datei darf den Rechner verlassen?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-ssh-schluesseldateien-zuordnen-v114.svg" alt="Lernillustration zu SSH-Schlüsseldateien zuordnen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der private Schlüssel wird weitergegeben.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Datei darf den Rechner verlassen?</span></div>
  </div>
</div>
