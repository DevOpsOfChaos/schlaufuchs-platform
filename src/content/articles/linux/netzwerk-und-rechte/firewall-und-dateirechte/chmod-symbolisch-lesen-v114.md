...
<div class="example-card">
  ...
  <h3>Nur die Gruppe soll Schreibrechte bekommen.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Nutzerklasse braucht welches Recht?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-chmod-symbolisch-lesen-v114.svg" alt="Lernillustration zu chmod symbolisch lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>chmod 777 wird als schnelle Lösung genutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Nutzerklasse braucht welches Recht?</span></div>
  </div>
</div>
