---
title: Firewall-Regelrichtung prüfen
description: eingehend und ausgehend unterscheiden
subject: linux
section: Feinstruktur Linux
topicPath:
- netzwerk-und-rechte
- firewall-und-dateirechte
- firewall-regelrichtung-pruefen-v114
learningGoals:
- Du erklärst Firewall-Regelrichtung prüfen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Eine ausgehende Regel wird geändert.
...
keyTakeaways:
- Firewall-Regelrichtung prüfen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Firewall-Regelrichtung prüfen** ist bewusst als kleines Unterthema angelegt. eingehend und ausgehend unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Webdienst soll erreichbar sein.</h3>
  <p>Die wichtige Frage lautet: <strong>In welche Richtung läuft die Verbindung?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-firewall-regelrichtung-pruefen-v114.svg" alt="Lernillustration zu Firewall-Regelrichtung prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Eine ausgehende Regel wird geändert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>In welche Richtung läuft die Verbindung?</span></div>
  </div>
</div>
