...
- besitz-mit-chown-korrigieren-v114
learningGoals:
- Du erklärst Besitz mit chown korrigieren als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Besitz mit chown korrigieren wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
