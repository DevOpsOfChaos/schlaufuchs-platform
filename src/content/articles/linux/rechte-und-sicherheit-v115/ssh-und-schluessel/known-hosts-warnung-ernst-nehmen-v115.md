...
learningGoals:
  - "Du erklärst known_hosts Warnung ernst nehmen an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Hat sich der Server wirklich legitim geändert?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach known_hosts Warnung ernst nehmen."
