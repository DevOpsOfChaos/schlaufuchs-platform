---
title: "Linux – Agent und Schlüsseldatei unterscheiden"
description: "Trainiere Agent und Schlüsseldatei unterscheiden als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: linux
...
learningGoals:
  - "Du erklärst Agent und Schlüsseldatei unterscheiden an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Der Agent wird mit der Datei selbst verwechselt."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Ist der Schlüssel geladen oder existiert er nur auf der Platte?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Agent und Schlüsseldatei unterscheiden."
...
<img src="/schlaufuchs-platform/illustrations/linux-agent-und-schluesseldatei-unterscheiden-v115.svg" alt="Lernillustration zu Agent und Schlüsseldatei unterscheiden" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Agent und Schlüsseldatei unterscheiden** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Ist der Schlüssel geladen oder existiert er nur auf der Platte?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Agent und Schlüsseldatei unterscheiden</h3>
  <p>Ein Login funktioniert nur in einer Sitzung.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Agent und Schlüsseldatei unterscheiden sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Der Agent wird mit der Datei selbst verwechselt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Der Agent wird mit der Datei selbst verwechselt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Agent und Schlüsseldatei unterscheiden bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
