...
Systemressourcen beschreiben, welche begrenzten Mittel ein Rechner laufenden Programmen bereitstellt. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Systemressourcen](/schlaufuchs-platform/images/overviews/v147/systemressourcen.svg)

*Überblick über CPU, Speicher, I/O, Netzwerk und Prozesse als begrenzte Ressourcen eines Linux-Systems.*

## Grundidee

Systemressourcen beschreiben, welche begrenzten Mittel ein Rechner laufenden Programmen bereitstellt. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Systemressourcen hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Prozesslast:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Speichernutzung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **I/O-Wartezeit:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Netzwerkverkehr:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Systemressourcen beschreiben, welche begrenzten Mittel ein Rechner laufenden Programmen bereitstellt. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
