---
title: "Linux-Sicherheitsmodell im Überblick"
description: "Linux schützt Systeme über Benutzer, Rechte, Prozesse, Dienste und Protokolle. Wichtig ist, diese Ebenen getrennt zu lesen."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "security-grundlagen", "sicherheitsmodell", "betrieb"]
draft: false
---
![Linux-Sicherheitsmodell im Überblick](/schlaufuchs-platform/images/linux/sanierung-v199-security-automation/linux-sicherheitsmodell-ueberblick.svg)

Linux schützt Systeme über Benutzer, Rechte, Prozesse, Dienste und Protokolle. Wichtig ist, diese Ebenen getrennt zu lesen.
...
Linux-Sicherheitsmodell im Überblick wird beherrschbar, wenn du Zustand, Ursache, Eingriff und Kontrolle sauber trennst.
