---
title: "SSH-Keys und Agenten"
description: "Schlüssel ersetzen Passwörter nur dann sinnvoll, wenn private Schlüssel geschützt und nachvollziehbar genutzt werden."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "remote-zugriff", "ssh-keys", "betrieb"]
draft: false
---
![SSH-Keys und Agenten](/schlaufuchs-platform/images/linux/sanierung-v199-security-automation/ssh-keys-und-agenten.svg)

Schlüssel ersetzen Passwörter nur dann sinnvoll, wenn private Schlüssel geschützt und nachvollziehbar genutzt werden.
...
SSH-Keys und Agenten wird beherrschbar, wenn du Zustand, Ursache, Eingriff und Kontrolle sauber trennst.
