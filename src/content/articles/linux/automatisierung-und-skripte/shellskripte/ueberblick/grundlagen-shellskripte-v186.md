...
**Shellskripte** ist ein wichtiges Linux-Thema, weil es nicht nur aus einem einzelnen Befehl besteht. Entscheidend ist, welche Rolle das Thema im System spielt, welcher Kontext geprüft werden muss und welche Grenzen es gibt.

## Warum das Thema wichtig ist

Shellskripte machen wiederkehrende Befehlsfolgen reproduzierbar. Parameter und Exit-Codes machen Skripte besser steuerbar. Dadurch lassen sich Befehle, Ausgaben und Fehlersituationen geordneter lesen.
...
Ein Skript ist nicht automatisch robust, nur weil es einmal funktioniert hat. Diese Abgrenzung verhindert, dass ein einzelnes Symptom vorschnell als Ursache behandelt wird.
