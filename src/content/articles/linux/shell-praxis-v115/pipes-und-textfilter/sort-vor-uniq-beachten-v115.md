---
title: "Linux – sort vor uniq beachten"
description: "Trainiere sort vor uniq beachten als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
subject: linux
...
learningGoals:
  - "Du erklärst sort vor uniq beachten an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "uniq wird auf unsortierte Daten angewendet."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Liegen gleiche Zeilen direkt hintereinander?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach sort vor uniq beachten."
...
<img src="/schlaufuchs-platform/illustrations/linux-sort-vor-uniq-beachten-v115.svg" alt="Lernillustration zu sort vor uniq beachten" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **sort vor uniq beachten** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Liegen gleiche Zeilen direkt hintereinander?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: sort vor uniq beachten</h3>
  <p>Doppelte Zeilen sollen gezählt werden.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>sort vor uniq beachten sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>uniq wird auf unsortierte Daten angewendet.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: uniq wird auf unsortierte Daten angewendet. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> sort vor uniq beachten bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
