...
learningGoals:
  - "Du erklärst tail für laufende Logs verwenden an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Soll die Ausgabe neuen Zeilen folgen?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach tail für laufende Logs verwenden."
