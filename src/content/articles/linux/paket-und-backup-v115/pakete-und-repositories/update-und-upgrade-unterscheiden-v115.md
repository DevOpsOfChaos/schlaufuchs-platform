...
Dieses Unterthema behandelt **Update und Upgrade unterscheiden** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Werden nur Informationen aktualisiert oder wirklich Pakete ersetzt?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Update und Upgrade unterscheiden</h3>
  <p>Ein System soll aktualisiert werden.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Update und Upgrade unterscheiden sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Paketlisten erneuern und Pakete aktualisieren werden gleichgesetzt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Paketlisten erneuern und Pakete aktualisieren werden gleichgesetzt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Update und Upgrade unterscheiden bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
