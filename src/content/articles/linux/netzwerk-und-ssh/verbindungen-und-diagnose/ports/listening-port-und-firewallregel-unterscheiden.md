---
title: "Linux – Listening Port und Firewallregel unterscheiden"
description: "Lerne Portdiagnose als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Portdiagnose als enges Unterthema."
...
commonMistakes:
  - "Ein offener lokaler Port wird als externe Erreichbarkeit gelesen."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Portdiagnose wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Portdiagnose** ist bewusst als kleines Unterthema angelegt. Lerne Portdiagnose als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Dienst läuft, ist aber von außen nicht erreichbar.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-listening-port-und-firewallregel-unterscheiden.svg" alt="Lernillustration zu Portdiagnose." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Ein offener lokaler Port wird als externe Erreichbarkeit gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe ss lokal und Firewall oder Routing separat.</span></div>
  </div>
</div>
