---
title: "Linux – SSH-Schlüsseldatei und Public Key trennen"
...
<div class="example-card">
  ...
  <h3>Ein Public Key soll auf den Server kopiert werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-ssh-schluesseldatei-und-public-key-trennen.svg" alt="Lernillustration zu SSH-Key-Dateien." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Privater und öffentlicher Schlüssel werden verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe Dateiname, Inhalt und Zielort authorized_keys.</span></div>
  </div>
</div>
