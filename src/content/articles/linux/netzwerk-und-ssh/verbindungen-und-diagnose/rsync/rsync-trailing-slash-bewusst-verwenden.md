---
title: "Linux – rsync-Trailing-Slash bewusst verwenden"
...
<div class="example-card">
  ...
  <h3>Ein Verzeichnis wird mit oder ohne abschließenden Slash synchronisiert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-rsync-trailing-slash-bewusst-verwenden.svg" alt="Lernillustration zu rsync-Pfade." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Quelle und Inhalt der Quelle werden verwechselt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Vergleiche vorab mit --dry-run, was im Ziel entsteht.</span></div>
  </div>
</div>
