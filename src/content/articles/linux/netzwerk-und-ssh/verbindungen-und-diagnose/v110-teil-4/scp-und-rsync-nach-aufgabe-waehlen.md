---
title: "Linux – scp und rsync nach Aufgabe wählen"
description: "Lerne scp und rsync nach Aufgabe wählen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
subject: "linux"
section: "Netzwerk"
topicPath:
  - "netzwerk-und-ssh"
...
learningGoals:
  - "Du erklärst scp und rsync nach Aufgabe wählen als eigenes Unterthema."
...
commonMistakes:
  - "Jede Dateiübertragung wird mit scp erledigt."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "scp und rsync nach Aufgabe wählen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**scp und rsync nach Aufgabe wählen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Ordner soll wiederholt auf einen Server übertragen werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v110-scp-und-rsync-nach-aufgabe-waehlen.svg" alt="Lernillustration zu scp und rsync nach Aufgabe wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Jede Dateiübertragung wird mit scp erledigt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Nutze rsync, wenn Unterschiede und Wiederholung wichtig sind.</span></div>
  </div>
</div>
