---
title: "Linux – DNS-Fehler von Verbindungsfehler trennen"
description: "Lerne DNS und Verbindung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst DNS und Verbindung als enges Unterthema."
...
commonMistakes:
  - "Namensauflösung und Dienstverbindung werden vermischt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "DNS und Verbindung wird durch Kontext, Abgrenzung und Prüfung klar."
...
**DNS und Verbindung** ist bewusst als kleines Unterthema angelegt. Lerne DNS und Verbindung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Hostname ist nicht erreichbar.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-dns-fehler-von-verbindungsfehler-trennen.svg" alt="Lernillustration zu DNS und Verbindung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Namensauflösung und Dienstverbindung werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Teste Name, IP-Erreichbarkeit und Port getrennt.</span></div>
  </div>
</div>
