---
title: "Image-Cleanup – Überblick"
description: "Ein ruhiger Linux-Überblick zu Image-Cleanup: Zustand, Signal, Aktion, Kontrolle und Rückfallweg werden getrennt."
subject: "linux"
...
selfCheckPoints: []
level: "einfach"
tags: ["linux", "container-host-und-runtime-betrieb", "image-cleanup", "betrieb", "recovery", "v212"]
draft: false
---
![Image-Cleanup](/schlaufuchs-platform/images/linux/sanierung-v212-betrieb-recovery/image-cleanup.svg)

## Worum es hier geht

**Image-Cleanup** ist ein Linux-Betriebsthema. Ziel ist eine ruhige Vorgehensweise: erst Zustand erfassen, dann ein belastbares Signal wählen, danach klein ändern und am Ende Kontrolle und Rückfallweg dokumentieren.
...
Image-Cleanup ist sauber bearbeitet, wenn Zustand, Signal, Aktion, Kontrolle und Recovery getrennt sichtbar sind.
