---
title: "Volumes – Überblick"
description: "Ein ruhiger Linux-Überblick zu Volumes: Zustand, Signal, Aktion, Kontrolle und Rückfallweg werden getrennt."
subject: "linux"
...
selfCheckPoints: []
level: "einfach"
tags: ["linux", "container-host-und-runtime-betrieb", "volumes", "betrieb", "recovery", "v212"]
draft: false
---
![Volumes](/schlaufuchs-platform/images/linux/sanierung-v212-betrieb-recovery/volumes.svg)

## Worum es hier geht

**Volumes** ist ein Linux-Betriebsthema. Ziel ist eine ruhige Vorgehensweise: erst Zustand erfassen, dann ein belastbares Signal wählen, danach klein ändern und am Ende Kontrolle und Rückfallweg dokumentieren.
...
Volumes ist sauber bearbeitet, wenn Zustand, Signal, Aktion, Kontrolle und Recovery getrennt sichtbar sind.
