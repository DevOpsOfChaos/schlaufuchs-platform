---
title: "Postmortem – Überblick"
description: "Ein ruhiger Linux-Überblick zu Postmortem: Zustand, Signal, Aktion, Kontrolle und Rückfallweg werden getrennt."
subject: "linux"
...
selfCheckPoints: []
level: "mittel"
tags: ["linux", "incident-response-und-runbooks", "postmortem", "betrieb", "recovery", "v212"]
draft: false
---
![Postmortem](/schlaufuchs-platform/images/linux/sanierung-v212-betrieb-recovery/postmortem.svg)

## Worum es hier geht

**Postmortem** ist ein Linux-Betriebsthema. Ziel ist eine ruhige Vorgehensweise: erst Zustand erfassen, dann ein belastbares Signal wählen, danach klein ändern und am Ende Kontrolle und Rückfallweg dokumentieren.
...
Postmortem ist sauber bearbeitet, wenn Zustand, Signal, Aktion, Kontrolle und Recovery getrennt sichtbar sind.
