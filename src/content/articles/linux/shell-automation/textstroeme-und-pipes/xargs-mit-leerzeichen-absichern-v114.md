...
learningGoals:
- Du erklärst xargs mit Leerzeichen absichern als klar abgegrenztes Unterthema.
...
commonMistakes:
- xargs trennt ungewollt am Leerzeichen.
...
keyTakeaways:
- xargs mit Leerzeichen absichern wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
