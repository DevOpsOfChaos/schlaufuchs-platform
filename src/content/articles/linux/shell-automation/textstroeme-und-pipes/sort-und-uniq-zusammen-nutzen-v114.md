---
title: sort und uniq zusammen nutzen
description: Duplikate erst nach Sortierung zählen
subject: linux
...
learningGoals:
- Du erklärst sort und uniq zusammen nutzen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- sort und uniq zusammen nutzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**sort und uniq zusammen nutzen** ist bewusst als kleines Unterthema angelegt. Duplikate erst nach Sortierung zählen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Liste enthält wiederholte Benutzernamen.</h3>
  <p>Die wichtige Frage lautet: <strong>Sind gleiche Zeilen nebeneinander?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-sort-und-uniq-zusammen-nutzen-v114.svg" alt="Lernillustration zu sort und uniq zusammen nutzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>uniq wird auf unsortierte Daten angewendet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Sind gleiche Zeilen nebeneinander?</span></div>
  </div>
</div>
