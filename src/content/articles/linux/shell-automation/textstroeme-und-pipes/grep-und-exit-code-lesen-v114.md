---
title: grep und Exit-Code lesen
description: Trefferlogik von Textausgabe trennen
subject: linux
...
learningGoals:
- Du erklärst grep und Exit-Code lesen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Nur die sichtbare Ausgabe wird betrachtet.
...
keyTakeaways:
- grep und Exit-Code lesen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**grep und Exit-Code lesen** ist bewusst als kleines Unterthema angelegt. Trefferlogik von Textausgabe trennen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Skript prüft, ob ein Muster vorkommt.</h3>
  <p>Die wichtige Frage lautet: <strong>Was bedeutet Exit-Code 0, 1 oder 2?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-grep-und-exit-code-lesen-v114.svg" alt="Lernillustration zu grep und Exit-Code lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur die sichtbare Ausgabe wird betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Was bedeutet Exit-Code 0, 1 oder 2?</span></div>
  </div>
</div>
