---
title: Dry-Run-Modus einbauen
description: Gefährliche Aktionen vorher sichtbar machen
subject: linux
...
learningGoals:
- Du erklärst Dry-Run-Modus einbauen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Der erste Test löscht echte Daten.
...
keyTakeaways:
- Dry-Run-Modus einbauen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Dry-Run-Modus einbauen** ist bewusst als kleines Unterthema angelegt. Gefährliche Aktionen vorher sichtbar machen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Skript löscht alte Dateien.</h3>
  <p>Die wichtige Frage lautet: <strong>Kann das Skript zuerst nur anzeigen, was es tun würde?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-dry-run-modus-einbauen-v114.svg" alt="Lernillustration zu Dry-Run-Modus einbauen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der erste Test löscht echte Daten.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Kann das Skript zuerst nur anzeigen, was es tun würde?</span></div>
  </div>
</div>
