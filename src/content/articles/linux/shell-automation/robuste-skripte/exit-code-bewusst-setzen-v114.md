---
title: Exit-Code bewusst setzen
description: Skripterfolg für andere Programme lesbar machen
subject: linux
...
learningGoals:
- Du erklärst Exit-Code bewusst setzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Fehler werden nur auf dem Bildschirm ausgegeben.
...
keyTakeaways:
- Exit-Code bewusst setzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Exit-Code bewusst setzen** ist bewusst als kleines Unterthema angelegt. Skripterfolg für andere Programme lesbar machen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Build-Skript wird in CI genutzt.</h3>
  <p>Die wichtige Frage lautet: <strong>Welchen Status sieht der aufrufende Prozess?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-exit-code-bewusst-setzen-v114.svg" alt="Lernillustration zu Exit-Code bewusst setzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Fehler werden nur auf dem Bildschirm ausgegeben.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welchen Status sieht der aufrufende Prozess?</span></div>
  </div>
</div>
