...
learningGoals:
- Du erklärst Temporäre Dateien sicher nutzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Immer derselbe Dateiname in /tmp wird genutzt.
...
keyTakeaways:
- Temporäre Dateien sicher nutzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
