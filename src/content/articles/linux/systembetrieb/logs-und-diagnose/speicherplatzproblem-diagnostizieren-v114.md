---
title: Speicherplatzproblem diagnostizieren
description: df und du passend kombinieren
subject: linux
...
learningGoals:
- Du erklärst Speicherplatzproblem diagnostizieren als klar abgegrenztes Unterthema.
...
commonMistakes:
- Nur ein Verzeichnis wird geraten.
...
keyTakeaways:
- Speicherplatzproblem diagnostizieren wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Speicherplatzproblem diagnostizieren** ist bewusst als kleines Unterthema angelegt. df und du passend kombinieren. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Partition ist voll.</h3>
  <p>Die wichtige Frage lautet: <strong>Ist das Dateisystem voll oder ein Pfad besonders groß?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-speicherplatzproblem-diagnostizieren-v114.svg" alt="Lernillustration zu Speicherplatzproblem diagnostizieren." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur ein Verzeichnis wird geraten.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist das Dateisystem voll oder ein Pfad besonders groß?</span></div>
  </div>
</div>
