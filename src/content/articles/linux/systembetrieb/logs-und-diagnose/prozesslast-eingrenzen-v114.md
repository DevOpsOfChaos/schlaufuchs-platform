---
title: Prozesslast eingrenzen
description: CPU, Speicher und I/O unterscheiden
subject: linux
...
learningGoals:
- Du erklärst Prozesslast eingrenzen als klar abgegrenztes Unterthema.
...
commonMistakes:
- top wird nur nach dem ersten Prozess beurteilt.
...
keyTakeaways:
- Prozesslast eingrenzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Prozesslast eingrenzen** ist bewusst als kleines Unterthema angelegt. CPU, Speicher und I/O unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein System reagiert langsam.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Ressource ist tatsächlich knapp?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-prozesslast-eingrenzen-v114.svg" alt="Lernillustration zu Prozesslast eingrenzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>top wird nur nach dem ersten Prozess beurteilt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Ressource ist tatsächlich knapp?</span></div>
  </div>
</div>
