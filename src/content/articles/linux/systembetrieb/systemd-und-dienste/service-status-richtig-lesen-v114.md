---
title: Service-Status richtig lesen
description: active, failed und exited unterscheiden
subject: linux
...
learningGoals:
- Du erklärst Service-Status richtig lesen als klar abgegrenztes Unterthema.
...
commonMistakes:
- exited wird automatisch als Fehler gelesen.
...
keyTakeaways:
- Service-Status richtig lesen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Service-Status richtig lesen** ist bewusst als kleines Unterthema angelegt. active, failed und exited unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Dienst startet und beendet sich sofort.</h3>
  <p>Die wichtige Frage lautet: <strong>Ist ein dauerhaft laufender Prozess erwartet?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v114-service-status-richtig-lesen-v114.svg" alt="Lernillustration zu Service-Status richtig lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>exited wird automatisch als Fehler gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist ein dauerhaft laufender Prozess erwartet?</span></div>
  </div>
</div>
