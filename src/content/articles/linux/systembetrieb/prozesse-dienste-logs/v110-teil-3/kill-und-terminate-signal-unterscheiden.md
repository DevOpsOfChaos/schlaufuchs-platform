---
title: "Linux – kill und Terminate-Signal unterscheiden"
...
<div class="example-card">
  ...
  <h3>Ein Prozess soll beendet werden, reagiert aber nicht sofort.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v110-kill-und-terminate-signal-unterscheiden.svg" alt="Lernillustration zu kill und Terminate-Signal unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>kill wird automatisch mit hartem Töten gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Unterscheide SIGTERM, SIGKILL und sauberes Beenden.</span></div>
  </div>
</div>
