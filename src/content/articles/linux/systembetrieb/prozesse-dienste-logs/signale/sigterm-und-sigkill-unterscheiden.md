---
title: "Linux – SIGTERM und SIGKILL unterscheiden"
description: "Lerne Prozesssignale als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Prozesssignale als enges Unterthema."
...
**Prozesssignale** ist bewusst als kleines Unterthema angelegt. Lerne Prozesssignale als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Prozess reagiert nicht sofort auf Stop.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-sigterm-und-sigkill-unterscheiden.svg" alt="Lernillustration zu Prozesssignale." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jeder Abbruch wird als hartes Töten verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Versuche zuerst sauberes Beenden, bevor SIGKILL eingesetzt wird.</span></div>
  </div>
</div>
