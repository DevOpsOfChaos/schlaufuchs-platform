---
title: "Linux – sudo nur für konkrete Handlung einsetzen"
description: "Lerne sudo-Grenzen als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst sudo-Grenzen als enges Unterthema."
...
**sudo-Grenzen** ist bewusst als kleines Unterthema angelegt. Lerne sudo-Grenzen als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Befehl scheitert und wird sofort mit sudo wiederholt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-sudo-nur-fuer-konkrete-handlung-einsetzen.svg" alt="Lernillustration zu sudo-Grenzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>sudo wird als allgemeine Reparatur gesehen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, welche Datei oder Handlung wirklich erhöhte Rechte braucht.</span></div>
  </div>
</div>
