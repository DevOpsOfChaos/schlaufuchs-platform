---
title: "Linux – Sticky Bit in gemeinsamem Verzeichnis verstehen"
description: "Lerne Sticky Bit als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Sticky Bit als enges Unterthema."
...
commonMistakes:
  - "Schreibrecht wird als Löschrecht für fremde Dateien verstanden."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Sticky Bit wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Sticky Bit** ist bewusst als kleines Unterthema angelegt. Lerne Sticky Bit als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Mehrere Nutzer schreiben in dasselbe temporäre Verzeichnis.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v111-sticky-bit-in-gemeinsamem-verzeichnis-verstehen.svg" alt="Lernillustration zu Sticky Bit." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Schreibrecht wird als Löschrecht für fremde Dateien verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob nur Eigentümer ihre Dateien löschen dürfen.</span></div>
  </div>
</div>
