...
<div class="example-card">
  ...
  <h3>Eine Datei gehört dem falschen Nutzer, hat aber passende Rechte.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v110-chown-und-chmod-nicht-verwechseln.svg" alt="Lernillustration zu chown und chmod nicht verwechseln." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Besitz und Berechtigung werden gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Prüfe zuerst Eigentümer und Gruppe, dann den Modus.</span></div>
  </div>
</div>
