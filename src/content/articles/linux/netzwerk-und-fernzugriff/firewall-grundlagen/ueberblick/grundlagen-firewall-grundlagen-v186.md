...
**Firewall-Grundlagen** ist ein wichtiges Linux-Thema, weil es nicht nur aus einem einzelnen Befehl besteht. Entscheidend ist, welche Rolle das Thema im System spielt, welcher Kontext geprüft werden muss und welche Grenzen es gibt.

## Warum das Thema wichtig ist

Firewalls entscheiden anhand von Regeln über Netzwerkverkehr. Richtung, Schnittstelle, Port und Zustand können relevant sein. Dadurch lassen sich Befehle, Ausgaben und Fehlersituationen geordneter lesen.
...
Firewall aus bedeutet nicht automatisch sicheres oder korrektes Netzwerkverhalten. Diese Abgrenzung verhindert, dass ein einzelnes Symptom vorschnell als Ursache behandelt wird.
