---
title: "Relativen und absoluten Pfad trennen"
description: "Lerne Relativen und absoluten Pfad trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
section: "Feinstruktur Linux"
topicPath:
  - "shell"
  - "orientierung-und-pfade"
  - "relativen-und-absoluten-pfad-trennen-v113"
learningGoals:
  - "Du erklärst Relativen und absoluten Pfad trennen als enges Unterthema."
...
commonMistakes:
  - "Relative Pfade werden wie absolute Pfade behandelt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Relativen und absoluten Pfad trennen wird über eine kleine Trennkante verständlich."
...
**Relativen und absoluten Pfad trennen** ist bewusst als kleines Unterthema angelegt. Lerne Relativen und absoluten Pfad trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Skript funktioniert nur aus einem bestimmten Startordner.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-relativen-und-absoluten-pfad-trennen-v113.svg" alt="Lernillustration zu Relativen und absoluten Pfad trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Relative Pfade werden wie absolute Pfade behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wovon hängt der relative Pfad ab?</span></div>
  </div>
</div>
