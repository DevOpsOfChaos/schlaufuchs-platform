---
title: "Linux – Relative Pfade vor Befehl prüfen"
description: "Lerne relative pfade vor befehl prüfen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "linux"
...
learningGoals:
  - "Du erklärst relative pfade vor befehl prüfen in einem klaren Kontext."
...
**Relative Pfade vor Befehl prüfen** ist bewusst als kleines Unterthema angelegt. Lerne relative pfade vor befehl prüfen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Befehl arbeitet im falschen Ordner.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Orientierung und Pfade“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Relative Pfade hängen immer vom aktuellen Arbeitsverzeichnis ab.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der Pfad wird unabhängig vom Standort gelesen.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Relative Pfade hängen immer vom aktuellen Arbeitsverzeichnis ab.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Befehl arbeitet im falschen Ordner.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Orientierung und Pfade** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Relative Pfade hängen immer vom aktuellen Arbeitsverzeichnis ab.</p>
</div>
