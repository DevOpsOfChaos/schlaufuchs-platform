---
title: "Arbeitsverzeichnis vor Befehlen prüfen"
description: "Lerne Arbeitsverzeichnis vor Befehlen prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Arbeitsverzeichnis vor Befehlen prüfen als enges Unterthema."
...
commonMistakes:
  - "Dateiname wird ohne aktuellen Pfad bewertet."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Arbeitsverzeichnis vor Befehlen prüfen wird über eine kleine Trennkante verständlich."
...
**Arbeitsverzeichnis vor Befehlen prüfen** ist bewusst als kleines Unterthema angelegt. Lerne Arbeitsverzeichnis vor Befehlen prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Befehl wird im falschen Ordner ausgeführt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-arbeitsverzeichnis-vor-befehlen-pruefen-v113.svg" alt="Lernillustration zu Arbeitsverzeichnis vor Befehlen prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Dateiname wird ohne aktuellen Pfad bewertet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Was zeigt pwd direkt vor dem Befehl?</span></div>
  </div>
</div>
