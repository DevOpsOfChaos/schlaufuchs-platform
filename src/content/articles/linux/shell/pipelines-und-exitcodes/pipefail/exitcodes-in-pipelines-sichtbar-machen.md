---
title: "Linux – Exitcodes in Pipelines sichtbar machen"
description: "Lerne Pipeline-Exitcodes als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "linux"
section: "Shell"
topicPath:
  - "shell"
...
learningGoals:
  - "Du erklärst Pipeline-Exitcodes in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Pipeline-Exitcodes wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Pipeline-Exitcodes** ist ein bewusst kleines Unterthema. Lerne Pipeline-Exitcodes als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ohne pipefail kann eine Pipeline erfolgreich wirken, obwohl ein früherer Schritt scheitert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v108-exitcodes-in-pipelines-sichtbar-machen.svg" alt="Lernillustration zu Pipeline-Exitcodes." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Exitstatus des relevanten Schritts prüfen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Exitstatus des relevanten Schritts prüfen.</span></div>
