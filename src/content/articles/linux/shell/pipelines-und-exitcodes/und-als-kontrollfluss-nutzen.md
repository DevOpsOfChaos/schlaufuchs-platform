---
title: "Linux – && und || als Kontrollfluss nutzen"
description: "Lerne && und || als kontrollfluss nutzen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "linux"
...
learningGoals:
  - "Du erklärst && und || als kontrollfluss nutzen in einem klaren Kontext."
...
**&& und || als Kontrollfluss nutzen** ist bewusst als kleines Unterthema angelegt. Lerne && und || als kontrollfluss nutzen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein zweiter Befehl soll nur bei Erfolg laufen.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Pipelines und Exitcodes“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Logische Operatoren steuern Befehlsketten über Exitcodes.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Die Operatoren werden wie Satzzeichen gelesen.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Logische Operatoren steuern Befehlsketten über Exitcodes.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein zweiter Befehl soll nur bei Erfolg laufen.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Pipelines und Exitcodes** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Logische Operatoren steuern Befehlsketten über Exitcodes.</p>
</div>
