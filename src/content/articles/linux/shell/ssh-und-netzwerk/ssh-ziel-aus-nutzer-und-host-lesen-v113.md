---
title: "SSH-Ziel aus Nutzer und Host lesen"
...
<div class="example-card">
  ...
  <h3>Eine Verbindung schlägt fehl, obwohl der Host erreichbar ist.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-ssh-ziel-aus-nutzer-und-host-lesen-v113.svg" alt="Lernillustration zu SSH-Ziel aus Nutzer und Host lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Hostproblem und falscher Benutzer werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Kombination aus Nutzername und Host wird verwendet?</span></div>
  </div>
</div>
