...
description: "Lerne kill-signal passend wählen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "linux"
...
**kill-Signal passend wählen** ist bewusst als kleines Unterthema angelegt. Lerne kill-signal passend wählen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Prozess soll beendet werden.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Signale unterscheiden Bitte, Abbruch und harte Beendigung.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>kill wird immer als brutales Löschen verstanden.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Signale unterscheiden Bitte, Abbruch und harte Beendigung.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Prozess soll beendet werden.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Signale unterscheiden Bitte, Abbruch und harte Beendigung.</p>
</div>
