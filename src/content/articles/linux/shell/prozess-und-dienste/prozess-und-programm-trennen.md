---
title: "Linux – Prozess und Programm trennen"
description: "Lerne prozess und programm trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "linux"
...
learningGoals:
  - "Du erklärst prozess und programm trennen in einem klaren Kontext."
...
**Prozess und Programm trennen** ist bewusst als kleines Unterthema angelegt. Lerne prozess und programm trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Programm läuft mehrfach gleichzeitig.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Ein Prozess ist eine laufende Instanz eines Programms.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Programmdatei und laufender Prozess werden gleichgesetzt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Ein Prozess ist eine laufende Instanz eines Programms.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Programm läuft mehrfach gleichzeitig.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Ein Prozess ist eine laufende Instanz eines Programms.</p>
</div>
