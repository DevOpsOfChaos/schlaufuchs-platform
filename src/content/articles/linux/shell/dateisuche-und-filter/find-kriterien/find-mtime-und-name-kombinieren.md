---
title: "Linux – find mit mtime und name kombinieren"
description: "Lerne find-Kriterien als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "linux"
section: "Shell"
topicPath:
  - "shell"
...
learningGoals:
  - "Du erklärst find-Kriterien in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "find-Kriterien wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**find-Kriterien** ist ein bewusst kleines Unterthema. Lerne find-Kriterien als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>find wird präziser, wenn Name, Typ und Änderungszeit bewusst kombiniert werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v108-find-mtime-und-name-kombinieren.svg" alt="Lernillustration zu find-Kriterien." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Kriterien als UND-Verknüpfung lesen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Kriterien als UND-Verknüpfung lesen.</span></div>
