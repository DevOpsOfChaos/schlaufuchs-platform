---
title: "Prozess und Programm unterscheiden"
description: "Lerne Prozess und Programm unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Prozess und Programm unterscheiden als enges Unterthema."
...
commonMistakes:
  - "Programmdatei und laufender Prozess werden gleichgesetzt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Prozess und Programm unterscheiden wird über eine kleine Trennkante verständlich."
...
**Prozess und Programm unterscheiden** ist bewusst als kleines Unterthema angelegt. Lerne Prozess und Programm unterscheiden als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Programm kann mehrfach laufen und mehrere Einträge erzeugen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-prozess-und-programm-unterscheiden-v113.svg" alt="Lernillustration zu Prozess und Programm unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Programmdatei und laufender Prozess werden gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Geht es um die Datei oder um eine laufende Instanz?</span></div>
  </div>
</div>
