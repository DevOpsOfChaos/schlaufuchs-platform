---
title: "head und tail nach Fragestellung wählen"
description: "Lerne head und tail nach Fragestellung wählen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst head und tail nach Fragestellung wählen als enges Unterthema."
...
commonMistakes:
  - "Die ganze Datei wird geöffnet, obwohl nur ein Ausschnitt gebraucht wird."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "head und tail nach Fragestellung wählen wird über eine kleine Trennkante verständlich."
...
**head und tail nach Fragestellung wählen** ist bewusst als kleines Unterthema angelegt. Lerne head und tail nach Fragestellung wählen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Logdatei wird untersucht und nur der relevante Anfang oder Schluss zählt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-head-und-tail-nach-fragestellung-waehlen-v113.svg" alt="Lernillustration zu head und tail nach Fragestellung wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die ganze Datei wird geöffnet, obwohl nur ein Ausschnitt gebraucht wird.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Interessiert der Start, das Ende oder ein laufender Strom?</span></div>
  </div>
</div>
