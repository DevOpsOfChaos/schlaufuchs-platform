---
title: "Installieren und Aktualisieren trennen"
description: "Lerne Installieren und Aktualisieren trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Installieren und Aktualisieren trennen als enges Unterthema."
...
commonMistakes:
  - "Vorhanden wird mit aktuell gleichgesetzt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Installieren und Aktualisieren trennen wird über eine kleine Trennkante verständlich."
...
**Installieren und Aktualisieren trennen** ist bewusst als kleines Unterthema angelegt. Lerne Installieren und Aktualisieren trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Paket ist installiert, aber veraltet.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-installieren-und-aktualisieren-trennen-v113.svg" alt="Lernillustration zu Installieren und Aktualisieren trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Vorhanden wird mit aktuell gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wurde nur installiert oder auch die Paketliste aktualisiert?</span></div>
  </div>
</div>
