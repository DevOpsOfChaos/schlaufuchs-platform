---
title: "Linux – grep, cut und sort als lesbare Pipeline aufbauen"
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v107-grep-cut-sort-als-lesbare-pipeline-aufbauen.svg" alt="Lernillustration zu Pipeline-Aufbau." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
