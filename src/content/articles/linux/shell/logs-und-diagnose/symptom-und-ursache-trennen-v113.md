...
description: "Lerne Symptom und Ursache trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Symptom und Ursache trennen als enges Unterthema."
...
commonMistakes:
  - "Die letzte Meldung wird automatisch als Ursache gelesen."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Symptom und Ursache trennen wird über eine kleine Trennkante verständlich."
...
**Symptom und Ursache trennen** ist bewusst als kleines Unterthema angelegt. Lerne Symptom und Ursache trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Fehlermeldung beschreibt nur die Folge eines früheren Problems.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-symptom-und-ursache-trennen-v113.svg" alt="Lernillustration zu Symptom und Ursache trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die letzte Meldung wird automatisch als Ursache gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche vorherige Logzeile erklärt das erste Auftreten?</span></div>
  </div>
</div>
