---
title: "Linux – sort und uniq in richtiger Reihenfolge nutzen"
description: "Lerne sort und uniq in richtiger reihenfolge nutzen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "linux"
...
learningGoals:
  - "Du erklärst sort und uniq in richtiger reihenfolge nutzen in einem klaren Kontext."
...
**sort und uniq in richtiger Reihenfolge nutzen** ist bewusst als kleines Unterthema angelegt. Lerne sort und uniq in richtiger reihenfolge nutzen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Doppelte Zeilen sollen gezählt werden.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>uniq erkennt nur benachbarte Dubletten.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>uniq wird ohne vorherige Sortierung eingesetzt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>uniq erkennt nur benachbarte Dubletten.</span>
    </div>
  </div>
</div>
...
```text
Situation: Doppelte Zeilen sollen gezählt werden.
...
<div class="note-panel">
  <p><strong>Merke:</strong> uniq erkennt nur benachbarte Dubletten.</p>
</div>
