---
title: "Versteckte Dateien bewusst anzeigen"
description: "Lerne Versteckte Dateien bewusst anzeigen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
**Versteckte Dateien bewusst anzeigen** ist bewusst als kleines Unterthema angelegt. Lerne Versteckte Dateien bewusst anzeigen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Konfigurationsdatei wird nicht gefunden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-versteckte-dateien-bewusst-anzeigen-v113.svg" alt="Lernillustration zu Versteckte Dateien bewusst anzeigen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>ls ohne Optionen wird als vollständige Sicht verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wurde mit ls -a geprüft?</span></div>
  </div>
</div>
