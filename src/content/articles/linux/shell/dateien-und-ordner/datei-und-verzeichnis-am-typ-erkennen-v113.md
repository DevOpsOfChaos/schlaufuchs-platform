---
title: "Datei und Verzeichnis am Typ erkennen"
description: "Lerne Datei und Verzeichnis am Typ erkennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Datei und Verzeichnis am Typ erkennen als enges Unterthema."
...
commonMistakes:
  - "Name und Typ werden nur aus der Endung geraten."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Datei und Verzeichnis am Typ erkennen wird über eine kleine Trennkante verständlich."
...
**Datei und Verzeichnis am Typ erkennen** ist bewusst als kleines Unterthema angelegt. Lerne Datei und Verzeichnis am Typ erkennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Befehl schlägt fehl, weil ein Pfad ein Ordner ist.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-datei-und-verzeichnis-am-typ-erkennen-v113.svg" alt="Lernillustration zu Datei und Verzeichnis am Typ erkennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Name und Typ werden nur aus der Endung geraten.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Was zeigt ls -l am ersten Zeichen?</span></div>
  </div>
</div>
