---
title: "Archiv und Kompression trennen"
description: "Lerne Archiv und Kompression trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
subject: "linux"
...
learningGoals:
  - "Du erklärst Archiv und Kompression trennen als enges Unterthema."
...
commonMistakes:
  - "Packen und Komprimieren werden als dasselbe verstanden."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Archiv und Kompression trennen wird über eine kleine Trennkante verständlich."
...
**Archiv und Kompression trennen** ist bewusst als kleines Unterthema angelegt. Lerne Archiv und Kompression trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Datei endet auf tar.gz und enthält mehrere Dateien.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/linux-v113-archiv-und-kompression-trennen-v113.svg" alt="Lernillustration zu Archiv und Kompression trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Packen und Komprimieren werden als dasselbe verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wird gesammelt, verkleinert oder beides gemacht?</span></div>
  </div>
</div>
