...
Im Bereich Netzwerk steht Routing unter Linux für einen Zusammenhang, der häufig in späteren
...
In der Praxis taucht Routing unter Linux oft dann auf, wenn mehrere Einzelbeobachtungen
zusammenhängen und eine ruhige Einordnung nötig ist.

## Abgrenzung

Routing unter Linux ist nicht mit einem einzelnen Befehl, einer einzelnen Formel oder einem
einzelnen Bauteil gleichzusetzen. Der Begriff beschreibt den fachlichen Rahmen, in dem solche
Details sinnvoll werden.

## Häufige Missverständnisse

Häufig wird Routing unter Linux nur als einzelner Arbeitsschritt verstanden, obwohl der Begriff
...
Routing unter Linux ist ein Orientierungsbegriff: Er macht Spezialfälle verständlicher, weil er den allgemeinen Zusammenhang vorher klärt.
