...
Eine Komponenten-API beschreibt, wie andere Teile einer Anwendung eine Komponente benutzen dürfen. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Komponenten-API](/schlaufuchs-platform/images/overviews/v147/komponenten-api.svg)

*Überblick über Eigenschaften, Ereignisse, Slots und Zustände als öffentliche Schnittstelle einer UI-Komponente.*

## Grundidee

Eine Komponenten-API beschreibt, wie andere Teile einer Anwendung eine Komponente benutzen dürfen. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Komponenten-API hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Eingaben:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Ausgaben:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Zustände:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Stabilität:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Eine Komponenten-API beschreibt, wie andere Teile einer Anwendung eine Komponente benutzen dürfen. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
