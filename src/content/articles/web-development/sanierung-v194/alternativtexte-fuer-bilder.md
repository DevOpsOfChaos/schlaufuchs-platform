...
description: "Verstehe bildfunktion statt bilddeko beschreiben als ruhigen Web-Development-Baustein für zugängliche, responsive und gut prüfbare Seiten."
subject: "web-development"
section: "barrierefreiheit-responsive-ux"
topicPath: ["sanierung-v194", "alternativtexte-fuer-bilder"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
draft: false
---
![Didaktische Skizze zu Alternativtexte für Bilder](/schlaufuchs-platform/images/web-development/sanierung-v194/alternativtexte-fuer-bilder.svg)

Alternativtexte für Bilder gehört zur Web-Development-Sanierung v194. Die Seite behandelt das Thema als Qualitätsentscheidung: Eine Webseite soll nicht nur hübsch aussehen, sondern verständlich, bedienbar und überprüfbar bleiben.

## Worum es geht

Bildfunktion statt Bilddeko beschreiben. Dabei hilft es, nicht sofort an ein großes Redesign zu denken. Meist reicht zuerst eine kleine Beobachtung: Wer nutzt die Seite, welche Information wird gesucht und welcher Zustand ist gerade sichtbar?
...
- Alternativtext beschreibt die relevante Funktion eines Bildes.
- Dekorative Bilder brauchen keine inhaltliche Wiederholung.
- Diagramme benötigen oft Kontext im Text.
