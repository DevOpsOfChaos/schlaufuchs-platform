---
title: "Karten und Listen vergleichen"
description: "Verstehe darstellung passend zur aufgabe wählen als ruhigen Web-Development-Baustein für zugängliche, responsive und gut prüfbare Seiten."
subject: "web-development"
section: "barrierefreiheit-responsive-ux"
topicPath: ["sanierung-v194", "karten-und-listen-vergleichen"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
draft: false
---
![Didaktische Skizze zu Karten und Listen vergleichen](/schlaufuchs-platform/images/web-development/sanierung-v194/karten-und-listen-vergleichen.svg)

Karten und Listen vergleichen gehört zur Web-Development-Sanierung v194. Die Seite behandelt das Thema als Qualitätsentscheidung: Eine Webseite soll nicht nur hübsch aussehen, sondern verständlich, bedienbar und überprüfbar bleiben.

## Worum es geht

Darstellung passend zur Aufgabe wählen. Dabei hilft es, nicht sofort an ein großes Redesign zu denken. Meist reicht zuerst eine kleine Beobachtung: Wer nutzt die Seite, welche Information wird gesucht und welcher Zustand ist gerade sichtbar?
...
- Karten zeigen Überblick und Entscheidungshilfen.
- Listen sind stark für viele gleichartige Einträge.
- Metadaten sollten knapp und vergleichbar sein.
