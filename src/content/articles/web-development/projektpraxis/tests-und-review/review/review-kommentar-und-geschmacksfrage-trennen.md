---
title: "Web Development – Review-Kommentar und Geschmacksfrage trennen"
description: "Lerne Code Review als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Code Review als enges Unterthema."
...
**Code Review** ist bewusst als kleines Unterthema angelegt. Lerne Code Review als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Review enthält technische Risiken und persönliche Vorlieben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-review-kommentar-und-geschmacksfrage-trennen.svg" alt="Lernillustration zu Code Review." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Alle Kommentare werden als gleich wichtig behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Kennzeichne Blocker, Frage, Vorschlag und Geschmack getrennt.</span></div>
  </div>
</div>
