---
title: "Web Development – Release-Notiz nach Nutzerwirkung schreiben"
...
<div class="example-card">
  ...
  <h3>Ein technischer Umbau wird veröffentlicht.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-release-notiz-nach-nutzerwirkung-schreiben.svg" alt="Lernillustration zu Release Notes." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Notiz beschreibt nur interne Dateinamen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Formuliere, was sich für Nutzende sichtbar ändert.</span></div>
  </div>
</div>
