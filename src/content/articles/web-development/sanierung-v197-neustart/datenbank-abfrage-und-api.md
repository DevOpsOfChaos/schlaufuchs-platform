---
title: "Datenbank, Abfrage und API-Grenze"
description: "Lege fest, was die API liefert, statt Datenbankstrukturen ungefiltert sichtbar zu machen."
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "api", "datenbank-grenzen"]
draft: false
---
![Datenbank, Abfrage und API-Grenze](/schlaufuchs-platform/images/web-development/sanierung-v197-neustart/datenbank-abfrage-und-api.svg)

## Worum es geht

Lege fest, was die API liefert, statt Datenbankstrukturen ungefiltert sichtbar zu machen. In Backend- und API-Themen hilft es, nicht sofort an Code zu denken, sondern zuerst den Weg der Information zu lesen: Wer fragt an, wer prüft, wer antwortet und welche Daten verlassen das System?
