---
title: "Sessions, Cookies und Token"
description: "Verstehe Anmeldezustand als kontrollierte Information zwischen Browser und Server."
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "api", "authentifizierung"]
draft: false
---
![Sessions, Cookies und Token](/schlaufuchs-platform/images/web-development/sanierung-v197-neustart/sessions-cookies-und-token.svg)

## Worum es geht

Verstehe Anmeldezustand als kontrollierte Information zwischen Browser und Server. In Backend- und API-Themen hilft es, nicht sofort an Code zu denken, sondern zuerst den Weg der Information zu lesen: Wer fragt an, wer prüft, wer antwortet und welche Daten verlassen das System?
