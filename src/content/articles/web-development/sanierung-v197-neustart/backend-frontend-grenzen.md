---
title: "Backend und Frontend sauber trennen"
description: "Verstehe, welche Aufgaben im Browser liegen und welche besser vom Server übernommen werden."
...
selfCheckPoints: []
level: "einfach"
tags: ["web-development", "backend", "api", "grundlagen"]
draft: false
---
![Backend und Frontend sauber trennen](/schlaufuchs-platform/images/web-development/sanierung-v197-neustart/backend-frontend-grenzen.svg)

## Worum es geht

Verstehe, welche Aufgaben im Browser liegen und welche besser vom Server übernommen werden. In Backend- und API-Themen hilft es, nicht sofort an Code zu denken, sondern zuerst den Weg der Information zu lesen: Wer fragt an, wer prüft, wer antwortet und welche Daten verlassen das System?
