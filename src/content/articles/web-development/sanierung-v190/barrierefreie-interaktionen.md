---
title: "Barrierefreie Interaktionen"
description: "Verstehe interaktion zugänglich planen als ruhigen Baustein für wartbare Frontend-Projekte."
...
learningGoals:
  - "Interaktion zugänglich planen"
  - "typische Fehlerquellen erkennen"
  - "eine kleine Frontend-Entscheidung begründen"
practiceIdeas:
  - "Plane eine Tastaturprüfung für ein aufklappbares Menü."
...
keyTakeaways:
  - "Tastaturbedienung ist ein Grundfall."
...
![Didaktische Skizze zu Barrierefreie Interaktionen](/schlaufuchs-platform/images/web-development/sanierung-v190/barrierefreie-interaktionen.svg)

Barrierefreie Interaktionen gehört zur JavaScript-Vertiefung im Web Development. Die Seite betrachtet das Thema nicht als isolierten Code-Trick, sondern als Entscheidungspunkt: Welche Aufgabe hat der Baustein, welche Daten oder Elemente sind beteiligt und wie bleibt die Lösung auch später verständlich?

## Worum es geht

Der Kern ist: **interaktion zugänglich planen**. JavaScript wird schnell unübersichtlich, wenn jede Aktion sofort als Code umgesetzt wird. Ruhiger ist es, zuerst die beteiligten Informationen, Zustände und sichtbaren Wirkungen zu ordnen.

Wichtige Leitgedanken:

- Tastaturbedienung ist ein Grundfall.
- Fokus, Beschriftung und Zustand müssen wahrnehmbar sein.
- Interaktive Elemente brauchen passende HTML-Elemente.
...
Barrierefreie Interaktionen ist dann sauber umgesetzt, wenn Zweck, Daten, Zustand, sichtbare Wirkung und Fehlerfall getrennt erkennbar bleiben.
