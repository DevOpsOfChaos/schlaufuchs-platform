...
Der Kern ist: **datenladen nachvollziehbar machen**. JavaScript wird schnell unübersichtlich, wenn jede Aktion sofort als Code umgesetzt wird. Ruhiger ist es, zuerst die beteiligten Informationen, Zustände und sichtbaren Wirkungen zu ordnen.

Wichtige Leitgedanken:

- fetch liefert zuerst eine Antwort, nicht direkt fertige Daten.
- JSON muss bewusst gelesen werden.
- Netzwerkfehler und Datenfehler sind unterschiedliche Fälle.
...
Fetch API und JSON ist dann sauber umgesetzt, wenn Zweck, Daten, Zustand, sichtbare Wirkung und Fehlerfall getrennt erkennbar bleiben.
