...
Der Formularabschluss entscheidet, ob eine Eingabe verständlich, sicher und vertrauenswürdig beendet wird. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Formularabschluss](/schlaufuchs-platform/images/overviews/v147/formularabschluss.svg)

*Überblick über den letzten Schritt eines Formulars: Prüfung, Bestätigung, Absenden, Rückmeldung und Wiederherstellung.*

## Grundidee

Der Formularabschluss entscheidet, ob eine Eingabe verständlich, sicher und vertrauenswürdig beendet wird. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Formularabschluss hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Validierung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Doppelklickschutz:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Fehlermeldung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Erfolgsmeldung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Der Formularabschluss entscheidet, ob eine Eingabe verständlich, sicher und vertrauenswürdig beendet wird. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
