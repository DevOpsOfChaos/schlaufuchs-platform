---
title: "HTML – responsive Tabellen ohne Bedeutungsverlust"
...
<div class="example-card">
  ...
  <h3>HTML – responsive Tabellen ohne Bedeutungsverlust</h3>
  <p>Verstehe, warum eine Tabelle auf kleinen Bildschirmen nicht einfach zerlegt werden darf, wenn Kopf- und Datenbezug verloren gehen.</p>
</div>

<div class="figure-card">
  <p class="card-kicker">Orientierung</p>
  <h3>Vom Problem zur prüfbaren Lösung</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-v102-form-errors.svg" alt="Schematische Lernillustration zu HTML – responsive Tabellen ohne Bedeutungsverlust." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
```html
<table>
  <thead><tr><th>Tarif</th><th>Preis</th><th>Leistung</th></tr></thead>
  <tbody><tr><td>Basis</td><td>9 €</td><td>Startpaket</td></tr></tbody>
</table>
```
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Auf dem Smartphone bleiben nur Werte sichtbar, aber niemand erkennt, welche Spalte was bedeutet.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Die mobile Darstellung erhält den Zusammenhang zwischen Überschrift und Wert.</span>
    </div>
  </div>
</div>
