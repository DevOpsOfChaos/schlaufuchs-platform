---
title: "Alt-Text nach Funktion wählen"
description: "Lerne Alt-Text nach Funktion wählen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Alt-Text nach Funktion wählen als enges Unterthema."
...
commonMistakes:
  - "Alt-Text beschreibt nur das Aussehen."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Alt-Text nach Funktion wählen wird über eine kleine Trennkante verständlich."
...
**Alt-Text nach Funktion wählen** ist bewusst als kleines Unterthema angelegt. Lerne Alt-Text nach Funktion wählen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Icon dient als Link und braucht verständlichen Alternativtext.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v113-alt-text-nach-funktion-waehlen-v113.svg" alt="Lernillustration zu Alt-Text nach Funktion wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Alt-Text beschreibt nur das Aussehen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Funktion erfüllt das Bild für Nutzende?</span></div>
  </div>
</div>
