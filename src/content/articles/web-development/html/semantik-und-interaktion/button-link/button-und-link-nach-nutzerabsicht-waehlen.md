...
<div class="example-card">
  ...
  <h3>Ein Element löst entweder Navigation oder eine Aktion aus.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v109-button-und-link-nach-nutzerabsicht-waehlen.svg" alt="Lernillustration zu Button und Link." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Alles wird als klickbarer Link gestaltet.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Frage: Navigieren oder Aktion ausführen?</span></div>
  </div>
</div>
