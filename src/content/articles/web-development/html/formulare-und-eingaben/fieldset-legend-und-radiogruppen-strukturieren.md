---
title: "HTML – fieldset, legend und Radiogruppen strukturieren"
...
Lerne, zusammengehörige Formularoptionen mit fieldset, legend und Labels so zu gruppieren, dass die Frage eindeutig bleibt. Wichtig ist dabei nicht nur, ob der Code technisch läuft. Entscheidend ist, ob Bedeutung, Bedienung und Gestaltung dieselbe Aussage stützen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-fieldset-radio-flow.svg" alt="Schematische Orientierung zur Entscheidung: Bedeutung klären, technische Struktur wählen und Nutzbarkeit prüfen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="figure-card">
  ...
  <pre><code>&lt;fieldset&gt;
  &lt;legend&gt;Wie möchtest du benachrichtigt werden?&lt;/legend&gt;
  &lt;label&gt;&lt;input type=&quot;radio&quot; name=&quot;kontakt&quot; value=&quot;mail&quot;&gt; E-Mail&lt;/label&gt;
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Die Optionen „Ja“ und „Nein“ stehen im Formular, aber die eigentliche Frage fehlt.</span>
    </div>
    <div class="compare-item">
      <strong>Besser</strong>
      <span>Die legend formuliert die Frage, die Labels benennen die einzelnen Antworten.</span>
    </div>
  </div>
</div>
