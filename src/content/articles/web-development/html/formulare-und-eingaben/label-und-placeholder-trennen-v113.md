---
title: "Label und Placeholder trennen"
description: "Lerne Label und Placeholder trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Label und Placeholder trennen als enges Unterthema."
...
commonMistakes:
  - "Placeholder wird als dauerhaftes Label genutzt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Label und Placeholder trennen wird über eine kleine Trennkante verständlich."
...
**Label und Placeholder trennen** ist bewusst als kleines Unterthema angelegt. Lerne Label und Placeholder trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Eingabefeld zeigt nur einen Platzhaltertext.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v113-label-und-placeholder-trennen-v113.svg" alt="Lernillustration zu Label und Placeholder trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Placeholder wird als dauerhaftes Label genutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Bleibt die Feldbedeutung sichtbar, wenn Text eingegeben wird?</span></div>
  </div>
</div>
