---
title: "Web Development – Button und Link nach Aktion wählen"
description: "Lerne button und link nach aktion wählen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
...
learningGoals:
  - "Du erklärst button und link nach aktion wählen in einem klaren Kontext."
...
**Button und Link nach Aktion wählen** ist bewusst als kleines Unterthema angelegt. Lerne button und link nach aktion wählen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Element öffnet eine Seite oder löst eine Aktion aus.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „HTML Semantik und Struktur“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Links navigieren; Buttons führen Aktionen aus.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Beide Elemente werden nur nach Styling ausgewählt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Links navigieren; Buttons führen Aktionen aus.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Element öffnet eine Seite oder löst eine Aktion aus.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **HTML Semantik und Struktur** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Links navigieren; Buttons führen Aktionen aus.</p>
</div>
