---
title: "HTML – Button und Link richtig unterscheiden"
...
Verstehe, wann eine Oberfläche einen Link braucht und wann ein Button die fachlich richtige Wahl ist. Wichtig ist dabei nicht nur, ob der Code technisch läuft. Entscheidend ist, ob Bedeutung, Bedienung und Gestaltung dieselbe Aussage stützen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-button-link-decision.svg" alt="Schematische Orientierung zur Entscheidung: Bedeutung klären, technische Struktur wählen und Nutzbarkeit prüfen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="figure-card">
  ...
  <pre><code>&lt;a href=&quot;/preise&quot;&gt;Preise ansehen&lt;/a&gt;
&lt;button type=&quot;button&quot;&gt;Filter zurücksetzen&lt;/button&gt;</code></pre>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Ein Link mit href="#" öffnet ein Menü und verhindert dann per JavaScript die Standardaktion.</span>
    </div>
    <div class="compare-item">
      <strong>Besser</strong>
      <span>Ein Button steuert das Menü, ein Link führt zu einer anderen Adresse.</span>
    </div>
  </div>
</div>
