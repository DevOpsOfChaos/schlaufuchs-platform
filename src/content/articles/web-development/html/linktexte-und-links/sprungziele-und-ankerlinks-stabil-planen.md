---
title: "HTML – Sprungziele und Ankerlinks stabil planen"
...
<div class="example-card">
  ...
  <h3>Sprungziele und Ankerlinks stabil planen</h3>
  <p>Stell dir vor, du prüfst eine echte Lern- oder Formularseite. Die Frage lautet nicht nur, ob der Ausschnitt im Browser gut aussieht, sondern ob sprungziele und ankerlinks stabil planen auch in Struktur, Bedienung und Wartung stimmig bleibt.</p>
</div>

<div class="figure-card">
  <p class="card-kicker">Orientierung</p>
  <h3>Vom Problem zur robusten Entscheidung</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/css-anchor-scroll-margin.svg" alt="Schematische Lernillustration zu Sprungziele und Ankerlinks stabil planen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
```html
<a href="#loesung">Zur Musterlösung springen</a>
...
Die Demo ist absichtlich klein. Sie zeigt nicht jede mögliche Variante, sondern den Kern der Entscheidung: **Der Link nennt das Ziel, und der Abschnitt ist nach dem Sprung lesbar sichtbar**
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der Linktext lautet „hier“ und das Ziel verschwindet unter dem festen Kopfbereich.</span>
    </div>
    <div class="compare-item">
      <strong>Besser</strong>
      <span>Der Link nennt das Ziel, und der Abschnitt ist nach dem Sprung lesbar sichtbar.</span>
    </div>
  </div>
</div>
...
Diese Seite konzentriert sich auf **sprungziele und ankerlinks stabil planen**. Andere Themen wie allgemeines visuelles Design, komplette Komponentenarchitektur oder JavaScript-Verhalten gehören auf eigene Seiten. So bleibt die Lernfrage klein genug, um sie sauber zu üben.
