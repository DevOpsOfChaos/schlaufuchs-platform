---
title: UI-Zustand minimal halten
description: Nur nötigen Zustand speichern
...
learningGoals:
- Du erklärst UI-Zustand minimal halten als klar abgegrenztes Unterthema.
...
commonMistakes:
- Berechnete Werte werden doppelt gespeichert.
...
keyTakeaways:
- UI-Zustand minimal halten wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**UI-Zustand minimal halten** ist bewusst als kleines Unterthema angelegt. Nur nötigen Zustand speichern. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Filter kann aus Suchtext und Liste berechnet werden.</h3>
  <p>Die wichtige Frage lautet: <strong>Ist dieser Zustand Quelle oder Ableitung?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v114-ui-zustand-minimal-halten-v114.svg" alt="Lernillustration zu UI-Zustand minimal halten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Berechnete Werte werden doppelt gespeichert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist dieser Zustand Quelle oder Ableitung?</span></div>
  </div>
</div>
