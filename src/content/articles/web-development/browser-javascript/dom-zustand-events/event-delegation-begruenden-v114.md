...
learningGoals:
- Du erklärst Event Delegation begründen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Jeder Eintrag bekommt dauerhaft eigenen Listener.
...
keyTakeaways:
- Event Delegation begründen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
