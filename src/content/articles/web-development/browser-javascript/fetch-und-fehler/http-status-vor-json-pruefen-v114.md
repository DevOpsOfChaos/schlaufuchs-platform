...
learningGoals:
- Du erklärst HTTP-Status vor JSON prüfen als klar abgegrenztes Unterthema.
...
commonMistakes:
- response.json wird blind aufgerufen.
...
keyTakeaways:
- HTTP-Status vor JSON prüfen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
