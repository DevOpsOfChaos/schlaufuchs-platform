---
title: Fehlerzustände unterscheidbar machen
description: Leer, Laden, Fehler und Erfolg trennen
...
learningGoals:
- Du erklärst Fehlerzustände unterscheidbar machen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Leerer Inhalt und Ladefehler sehen gleich aus.
...
keyTakeaways:
- Fehlerzustände unterscheidbar machen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Fehlerzustände unterscheidbar machen** ist bewusst als kleines Unterthema angelegt. Leer, Laden, Fehler und Erfolg trennen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Liste zeigt nichts an.</h3>
  <p>Die wichtige Frage lautet: <strong>Welcher Zustand liegt gerade wirklich vor?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v114-fehlerzustaende-unterscheidbar-machen-v114.svg" alt="Lernillustration zu Fehlerzustände unterscheidbar machen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Leerer Inhalt und Ladefehler sehen gleich aus.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welcher Zustand liegt gerade wirklich vor?</span></div>
  </div>
</div>
