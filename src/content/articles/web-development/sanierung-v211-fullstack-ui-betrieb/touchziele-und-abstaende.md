---
title: "Touchziele und Abstände – Überblick"
description: "Ein ruhiger Web-Development-Überblick zu Touchziele und Abstände: Nutzerziel, UI-Zustand, technische Grenze und Abnahme werden getrennt."
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "barrierefreiheit-und-ux", "touchziele-und-abstaende", "fullstack", "v211"]
draft: false
---
![Touchziele und Abstände](/schlaufuchs-platform/images/web-development/sanierung-v211-fullstack-ui-betrieb/touchziele-und-abstaende.svg)

## Worum es hier geht

**Touchziele und Abstände** hilft dabei, Web Development nicht nur als sichtbare Oberfläche zu verstehen. Gute Webarbeit verbindet Nutzerabsicht, UI-Zustand, Datenvertrag, Sicherheit, Qualität und Betrieb.
...
Touchziele und Abstände ist tragfähig, wenn Nutzerziel, technischer Vertrag, Fehlerfall und Abnahme zusammen beschrieben werden.
