---
title: "Rollen und Berechtigungen – Überblick"
description: "Ein ruhiger Web-Development-Überblick zu Rollen und Berechtigungen: Nutzerziel, UI-Zustand, technische Grenze und Abnahme werden getrennt."
...
selfCheckPoints: []
level: "einfach"
tags: ["web-development", "auth-und-sicherheit", "rollen-und-berechtigungen", "fullstack", "v211"]
draft: false
---
![Rollen und Berechtigungen](/schlaufuchs-platform/images/web-development/sanierung-v211-fullstack-ui-betrieb/rollen-und-berechtigungen.svg)

## Worum es hier geht

**Rollen und Berechtigungen** hilft dabei, Web Development nicht nur als sichtbare Oberfläche zu verstehen. Gute Webarbeit verbindet Nutzerabsicht, UI-Zustand, Datenvertrag, Sicherheit, Qualität und Betrieb.
...
Rollen und Berechtigungen ist tragfähig, wenn Nutzerziel, technischer Vertrag, Fehlerfall und Abnahme zusammen beschrieben werden.
