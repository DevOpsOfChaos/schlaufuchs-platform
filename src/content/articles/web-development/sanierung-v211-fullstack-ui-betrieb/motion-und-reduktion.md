---
title: "Motion und Reduktion – Überblick"
description: "Ein ruhiger Web-Development-Überblick zu Motion und Reduktion: Nutzerziel, UI-Zustand, technische Grenze und Abnahme werden getrennt."
subject: "web-development"
section: "barrierefreiheit-und-ux"
topicPath: ["barrierefreiheit-und-ux", "motion-und-reduktion"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "barrierefreiheit-und-ux", "motion-und-reduktion", "fullstack", "v211"]
draft: false
---
![Motion und Reduktion](/schlaufuchs-platform/images/web-development/sanierung-v211-fullstack-ui-betrieb/motion-und-reduktion.svg)

## Worum es hier geht

**Motion und Reduktion** hilft dabei, Web Development nicht nur als sichtbare Oberfläche zu verstehen. Gute Webarbeit verbindet Nutzerabsicht, UI-Zustand, Datenvertrag, Sicherheit, Qualität und Betrieb.
...
Motion und Reduktion ist tragfähig, wenn Nutzerziel, technischer Vertrag, Fehlerfall und Abnahme zusammen beschrieben werden.
