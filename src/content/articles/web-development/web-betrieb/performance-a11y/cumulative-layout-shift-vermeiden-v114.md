---
title: Cumulative Layout Shift vermeiden
description: Platz für späte Inhalte reservieren
...
learningGoals:
- Du erklärst Cumulative Layout Shift vermeiden als klar abgegrenztes Unterthema.
...
commonMistakes:
- Die Verschiebung wird als kleiner Schönheitsfehler abgetan.
...
keyTakeaways:
- Cumulative Layout Shift vermeiden wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Cumulative Layout Shift vermeiden** ist bewusst als kleines Unterthema angelegt. Platz für späte Inhalte reservieren. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Bilder springen beim Laden in die Seite.</h3>
  <p>Die wichtige Frage lautet: <strong>Ist Größe vor dem Laden bekannt?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v114-cumulative-layout-shift-vermeiden-v114.svg" alt="Lernillustration zu Cumulative Layout Shift vermeiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Die Verschiebung wird als kleiner Schönheitsfehler abgetan.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist Größe vor dem Laden bekannt?</span></div>
  </div>
</div>
