---
title: "API-Tests in der Testpyramide"
description: "API-Tests prüfen Verträge, Fehlerfälle und Nebenwirkungen zwischen Unit- und End-to-End-Ebene."
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "sicherheit", "testen-und-qualitaet", "testen-und-qualitaet", "api-tests"]
draft: false
---
![API-Tests in der Testpyramide](/schlaufuchs-platform/images/web-development/sanierung-v198-security-auth-ops/api-tests-pyramide.svg)

## Worum es geht

API-Tests prüfen Verträge, Fehlerfälle und Nebenwirkungen zwischen Unit- und End-to-End-Ebene. In echten Webprojekten ist das Thema selten nur eine einzelne Codezeile. Es verbindet Nutzeraktion, Browserverhalten, Serverlogik, Daten und Betrieb.
...
API-Tests in der Testpyramide wird verständlich, wenn Verantwortung, Datenfluss und Kontrollpunkt getrennt gelesen werden.
