---
title: "Logging ohne Datenleck"
description: "Logs sollen Fehler erklären, aber keine Passwörter, Tokens oder privaten Daten verraten."
subject: "web-development"
section: "observability"
topicPath: ["betrieb-und-beobachtung", "logging"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "sicherheit", "observability", "betrieb-und-beobachtung", "logging"]
draft: false
---
![Logging ohne Datenleck](/schlaufuchs-platform/images/web-development/sanierung-v198-security-auth-ops/logging-ohne-datenleck.svg)

## Worum es geht

Logs sollen Fehler erklären, aber keine Passwörter, Tokens oder privaten Daten verraten. In echten Webprojekten ist das Thema selten nur eine einzelne Codezeile. Es verbindet Nutzeraktion, Browserverhalten, Serverlogik, Daten und Betrieb.
...
Logging ohne Datenleck wird verständlich, wenn Verantwortung, Datenfluss und Kontrollpunkt getrennt gelesen werden.
