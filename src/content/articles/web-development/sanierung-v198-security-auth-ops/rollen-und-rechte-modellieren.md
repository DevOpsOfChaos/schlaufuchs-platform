---
title: "Rollen und Rechte modellieren"
description: "Rechte werden aus konkreten Aktionen abgeleitet, nicht aus vagen Nutzergruppen."
subject: "web-development"
section: "auth-und-sicherheit"
topicPath: ["backend-und-sicherheit", "rollen-rechte"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "sicherheit", "auth-und-sicherheit", "backend-und-sicherheit", "rollen-rechte"]
draft: false
---
![Rollen und Rechte modellieren](/schlaufuchs-platform/images/web-development/sanierung-v198-security-auth-ops/rollen-und-rechte-modellieren.svg)

## Worum es geht

Rechte werden aus konkreten Aktionen abgeleitet, nicht aus vagen Nutzergruppen. In echten Webprojekten ist das Thema selten nur eine einzelne Codezeile. Es verbindet Nutzeraktion, Browserverhalten, Serverlogik, Daten und Betrieb.
...
Rollen und Rechte modellieren wird verständlich, wenn Verantwortung, Datenfluss und Kontrollpunkt getrennt gelesen werden.
