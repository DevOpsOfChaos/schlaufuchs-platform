---
title: "CSRF-Risiken verstehen"
description: "CSRF entsteht, wenn der Browser automatisch Vertrauen mitsendet und eine Anwendung keine Absicht prüft."
subject: "web-development"
section: "auth-und-sicherheit"
topicPath: ["backend-und-sicherheit", "csrf"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "sicherheit", "auth-und-sicherheit", "backend-und-sicherheit", "csrf"]
draft: false
---
![CSRF-Risiken verstehen](/schlaufuchs-platform/images/web-development/sanierung-v198-security-auth-ops/csrf-risiko-verstehen.svg)

## Worum es geht

CSRF entsteht, wenn der Browser automatisch Vertrauen mitsendet und eine Anwendung keine Absicht prüft. In echten Webprojekten ist das Thema selten nur eine einzelne Codezeile. Es verbindet Nutzeraktion, Browserverhalten, Serverlogik, Daten und Betrieb.
...
CSRF-Risiken verstehen wird verständlich, wenn Verantwortung, Datenfluss und Kontrollpunkt getrennt gelesen werden.
