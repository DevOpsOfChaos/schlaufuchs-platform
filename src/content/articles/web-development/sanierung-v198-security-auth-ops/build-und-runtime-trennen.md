---
title: "Build und Runtime trennen"
description: "Build-Zeit und Laufzeit haben unterschiedliche Daten, Risiken und Fehlerbilder."
subject: "web-development"
section: "deployment-und-betrieb"
topicPath: ["deployment-und-betrieb", "build-runtime"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "sicherheit", "deployment-und-betrieb", "deployment-und-betrieb", "build-runtime"]
draft: false
---
![Build und Runtime trennen](/schlaufuchs-platform/images/web-development/sanierung-v198-security-auth-ops/build-und-runtime-trennen.svg)

## Worum es geht

Build-Zeit und Laufzeit haben unterschiedliche Daten, Risiken und Fehlerbilder. In echten Webprojekten ist das Thema selten nur eine einzelne Codezeile. Es verbindet Nutzeraktion, Browserverhalten, Serverlogik, Daten und Betrieb.
...
Build und Runtime trennen wird verständlich, wenn Verantwortung, Datenfluss und Kontrollpunkt getrennt gelesen werden.
