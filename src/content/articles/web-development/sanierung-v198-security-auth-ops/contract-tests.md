...
description: "Contract Tests halten Erwartungen zwischen Client und Server explizit und überprüfbar."
subject: "web-development"
section: "testen-und-qualitaet"
topicPath: ["testen-und-qualitaet", "contract-tests"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
selfCheckPoints: []
level: "mittel"
tags: ["web-development", "backend", "sicherheit", "testen-und-qualitaet", "testen-und-qualitaet", "contract-tests"]
draft: false
---
![Contract Tests](/schlaufuchs-platform/images/web-development/sanierung-v198-security-auth-ops/contract-tests.svg)

## Worum es geht

Contract Tests halten Erwartungen zwischen Client und Server explizit und überprüfbar. In echten Webprojekten ist das Thema selten nur eine einzelne Codezeile. Es verbindet Nutzeraktion, Browserverhalten, Serverlogik, Daten und Betrieb.
...
Contract Tests wird verständlich, wenn Verantwortung, Datenfluss und Kontrollpunkt getrennt gelesen werden.
