...
- Die Basisebene sendet Daten über HTML und Serverlogik.
- JavaScript kann Live-Validierung, Zwischenspeicherung oder dynamische Felder ergänzen.
- Fehler und Erfolgsmeldungen müssen auch ohne Clientlogik verständlich bleiben.
...
Ein Suchformular funktioniert per normalem Submit; JavaScript ergänzt Vorschläge und verzögerte Sucheingaben.
...
Progressive Enhancement bei Formularen steht selten allein. Es berührt benachbarte Themen wie Modellbildung, Messung, Struktur, Fehlerbehandlung oder Darstellung. Wer diese Verbindungen erkennt, kann Spezialseiten später leichter einordnen und vermeidet, aus einem Einzelfall eine falsche allgemeine Regel abzuleiten.
