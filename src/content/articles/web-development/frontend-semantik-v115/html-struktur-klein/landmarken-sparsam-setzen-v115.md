---
title: "Web Development – Landmarken sparsam setzen"
description: "Trainiere Landmarken sparsam setzen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
...
learningGoals:
  - "Du erklärst Landmarken sparsam setzen an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Jeder Container bekommt eine Landmarke."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Hilft die Landmarke bei der Orientierung oder erzeugt sie Lärm?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Landmarken sparsam setzen."
...
<img src="/schlaufuchs-platform/illustrations/web-development-landmarken-sparsam-setzen-v115.svg" alt="Lernillustration zu Landmarken sparsam setzen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Landmarken sparsam setzen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Hilft die Landmarke bei der Orientierung oder erzeugt sie Lärm?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Landmarken sparsam setzen</h3>
  <p>Eine Seite enthält viele verschachtelte Bereiche.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Landmarken sparsam setzen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Jeder Container bekommt eine Landmarke.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Jeder Container bekommt eine Landmarke. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Landmarken sparsam setzen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
