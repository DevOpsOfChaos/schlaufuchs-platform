---
title: "Leeren Zustand gestalten"
description: "Lerne Leeren Zustand gestalten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Leeren Zustand gestalten als enges Unterthema."
...
commonMistakes:
  - "Kein Ergebnis wird wie ein Fehler behandelt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Leeren Zustand gestalten wird über eine kleine Trennkante verständlich."
...
**Leeren Zustand gestalten** ist bewusst als kleines Unterthema angelegt. Lerne Leeren Zustand gestalten als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Liste hat keine Treffer und die Seite wirkt kaputt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v113-leeren-zustand-gestalten-v113.svg" alt="Lernillustration zu Leeren Zustand gestalten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Kein Ergebnis wird wie ein Fehler behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Gibt es eine verständliche Empty-State-Meldung?</span></div>
  </div>
</div>
