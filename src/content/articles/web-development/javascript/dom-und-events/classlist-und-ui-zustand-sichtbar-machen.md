---
title: "JavaScript – classList und UI-Zustand sichtbar machen"
...
<div class="example-card">
  ...
  <h3>classList und UI-Zustand sichtbar machen</h3>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der Code setzt Farben, Abstände und Sichtbarkeit einzeln per JavaScript.</span>
    </div>
    <div class="compare-item">
      <strong>Besser</strong>
      <span>JavaScript setzt nur die Zustandsklasse, CSS beschreibt die Darstellung.</span>
    </div>
  </div>
</div>
