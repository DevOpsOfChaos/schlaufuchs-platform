---
title: "JavaScript – Custom Events zwischen Komponenten"
...
<div class="example-card">
  ...
  <p>Verstehe, wie eigene Events helfen, Komponenten lose zu koppeln, statt direkte Funktionsaufrufe durch die Oberfläche zu ziehen.</p>
</div>

<div class="figure-card">
  <p class="card-kicker">Orientierung</p>
  <h3>Vom Problem zur prüfbaren Lösung</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/js-v102-error-flow.svg" alt="Schematische Lernillustration zu JavaScript – Custom Events zwischen Komponenten." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
const event = new CustomEvent("cart:add", {
  detail: { productId: "buch-1", amount: 1 },
  bubbles: true
});
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der Produktbutton kennt Warenkorb, Anzeige und Speicherlogik direkt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Der Produktbutton meldet nur das Ereignis; andere Teile entscheiden, wie sie darauf reagieren.</span>
    </div>
  </div>
</div>
