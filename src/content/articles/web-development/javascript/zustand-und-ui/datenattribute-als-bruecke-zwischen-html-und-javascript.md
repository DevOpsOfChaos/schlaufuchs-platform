---
title: "JavaScript – Datenattribute als Brücke zwischen HTML und JavaScript"
...
<div class="example-card">
  ...
  <h3>Datenattribute als Brücke zwischen HTML und JavaScript</h3>
  <p>Lerne, data-Attribute als kleine, lesbare Verbindung zwischen Markup und Verhalten zu verwenden.</p>
</div>

<div class="figure-card">
  <p class="card-kicker">Orientierung</p>
  <h3>Die Entscheidung sichtbar machen</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/js-state-render-loop.svg" alt="Schematische Lernillustration zu JavaScript – Datenattribute als Brücke zwischen HTML und JavaScript." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
```js
<button data-filter="offen">Offene Aufgaben</button>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der Code erkennt Logik an einer CSS-Klasse wie red oder big.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Ein data-filter benennt fachlich, welche Bedeutung der Button für JavaScript hat.</span>
    </div>
  </div>
</div>
