---
title: "Web Development – localStorage und sessionStorage nach Risiko wählen"
...
<div class="example-card">
  ...
  <h3>Ein Frontend speichert Zustand zwischen Seitenaufrufen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v109-localstorage-und-sessionstorage-nach-risiko-waehlen.svg" alt="Lernillustration zu localStorage und sessionStorage." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Alle Daten werden dauerhaft im Browser abgelegt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Frage nach Dauer, Sensibilität und Löschbarkeit.</span></div>
  </div>
</div>
