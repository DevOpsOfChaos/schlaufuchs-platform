---
title: "Browser – localStorage mit Schema und Versionierung nutzen"
...
<div class="example-card">
  ...
  <h3>Browser – localStorage mit Schema und Versionierung nutzen</h3>
  <p>Verstehe, warum dauerhaft gespeicherte Browserdaten eine kleine Struktur und einen Migrationsweg brauchen.</p>
</div>

<div class="figure-card">
  <p class="card-kicker">Orientierung</p>
  <h3>Vom Problem zur prüfbaren Lösung</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/js-v102-state-storage.svg" alt="Schematische Lernillustration zu Browser – localStorage mit Schema und Versionierung nutzen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
```js
const saved = localStorage.getItem("settings:v2");
const settings = saved ? JSON.parse(saved) : { theme: "system", version: 2 };
```
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Die App erwartet immer ein perfektes altes Speicherformat.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Die App prüft Version, Standardwerte und Fehlerfall, bevor gespeicherte Daten genutzt werden.</span>
    </div>
  </div>
</div>
