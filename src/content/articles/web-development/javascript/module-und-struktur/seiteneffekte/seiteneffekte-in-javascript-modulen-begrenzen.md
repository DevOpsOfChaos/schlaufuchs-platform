---
title: "Web Development – Seiteneffekte in JavaScript-Modulen begrenzen"
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/webdevelopment-v107-seiteneffekte-in-javascript-modulen-begrenze.svg" alt="Lernillustration zu Modulgrenzen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
