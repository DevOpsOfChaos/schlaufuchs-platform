---
title: "CSS – :has(), :is() und :where() mit Spezifität einordnen"
description: "Lerne moderne CSS-Selektoren so zu lesen, dass Komfort, Lesbarkeit und Spezifität nicht durcheinandergeraten."
...
learningGoals:
  - "Du erklärst die Grundidee von :has(), :is() und :where()."
  - "Du beachtest Spezifität statt nur Schreibkomfort."
  - "Du entscheidest, wann ein Selektor die Wartbarkeit verbessert oder verschlechtert."
practiceIdeas:
...
commonMistakes:
  - ":has() als Ersatz für jede JavaScript-Logik zu behandeln."
  - ":where() zu verwenden und danach Spezifität zu erwarten."
  - "Sehr lange Selektoren zu bauen, die schwer überprüfbar sind."
keyTakeaways:
...
Lerne moderne CSS-Selektoren so zu lesen, dass Komfort, Lesbarkeit und Spezifität nicht durcheinandergeraten. Wichtig ist dabei nicht nur, ob der Code technisch läuft. Entscheidend ist, ob Bedeutung, Bedienung und Gestaltung dieselbe Aussage stützen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/css-has-is-where.svg" alt="Schematische Orientierung zur Entscheidung: Bedeutung klären, technische Struktur wählen und Nutzbarkeit prüfen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="figure-card">
  ...
  <pre><code>.field:has([aria-invalid=&quot;true&quot;]) {
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Ein Selektor wird immer länger, bis er zufällig gewinnt.</span>
    </div>
    <div class="compare-item">
      <strong>Besser</strong>
      <span>Der Selektor bleibt lesbar, und die Spezifität ist bewusst gewählt.</span>
    </div>
  </div>
</div>
