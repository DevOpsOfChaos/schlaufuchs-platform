---
title: "CSS – Custom Properties, Scope und Fallbacks verstehen"
description: "Verstehe CSS-Variablen als kaskadierende Werte, die vererbt, überschrieben und mit Fallbacks abgesichert werden können."
...
learningGoals:
  - "Du erklärst Custom Properties als Teil der Kaskade."
  - "Du unterscheidest globalen Wert, Komponentenwert und lokalen Fallback."
  - "Du nutzt var() nicht als magische Konstante, sondern als steuerbaren Wert."
practiceIdeas:
...
commonMistakes:
  - "CSS-Variablen wie feste Programmiervariablen zu lesen."
  - "Fallbacks mit echten Standardwerten zu verwechseln."
  - "Werte an einer Stelle zu überschreiben, ohne den Scope zu prüfen."
keyTakeaways:
...
Verstehe CSS-Variablen als kaskadierende Werte, die vererbt, überschrieben und mit Fallbacks abgesichert werden können. Wichtig ist dabei nicht nur, ob der Code technisch läuft. Entscheidend ist, ob Bedeutung, Bedienung und Gestaltung dieselbe Aussage stützen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/css-kaskade-layer.svg" alt="Schematische Orientierung zur Entscheidung: Bedeutung klären, technische Struktur wählen und Nutzbarkeit prüfen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="figure-card">
  ...
  <pre><code>:root { --card-gap: 1rem; }
.card-list { gap: var(--card-gap, 1rem); }
.compact { --card-gap: 0.5rem; }</code></pre>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Ein Wert wird mehrfach kopiert und später an drei Stellen unterschiedlich geändert.</span>
    </div>
    <div class="compare-item">
      <strong>Besser</strong>
      <span>Ein Custom Property steuert den Abstand, einzelne Bereiche überschreiben ihn bewusst.</span>
    </div>
  </div>
</div>
