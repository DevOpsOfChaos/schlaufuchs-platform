---
title: "CSS – Komponentenvarianten mit Design-Tokens planen"
description: "Trenne Grundkomponente, Variante und Token, damit Buttons, Hinweise und Karten konsistent bleiben statt per Einzelregel auseinanderzulaufen."
...
learningGoals:
  - "Du erklärst die Kernidee von „Design-System“ in eigenen Worten."
...
commonMistakes:
  - "Farben direkt in jede Klasse schreiben"
  - "Varianten nach Zufall benennen"
  - "Fokuszustände vergessen"
keyTakeaways:
  - "Design-System wird klarer, wenn Zustand, Ursache und Prüfschritt getrennt werden."
...
<div class="example-card">
  ...
  <h3>Design-System: kleine Frage statt Sammelbox</h3>
...
```text
1. Grundwert benennen
2. Variante definieren
3. Zustand prüfen
4. Ausnahme begründen
```
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <ul>
        <li>Tokens haben fachliche Namen</li>
        <li>Varianten bleiben überschaubar</li>
        <li>Hover, Fokus und Disabled werden mitgedacht</li>
      </ul>
    </div>
    <div class="compare-item">
      <strong>Typische Stolperstelle</strong>
      <ul>
        <li>Farben direkt in jede Klasse schreiben</li>
        <li>Varianten nach Zufall benennen</li>
        <li>Fokuszustände vergessen</li>
      </ul>
    </div>
  </div>
</div>
...
Diese Seite gehört zum Unterthema **css / design-systeme**. Sie soll nicht alle angrenzenden Fragen mitlösen. Genau diese Trennung macht den Bereich übersichtlicher: erst die kleine Denkentscheidung verstehen, dann bei Bedarf zum nächsten Unterthema wechseln.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Design-System bleibt lernbar, wenn es als eigenes Unterthema mit klarer Gegenprobe behandelt wird.</p>
</div>
