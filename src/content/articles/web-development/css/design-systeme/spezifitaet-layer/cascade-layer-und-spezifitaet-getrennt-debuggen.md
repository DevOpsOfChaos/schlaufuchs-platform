---
title: "Web Development – Cascade Layer und Spezifität getrennt debuggen"
...
<div class="example-card">
  ...
  <h3>Eine CSS-Regel greift trotz scheinbar stärkerem Selektor nicht.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v109-cascade-layer-und-spezifitaet-getrennt-debuggen.svg" alt="Lernillustration zu Cascade Layer und Spezifität." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Layer-Reihenfolge und Spezifität werden vermischt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Prüfe erst Layer, dann Selektorstärke.</span></div>
  </div>
</div>
