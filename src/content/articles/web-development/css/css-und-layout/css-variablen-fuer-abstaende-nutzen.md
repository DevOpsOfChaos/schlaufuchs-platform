---
title: "Web Development – CSS-Variablen für Abstände nutzen"
description: "Lerne css-variablen für abstände nutzen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
...
learningGoals:
  - "Du erklärst css-variablen für abstände nutzen in einem klaren Kontext."
...
**CSS-Variablen für Abstände nutzen** ist bewusst als kleines Unterthema angelegt. Lerne css-variablen für abstände nutzen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Viele Komponenten teilen wiederkehrende Spacing-Werte.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Design Tokens reduzieren Zufall und Wiederholung.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Jeder Abstand wird einzeln erfunden.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Design Tokens reduzieren Zufall und Wiederholung.</span>
    </div>
  </div>
</div>
...
```text
Situation: Viele Komponenten teilen wiederkehrende Spacing-Werte.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Design Tokens reduzieren Zufall und Wiederholung.</p>
</div>
