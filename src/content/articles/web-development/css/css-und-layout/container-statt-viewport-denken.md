---
title: "Web Development – Container statt Viewport denken"
description: "Lerne container statt viewport denken als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
...
learningGoals:
  - "Du erklärst container statt viewport denken in einem klaren Kontext."
...
**Container statt Viewport denken** ist bewusst als kleines Unterthema angelegt. Lerne container statt viewport denken als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Komponente sitzt in verschieden breiten Bereichen.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „CSS Layout und Gestaltung“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Container Queries reagieren auf den Platz der Komponente.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Alle Responsivität hängt am Browserfenster.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Container Queries reagieren auf den Platz der Komponente.</span>
    </div>
  </div>
</div>
...
```text
Situation: Eine Komponente sitzt in verschieden breiten Bereichen.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **CSS Layout und Gestaltung** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Container Queries reagieren auf den Platz der Komponente.</p>
</div>
