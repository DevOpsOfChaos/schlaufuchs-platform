---
title: "Grid und Flexbox nach Richtung wählen"
description: "Lerne Grid und Flexbox nach Richtung wählen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Grid und Flexbox nach Richtung wählen als enges Unterthema."
...
commonMistakes:
  - "Flexbox wird für jedes Layoutproblem verwendet."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Grid und Flexbox nach Richtung wählen wird über eine kleine Trennkante verständlich."
...
**Grid und Flexbox nach Richtung wählen** ist bewusst als kleines Unterthema angelegt. Lerne Grid und Flexbox nach Richtung wählen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Layout soll zweidimensional ausgerichtet werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v113-grid-und-flexbox-nach-richtung-waehlen-v113.svg" alt="Lernillustration zu Grid und Flexbox nach Richtung wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Flexbox wird für jedes Layoutproblem verwendet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Geht es um eine Achse oder um Zeilen und Spalten zugleich?</span></div>
  </div>
</div>
