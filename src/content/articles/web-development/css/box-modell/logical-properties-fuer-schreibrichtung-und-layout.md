...
learningGoals:
  - "Du unterscheidest physische und logische CSS-Eigenschaften."
  - "Du erklärst, warum inline und block oft fachlicher sind als left und right."
  - "Du planst Komponenten, die besser mit Schreibrichtungen umgehen."
practiceIdeas:
...
commonMistakes:
  - "Abstände grundsätzlich als margin-left und margin-right zu denken."
  - "Schreibrichtung und Textfluss nie mitzudenken."
  - "Komponenten unnötig fest an eine Richtung zu binden."
keyTakeaways:
