---
title: "Spezifität nicht hochschaukeln"
description: "Lerne Spezifität nicht hochschaukeln als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Spezifität nicht hochschaukeln als enges Unterthema."
...
commonMistakes:
  - "Mehr Selektorstärke wird als saubere Lösung gesehen."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Spezifität nicht hochschaukeln wird über eine kleine Trennkante verständlich."
...
**Spezifität nicht hochschaukeln** ist bewusst als kleines Unterthema angelegt. Lerne Spezifität nicht hochschaukeln als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Regel wird mit immer längeren Selektoren überschrieben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v113-spezifitaet-nicht-hochschaukeln-v113.svg" alt="Lernillustration zu Spezifität nicht hochschaukeln." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Mehr Selektorstärke wird als saubere Lösung gesehen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Kann die Regel näher an der Komponente oder über eine Klasse gelöst werden?</span></div>
  </div>
</div>
