---
title: "CSS – Grid mit auto-fit und minmax als Kartenraster planen"
...
Verstehe, wie auto-fit, minmax und gap robuste Kartenraster erzeugen, ohne feste Spaltenzahlen für jede Bildschirmbreite zu pflegen. Wichtig ist dabei nicht nur, ob der Code technisch läuft. Entscheidend ist, ob Bedeutung, Bedienung und Gestaltung dieselbe Aussage stützen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/css-grid-auto-fit-minmax.svg" alt="Schematische Orientierung zur Entscheidung: Bedeutung klären, technische Struktur wählen und Nutzbarkeit prüfen." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Das Raster erzwingt vier Spalten, auch wenn Karten dadurch zu schmal werden.</span>
    </div>
    <div class="compare-item">
      <strong>Besser</strong>
      <span>Das Raster entscheidet über die verfügbare Breite und eine sinnvolle Mindestgröße.</span>
    </div>
  </div>
</div>
