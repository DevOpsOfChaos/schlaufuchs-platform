---
title: "Web Development – em und rem nach Bezugssystem unterscheiden"
description: "Lerne em und rem als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
...
learningGoals:
  - "Du erklärst em und rem als eigenes Unterthema."
...
commonMistakes:
  - "em und rem werden als identische flexible Einheit genutzt."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "em und rem wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**em und rem** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne em und rem als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Abstände sollen mit Schriftgröße skalieren.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v109-em-und-rem-nach-bezugssystem-unterscheiden.svg" alt="Lernillustration zu em und rem." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>em und rem werden als identische flexible Einheit genutzt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Prüfe, ob Bezug Elternschrift oder Rootschrift ist.</span></div>
  </div>
</div>
