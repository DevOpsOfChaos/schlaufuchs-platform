---
title: "Web Development – Spacing-Token statt Einzelabstände nutzen"
description: "Lerne Spacing Tokens als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Spacing Tokens als enges Unterthema."
...
**Spacing Tokens** ist bewusst als kleines Unterthema angelegt. Lerne Spacing Tokens als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Layout hat viele leicht unterschiedliche Abstände.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-spacing-token-statt-einzelabstaende-nutzen.svg" alt="Lernillustration zu Spacing Tokens." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jede Komponente bekommt eigene Zufallswerte.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ordne Abstände einer kleinen Token-Skala zu.</span></div>
  </div>
</div>
