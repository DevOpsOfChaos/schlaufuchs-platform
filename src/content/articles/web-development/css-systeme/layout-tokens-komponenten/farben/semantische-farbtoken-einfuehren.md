---
title: "Web Development – Semantische Farbtoken einführen"
description: "Lerne Farbtoken als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Farbtoken als enges Unterthema."
...
**Farbtoken** ist bewusst als kleines Unterthema angelegt. Lerne Farbtoken als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Fehlerzustand verwendet direkt eine rote Hexfarbe.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-semantische-farbtoken-einfuehren.svg" alt="Lernillustration zu Farbtoken." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Farbe wird nach Aussehen statt Bedeutung benannt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Nutze Namen wie color-danger statt color-red-500 im Komponentenvertrag.</span></div>
  </div>
</div>
