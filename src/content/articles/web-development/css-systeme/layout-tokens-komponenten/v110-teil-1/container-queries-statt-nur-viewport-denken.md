---
title: "Web Development – Container Queries statt nur Viewport denken"
description: "Lerne Container Queries statt nur Viewport denken als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
...
learningGoals:
  - "Du erklärst Container Queries statt nur Viewport denken als eigenes Unterthema."
...
commonMistakes:
  - "Responsive Design wird nur über die Fensterbreite gesteuert."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Container Queries statt nur Viewport denken wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Container Queries statt nur Viewport denken** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Karte steht mal in einer Sidebar und mal im Hauptbereich.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v110-container-queries-statt-nur-viewport-denken.svg" alt="Lernillustration zu Container Queries statt nur Viewport denken." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Responsive Design wird nur über die Fensterbreite gesteuert.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Frage, wie breit der Container der Komponente ist.</span></div>
  </div>
</div>
