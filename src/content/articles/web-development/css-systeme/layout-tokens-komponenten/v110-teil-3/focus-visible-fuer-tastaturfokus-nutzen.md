---
title: "Web Development – :focus-visible für Tastaturfokus nutzen"
...
<div class="example-card">
  ...
  <h3>Fokusringe sollen sichtbar sein, ohne Mausnutzer zu irritieren.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v110-focus-visible-fuer-tastaturfokus-nutzen.svg" alt="Lernillustration zu :focus-visible für Tastaturfokus nutzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Fokusmarkierungen werden komplett entfernt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Nutze :focus-visible statt outline: none.</span></div>
  </div>
</div>
