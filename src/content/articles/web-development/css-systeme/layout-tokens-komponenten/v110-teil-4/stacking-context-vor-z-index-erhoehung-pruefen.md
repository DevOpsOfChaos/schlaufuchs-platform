---
title: "Web Development – Stacking Context vor z-index-Erhöhung prüfen"
description: "Lerne Stacking Context vor z-index-Erhöhung prüfen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
...
learningGoals:
  - "Du erklärst Stacking Context vor z-index-Erhöhung prüfen als eigenes Unterthema."
...
commonMistakes:
  - "Der z-index wird immer weiter erhöht."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Stacking Context vor z-index-Erhöhung prüfen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Stacking Context vor z-index-Erhöhung prüfen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Dropdown liegt trotz hohem z-index unter einem anderen Element.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v110-stacking-context-vor-z-index-erhoehung-pruefen.svg" alt="Lernillustration zu Stacking Context vor z-index-Erhöhung prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Der z-index wird immer weiter erhöht.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Prüfe, ob ein neuer Stacking Context die Reihenfolge begrenzt.</span></div>
  </div>
</div>
