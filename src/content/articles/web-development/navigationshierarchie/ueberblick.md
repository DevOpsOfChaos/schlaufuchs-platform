...
Eine Navigationshierarchie ordnet Inhalte so, dass Nutzende ihre Position und sinnvolle nächste Schritte erkennen. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Navigationshierarchie](/schlaufuchs-platform/images/overviews/v147/navigationshierarchie.svg)

*Überblick über Hauptnavigation, Unterbereiche, Breadcrumbs und die Ordnung von Webinhalten.*

## Grundidee

Eine Navigationshierarchie ordnet Inhalte so, dass Nutzende ihre Position und sinnvolle nächste Schritte erkennen. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Navigationshierarchie hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Hauptnavigation:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Unterstruktur:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Breadcrumbs:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Tiefe und Breite:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Eine Navigationshierarchie ordnet Inhalte so, dass Nutzende ihre Position und sinnvolle nächste Schritte erkennen. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
