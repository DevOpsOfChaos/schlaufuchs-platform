---
title: "Web Development – Pflichtfeldhinweis und Fehlermeldung unterscheiden"
...
<div class="example-card">
  ...
  <h3>Ein Feld ist erforderlich und später fehlerhaft ausgefüllt.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-pflichtfeldhinweis-und-fehlermeldung-unterscheiden.svg" alt="Lernillustration zu Formularhinweise." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Vorabhinweis und konkrete Fehlermeldung werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Trenne Regel vor Eingabe und Fehler nach Prüfung.</span></div>
  </div>
</div>
