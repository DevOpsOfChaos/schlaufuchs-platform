---
title: "Web Development – Fokus nach Dialogschluss zurückführen"
description: "Lerne Dialog-Fokus als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
**Dialog-Fokus** ist bewusst als kleines Unterthema angelegt. Lerne Dialog-Fokus als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Modal wird geschlossen und der Tastaturfokus springt an den Seitenanfang.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-fokus-nach-dialogschluss-zurueckfuehren.svg" alt="Lernillustration zu Dialog-Fokus." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Visuelles Schließen wird mit bedienbarem Schließen gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, welches Element den Dialog geöffnet hat.</span></div>
  </div>
</div>
