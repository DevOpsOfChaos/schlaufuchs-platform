---
title: "Web Development – Statusmeldung und Fehlermeldung trennen"
...
<div class="example-card">
  ...
  <h3>Ein Formular speichert, lädt oder scheitert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-statusmeldung-und-fehlermeldung-trennen.svg" alt="Lernillustration zu Statusmeldungen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Erfolg, Fehler und Wartezustand werden im gleichen Text versteckt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob Nutzende wissen, was passiert ist und was sie tun können.</span></div>
  </div>
</div>
