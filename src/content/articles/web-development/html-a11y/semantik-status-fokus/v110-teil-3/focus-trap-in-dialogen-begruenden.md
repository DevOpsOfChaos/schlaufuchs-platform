---
title: "Web Development – Focus Trap in Dialogen begründen"
...
<div class="example-card">
  ...
  <h3>Ein modaler Dialog ist geöffnet, aber Tab springt in den Hintergrund.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v110-focus-trap-in-dialogen-begruenden.svg" alt="Lernillustration zu Focus Trap in Dialogen begründen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Der Dialog wird nur visuell als modal verstanden.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Halte den Fokus im Dialog und ermögliche einen klaren Ausstieg.</span></div>
  </div>
</div>
