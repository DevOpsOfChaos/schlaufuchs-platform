...
Datenschutz im Frontend betrifft sichtbare Eingaben, lokale Speicherung, Tracking, externe Ressourcen und unbeabsichtigte Datenweitergabe. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Datenschutz im Frontend](/schlaufuchs-platform/images/overviews/v147/datenschutz-im-frontend.svg)

*Überblick über Datenschutzfragen, die bereits im Browser und nicht erst im Backend entstehen.*

## Grundidee

Datenschutz im Frontend betrifft sichtbare Eingaben, lokale Speicherung, Tracking, externe Ressourcen und unbeabsichtigte Datenweitergabe. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Datenschutz im Frontend hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Datensparsamkeit:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **lokale Speicherung:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Drittanbieter:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Transparenz:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Datenschutz im Frontend betrifft sichtbare Eingaben, lokale Speicherung, Tracking, externe Ressourcen und unbeabsichtigte Datenweitergabe. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
