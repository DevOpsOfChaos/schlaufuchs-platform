---
title: "Web Development – CSP-Report nicht mit Blockade verwechseln"
description: "Lerne CSP Report Only als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst CSP Report Only als enges Unterthema."
...
commonMistakes:
  - "Report-only wird als bereits schützende Blockade gelesen."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "CSP Report Only wird durch Kontext, Abgrenzung und Prüfung klar."
...
**CSP Report Only** ist bewusst als kleines Unterthema angelegt. Lerne CSP Report Only als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine neue Content-Security-Policy wird getestet.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v111-csp-report-nicht-mit-blockade-verwechseln.svg" alt="Lernillustration zu CSP Report Only." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Report-only wird als bereits schützende Blockade gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob die Policy nur meldet oder wirklich blockiert.</span></div>
  </div>
</div>
