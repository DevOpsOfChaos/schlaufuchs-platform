---
title: "Web Development – Reviewfrage vor Geschmacksfrage stellen"
description: "Trainiere Reviewfrage vor Geschmacksfrage stellen als kleines Unterthema mit klarer Trennkante, Beispiel und Gegenprobe."
...
learningGoals:
  - "Du erklärst Reviewfrage vor Geschmacksfrage stellen an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Das Review diskutiert zuerst persönliche Stilvorlieben."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welche Nutzerwirkung oder Fehlerklasse wird geprüft?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Reviewfrage vor Geschmacksfrage stellen."
...
<img src="/schlaufuchs-platform/illustrations/web-development-reviewfrage-vor-geschmacksfrage-stellen-v115.svg" alt="Lernillustration zu Reviewfrage vor Geschmacksfrage stellen" loading="lazy" />

## Grundidee

Dieses Unterthema behandelt **Reviewfrage vor Geschmacksfrage stellen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welche Nutzerwirkung oder Fehlerklasse wird geprüft?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: Reviewfrage vor Geschmacksfrage stellen</h3>
  <p>Ein Pull Request verändert UI und Logik.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>Reviewfrage vor Geschmacksfrage stellen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Das Review diskutiert zuerst persönliche Stilvorlieben.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Das Review diskutiert zuerst persönliche Stilvorlieben. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> Reviewfrage vor Geschmacksfrage stellen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
