...
learningGoals:
  - "Du erklärst Feature Flag begrenzt einsetzen an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Wann wird der Flag wieder entfernt?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Feature Flag begrenzt einsetzen."
