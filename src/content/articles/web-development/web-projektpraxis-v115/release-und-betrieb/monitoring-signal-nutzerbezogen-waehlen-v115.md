...
learningGoals:
  - "Du erklärst Monitoring-Signal nutzerbezogen wählen an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Welches Signal zeigt echte Nutzerprobleme?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Monitoring-Signal nutzerbezogen wählen."
