...
learningGoals:
  - "Du erklärst Rollback-Bedingung vorher definieren an einem kleinen, abgegrenzten Fall."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Bei welchem Signal wird zurückgerollt?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Rollback-Bedingung vorher definieren."
