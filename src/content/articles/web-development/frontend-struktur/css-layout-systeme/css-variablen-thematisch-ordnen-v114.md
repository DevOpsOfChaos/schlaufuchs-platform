---
title: CSS-Variablen thematisch ordnen
description: Design-Tokens statt Einzelwerte nutzen
...
learningGoals:
- Du erklärst CSS-Variablen thematisch ordnen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Jede Komponente definiert eigene Werte.
...
keyTakeaways:
- CSS-Variablen thematisch ordnen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**CSS-Variablen thematisch ordnen** ist bewusst als kleines Unterthema angelegt. Design-Tokens statt Einzelwerte nutzen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Farben und Abstände wiederholen sich.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Werte gehören als gemeinsame Token zusammen?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v114-css-variablen-thematisch-ordnen-v114.svg" alt="Lernillustration zu CSS-Variablen thematisch ordnen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jede Komponente definiert eigene Werte.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Werte gehören als gemeinsame Token zusammen?</span></div>
  </div>
</div>
