---
title: Flex-Wrapping planen
description: Zeilenumbruch als Layoutfall behandeln
...
learningGoals:
- Du erklärst Flex-Wrapping planen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Nur Desktopbreite wird geprüft.
...
keyTakeaways:
- Flex-Wrapping planen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Flex-Wrapping planen** ist bewusst als kleines Unterthema angelegt. Zeilenumbruch als Layoutfall behandeln. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Karten sollen auf kleinen Bildschirmen umbrechen.</h3>
  <p>Die wichtige Frage lautet: <strong>Was passiert, wenn kein Platz mehr da ist?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/web-development-v114-flex-wrapping-planen-v114.svg" alt="Lernillustration zu Flex-Wrapping planen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur Desktopbreite wird geprüft.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Was passiert, wenn kein Platz mehr da ist?</span></div>
  </div>
</div>
