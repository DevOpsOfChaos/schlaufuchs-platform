---
title: MOSFET-Gate-Pegel prüfen
description: Logikpegel und Durchsteuerung unterscheiden
...
learningGoals:
- Du erklärst MOSFET-Gate-Pegel prüfen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Jeder MOSFET gilt als logic-level geeignet.
...
keyTakeaways:
- MOSFET-Gate-Pegel prüfen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**MOSFET-Gate-Pegel prüfen** ist bewusst als kleines Unterthema angelegt. Logikpegel und Durchsteuerung unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein MOSFET soll mit 3,3 Volt gesteuert werden.</h3>
  <p>Die wichtige Frage lautet: <strong>Ist der Durchlasswiderstand bei diesem Gate-Pegel angegeben?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-mosfet-gate-pegel-pruefen-v114.svg" alt="Lernillustration zu MOSFET-Gate-Pegel prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jeder MOSFET gilt als logic-level geeignet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ist der Durchlasswiderstand bei diesem Gate-Pegel angegeben?</span></div>
  </div>
</div>
