---
title: Transistor als Schalter lesen
description: Basis/Gate-Ansteuerung und Laststrom trennen
...
learningGoals:
- Du erklärst Transistor als Schalter lesen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Transistor als Schalter lesen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Transistor als Schalter lesen** ist bewusst als kleines Unterthema angelegt. Basis/Gate-Ansteuerung und Laststrom trennen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Mikrocontroller schaltet eine Lampe.</h3>
  <p>Die wichtige Frage lautet: <strong>Wer trägt den Laststrom wirklich?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-transistor-als-schalter-lesen-v114.svg" alt="Lernillustration zu Transistor als Schalter lesen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Pin soll den Laststrom direkt liefern.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wer trägt den Laststrom wirklich?</span></div>
  </div>
</div>
