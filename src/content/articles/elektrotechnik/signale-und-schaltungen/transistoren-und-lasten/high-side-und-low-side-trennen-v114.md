---
title: High-Side und Low-Side trennen
description: Lastposition im Schaltkreis bewusst wählen
...
learningGoals:
- Du erklärst High-Side und Low-Side trennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Schaltseite wird als egal betrachtet.
...
keyTakeaways:
- High-Side und Low-Side trennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**High-Side und Low-Side trennen** ist bewusst als kleines Unterthema angelegt. Lastposition im Schaltkreis bewusst wählen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Last soll gegen Plus oder Masse geschaltet werden.</h3>
  <p>Die wichtige Frage lautet: <strong>Liegt der Schalter oberhalb oder unterhalb der Last?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-high-side-und-low-side-trennen-v114.svg" alt="Lernillustration zu High-Side und Low-Side trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Schaltseite wird als egal betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Liegt der Schalter oberhalb oder unterhalb der Last?</span></div>
  </div>
</div>
...
Dieses Thema gehört zu **Transistoren Und Lasten**, aber es soll nicht das ganze Unterthema ersetzen. Die Seite beantwortet eine einzelne Prüffrage. Andere Seiten können danach benachbarte Fälle, Sonderfälle oder Vertiefungen übernehmen.
