---
title: Verlustleistung abschätzen
description: Wärme als Teil der Schaltungsentscheidung lesen
...
learningGoals:
- Du erklärst Verlustleistung abschätzen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Verlustleistung abschätzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Verlustleistung abschätzen** ist bewusst als kleines Unterthema angelegt. Wärme als Teil der Schaltungsentscheidung lesen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Bauteil führt hohen Strom bei Spannungsabfall.</h3>
  <p>Die wichtige Frage lautet: <strong>Wie viel Leistung wird im Bauteil verheizt?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-verlustleistung-abschaetzen-v114.svg" alt="Lernillustration zu Verlustleistung abschätzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur der Strom wird betrachtet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wie viel Leistung wird im Bauteil verheizt?</span></div>
  </div>
</div>
