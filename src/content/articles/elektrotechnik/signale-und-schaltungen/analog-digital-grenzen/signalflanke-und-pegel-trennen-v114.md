---
title: Signalflanke und Pegel trennen
description: Ereignis und Zustand auseinanderhalten
...
learningGoals:
- Du erklärst Signalflanke und Pegel trennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Solange High anliegt, wird ständig gezählt.
...
keyTakeaways:
- Signalflanke und Pegel trennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Signalflanke und Pegel trennen** ist bewusst als kleines Unterthema angelegt. Ereignis und Zustand auseinanderhalten. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Zähler soll nur beim Wechsel zählen.</h3>
  <p>Die wichtige Frage lautet: <strong>Wird ein Wechsel oder ein Zustand ausgewertet?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-signalflanke-und-pegel-trennen-v114.svg" alt="Lernillustration zu Signalflanke und Pegel trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Solange High anliegt, wird ständig gezählt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Wird ein Wechsel oder ein Zustand ausgewertet?</span></div>
  </div>
</div>
