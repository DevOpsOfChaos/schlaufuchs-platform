---
title: Pull-down und Pull-up vergleichen
description: Ruhezustand bewusst festlegen
...
learningGoals:
- Du erklärst Pull-down und Pull-up vergleichen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Pull-down und Pull-up vergleichen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Pull-down und Pull-up vergleichen** ist bewusst als kleines Unterthema angelegt. Ruhezustand bewusst festlegen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Eingang soll ohne Signal definiert sein.</h3>
  <p>Die wichtige Frage lautet: <strong>Welcher Pegel gilt ohne aktives Signal?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-pull-down-und-pull-up-vergleichen-v114.svg" alt="Lernillustration zu Pull-down und Pull-up vergleichen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Eingang bleibt offen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welcher Pegel gilt ohne aktives Signal?</span></div>
  </div>
</div>
