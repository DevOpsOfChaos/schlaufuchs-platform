...
Dieses Unterthema behandelt **LED-Vorwiderstand begründen** bewusst eng. Es gehört zu einem größeren Fachbereich, soll aber nicht als Sammelseite funktionieren. Die Seite beantwortet deshalb eine klare Frage: **Welcher Strom soll durch den Widerstand begrenzt werden?**

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Fall: LED-Vorwiderstand begründen</h3>
  <p>Eine LED soll an einer Versorgung betrieben werden.</p>
</div>
...
<div class="compare-card">
  ...
  <h3>LED-Vorwiderstand begründen sauber lesen</h3>
  <div class="compare-grid">
    <div class="compare-item">
      <strong>Unsaubere Lesart</strong>
      <span>Die LED wird direkt an die Spannung gelegt.</span>
    </div>
    <div class="compare-item">
...
Die häufigste Fehlstelle ist: Die LED wird direkt an die Spannung gelegt. Dadurch wird ein kleiner fachlicher Unterschied unsichtbar. Besser ist, die Aufgabe erst auf die konkrete Prüffrage zu verkleinern und dann mit einer Gegenprobe abzusichern.

<div class="note-panel">
  <p><strong>Merke:</strong> LED-Vorwiderstand begründen bleibt übersichtlich, wenn du zuerst Kontext, Trennkante und Gegenprobe formulierst.</p>
</div>
