---
title: "Elektrotechnik – AC- und DC-Kopplung am Oszi unterscheiden"
...
<div class="example-card">
  ...
  <h3>Ein Signal hat Gleichanteil und kleine Wechselanteile.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v110-ac-und-dc-kopplung-am-oszi-unterscheiden.svg" alt="Lernillustration zu AC- und DC-Kopplung am Oszi unterscheiden." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>AC-Kopplung wird als bessere Ansicht ohne Informationsverlust gesehen.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Entscheide, ob der Gleichanteil für die Frage wichtig ist.</span></div>
  </div>
</div>
