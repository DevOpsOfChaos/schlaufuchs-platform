---
title: "Elektrotechnik – Flanke und Pegel im Signalbild trennen"
...
<div class="example-card">
  ...
  <h3>Ein Interrupt soll auf eine steigende Flanke reagieren.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v110-flanke-und-pegel-im-signalbild-trennen.svg" alt="Lernillustration zu Flanke und Pegel im Signalbild trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Dauerhaft High wird mit Ereignis verwechselt.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Unterscheide Zustand und Übergang im Zeitdiagramm.</span></div>
  </div>
</div>
