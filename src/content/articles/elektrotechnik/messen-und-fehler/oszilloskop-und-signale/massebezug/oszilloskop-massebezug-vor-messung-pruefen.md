---
title: "Elektrotechnik – Oszilloskop-Massebezug vor Messung prüfen"
description: "Lerne Massebezug als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Massebezug als enges Unterthema."
...
commonMistakes:
  - "Masseklemme wird wie ein beliebiger Messpunkt behandelt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Massebezug wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Massebezug** ist bewusst als kleines Unterthema angelegt. Lerne Massebezug als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Tastkopf wird an eine nicht massefreie Schaltung gehalten.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-oszilloskop-massebezug-vor-messung-pruefen.svg" alt="Lernillustration zu Massebezug." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Masseklemme wird wie ein beliebiger Messpunkt behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob die Masseklemme elektrisch mit Schutzleiter verbunden ist.</span></div>
  </div>
</div>
