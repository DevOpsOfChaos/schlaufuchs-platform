---
title: "Elektrotechnik – Oszilloskop AC- und DC-Kopplung unterscheiden"
description: "Lerne AC- und DC-Kopplung als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst AC- und DC-Kopplung in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "AC- und DC-Kopplung wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**AC- und DC-Kopplung** ist ein bewusst kleines Unterthema. Lerne AC- und DC-Kopplung als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>DC-Kopplung zeigt Gleichanteil und Wechselanteil, AC-Kopplung blendet den Gleichanteil aus.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotec-v108-oszilloskop-ac-und-dc-kopplung-unterscheiden.svg" alt="Lernillustration zu AC- und DC-Kopplung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Kopplung vor Amplitudenbewertung prüfen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Kopplung vor Amplitudenbewertung prüfen.</span></div>
