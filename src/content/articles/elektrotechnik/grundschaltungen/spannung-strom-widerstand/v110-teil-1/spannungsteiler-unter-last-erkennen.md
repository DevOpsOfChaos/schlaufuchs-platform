---
title: "Elektrotechnik – Spannungsteiler unter Last erkennen"
description: "Lerne Spannungsteiler unter Last erkennen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
...
learningGoals:
  - "Du erklärst Spannungsteiler unter Last erkennen als eigenes Unterthema."
...
commonMistakes:
  - "Der Verbraucher wird als unsichtbar angenommen."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Spannungsteiler unter Last erkennen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Spannungsteiler unter Last erkennen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Spannungsteiler liefert ohne Last eine passende Spannung, mit Verbraucher aber nicht mehr.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v110-spannungsteiler-unter-last-erkennen.svg" alt="Lernillustration zu Spannungsteiler unter Last erkennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Der Verbraucher wird als unsichtbar angenommen.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Berechne oder skizziere den Lastwiderstand parallel zum unteren Teilerwiderstand.</span></div>
  </div>
</div>
