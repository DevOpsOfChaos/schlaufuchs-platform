---
title: "Elektrotechnik – Pull-up-Widerstand nicht beliebig wählen"
description: "Lerne Pull-up-Widerstand nicht beliebig wählen als kleines, klar prüfbares Unterthema mit Abgrenzung, Beispiel und Gegenprobe."
...
learningGoals:
  - "Du erklärst Pull-up-Widerstand nicht beliebig wählen als eigenes Unterthema."
...
commonMistakes:
  - "Pull-up wird nur als Ein-Aus-Schalter im Code gesehen."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Pull-up-Widerstand nicht beliebig wählen wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Pull-up-Widerstand nicht beliebig wählen** ist bewusst als enges Unterthema angelegt. Die Seite beantwortet nicht das ganze Kapitel, sondern die kleine fachliche Entscheidung, die in Aufgaben oft den Unterschied macht.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Eingang soll stabil High lesen, aber beim Tastendruck nicht zu viel Strom ziehen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v110-pullup-widerstand-nicht-beliebig-waehlen.svg" alt="Lernillustration zu Pull-up-Widerstand nicht beliebig wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Naheliegender Fehler</strong><span>Pull-up wird nur als Ein-Aus-Schalter im Code gesehen.</span></div>
    <div class="compare-item"><strong>Prüfschritt</strong><span>Prüfe Strom beim Low-Zustand und Störfestigkeit im High-Zustand.</span></div>
  </div>
</div>
...
```text
Messpunkt → Bezug → Erwartungswert → Gegenmessung
```
