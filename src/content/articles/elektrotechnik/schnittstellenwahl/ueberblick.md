...
Die Wahl einer Schnittstelle hängt nicht nur davon ab, ob Daten übertragen werden können. Entfernung, Störumgebung, Geschwindigkeit, Teilnehmerzahl und Debugbarkeit sind ebenso wichtig. Die Überblicksseite ist bewusst allgemein gehalten: Sie soll Orientierung geben, bevor einzelne Spezialfälle, Werkzeuge oder Rechenregeln wichtig werden.

![Schnittstellenwahl](/schlaufuchs-platform/images/overviews/v147/schnittstellenwahl.svg)

*Überblick darüber, wie elektrische, zeitliche und organisatorische Anforderungen die Wahl einer Schnittstelle beeinflussen.*

## Grundidee

Die Wahl einer Schnittstelle hängt nicht nur davon ab, ob Daten übertragen werden können. Entfernung, Störumgebung, Geschwindigkeit, Teilnehmerzahl und Debugbarkeit sind ebenso wichtig. In vielen Lern- und Praxissituationen wird das Thema zu spät allgemein erklärt. Dann stehen einzelne Beispiele nebeneinander, ohne dass klar ist, welche gemeinsame Struktur dahinterliegt.
...
Schnittstellenwahl hilft dabei, Entscheidungen, Beobachtungen oder Berechnungen nachvollziehbar zu ordnen. Es macht sichtbar, welche Elemente beteiligt sind, welche Rolle sie übernehmen und an welcher Stelle Missverständnisse entstehen können.
...
- **Datenmenge:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Leitungslänge:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Topologie:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
- **Fehlerverhalten:** Dieser Aspekt beeinflusst, wie das Thema verstanden, geplant oder überprüft wird.
...
Die Wahl einer Schnittstelle hängt nicht nur davon ab, ob Daten übertragen werden können. Entfernung, Störumgebung, Geschwindigkeit, Teilnehmerzahl und Debugbarkeit sind ebenso wichtig. Als Überblick ist das Thema dann verstanden, wenn die Grundidee, die wichtigsten Teilaspekte und mindestens eine typische Fehlerquelle klar benannt werden können.
