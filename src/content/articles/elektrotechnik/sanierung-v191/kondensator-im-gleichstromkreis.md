...
Der Kern ist: **kurzzeit- und langzeitverhalten trennen**. Elektrotechnik wird stabiler, wenn Größen, Bauteilrollen und Messpunkte nicht vermischt werden. Eine ruhige Analyse beginnt deshalb mit der Schaltungstopologie und endet erst danach bei Rechnung oder Messwert.

Wichtige Leitgedanken:

- Direkt nach dem Umschalten verhält sich ein Kondensator anders als im Endzustand.
- Im stationären Gleichstromfall fließt ideal kein Kondensatorstrom.
- Die Spannung am Kondensator ist eine Zustandsgröße.
...
Kondensator im Gleichstromkreis ist verstanden, wenn Schaltplan, Messpunkt, Bauteilrolle, Grenzwert und Fehlerbild getrennt erklärt werden können.
