---
title: "Schaltplan und Aufbau vergleichen"
description: "Verstehe plan und realität abgleichen als ruhigen Baustein für sichere und nachvollziehbare Elektrotechnik."
...
practiceIdeas:
  - "Führe einen Knotenvergleich zwischen Schaltplan und Steckbrettaufbau durch."
...
keyTakeaways:
  - "Der Schaltplan zeigt elektrische Beziehungen, nicht zwingend die räumliche Lage."
...
![Didaktische Skizze zu Schaltplan und Aufbau vergleichen](/schlaufuchs-platform/images/elektrotechnik/sanierung-v191/schaltplan-und-aufbau-vergleichen.svg)

Schaltplan und Aufbau vergleichen gehört zur Elektrotechnik-Sanierung v191. Die Seite behandelt das Thema als praktische Entscheidung: Was zeigt der Schaltplan, was passiert im realen Aufbau, wo wird gemessen und welcher Fehlerfall muss vor dem Einschalten bedacht werden?

## Worum es geht

Der Kern ist: **plan und realität abgleichen**. Elektrotechnik wird stabiler, wenn Größen, Bauteilrollen und Messpunkte nicht vermischt werden. Eine ruhige Analyse beginnt deshalb mit der Schaltungstopologie und endet erst danach bei Rechnung oder Messwert.

Wichtige Leitgedanken:

- Der Schaltplan zeigt elektrische Beziehungen, nicht zwingend die räumliche Lage.
- Aufbaufehler entstehen oft durch vertauschte Knoten.
- Vergleich erfolgt Bauteil für Bauteil und Knoten für Knoten.
...
Schaltplan und Aufbau vergleichen ist verstanden, wenn Schaltplan, Messpunkt, Bauteilrolle, Grenzwert und Fehlerbild getrennt erklärt werden können.
