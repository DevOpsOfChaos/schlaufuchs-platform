...
description: "Verstehe teilspannungen aus widerständen ableiten als ruhigen Baustein für sichere und nachvollziehbare Elektrotechnik."
...
learningGoals:
  - "Teilspannungen aus Widerständen ableiten"
  - "Mess- und Schaltungsentscheidungen begründen"
  - "typische Fehlerbilder früh erkennen"
practiceIdeas:
  - "Erkläre, warum eine Messlast das Ergebnis eines Spannungsteilers verändern kann."
...
keyTakeaways:
  - "Ein Spannungsteiler verteilt Spannung auf Widerstände."
...
![Didaktische Skizze zu Spannungsteiler verstehen](/schlaufuchs-platform/images/elektrotechnik/sanierung-v191/spannungsteiler-verstehen.svg)

Spannungsteiler verstehen gehört zur Elektrotechnik-Sanierung v191. Die Seite behandelt das Thema als praktische Entscheidung: Was zeigt der Schaltplan, was passiert im realen Aufbau, wo wird gemessen und welcher Fehlerfall muss vor dem Einschalten bedacht werden?

## Worum es geht

Der Kern ist: **teilspannungen aus widerständen ableiten**. Elektrotechnik wird stabiler, wenn Größen, Bauteilrollen und Messpunkte nicht vermischt werden. Eine ruhige Analyse beginnt deshalb mit der Schaltungstopologie und endet erst danach bei Rechnung oder Messwert.

Wichtige Leitgedanken:

- Ein Spannungsteiler verteilt Spannung auf Widerstände.
- Größere Widerstände erhalten bei gleichem Strom größere Teilspannungen.
- Lasten können einen Spannungsteiler verändern.
...
Spannungsteiler verstehen ist verstanden, wenn Schaltplan, Messpunkt, Bauteilrolle, Grenzwert und Fehlerbild getrennt erklärt werden können.
