---
title: "RC-Glied als Zeitverhalten"
...
Der Kern ist: **laden und entladen qualitativ deuten**. Elektrotechnik wird stabiler, wenn Größen, Bauteilrollen und Messpunkte nicht vermischt werden. Eine ruhige Analyse beginnt deshalb mit der Schaltungstopologie und endet erst danach bei Rechnung oder Messwert.

Wichtige Leitgedanken:

- Ein Kondensator ändert seine Spannung nicht sprunghaft ideal.
- Widerstand und Kapazität bestimmen die Zeitkonstante.
- Anfangs- und Endzustand machen den Verlauf verständlich.
...
RC-Glied als Zeitverhalten ist verstanden, wenn Schaltplan, Messpunkt, Bauteilrolle, Grenzwert und Fehlerbild getrennt erklärt werden können.
