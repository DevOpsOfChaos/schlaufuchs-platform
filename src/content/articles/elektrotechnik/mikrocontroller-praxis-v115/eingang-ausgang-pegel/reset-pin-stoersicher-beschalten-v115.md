...
learningGoals:
  - "Du erklärst Reset-Pin störsicher beschalten an einem kleinen, abgegrenzten Fall."
...
commonMistakes:
  - "Reset wird als reines Softwareereignis gesehen."
...
keyTakeaways:
  - "Dieses Unterthema prüft vor allem: Ist der Reset-Pin elektrisch stabil geführt?"
  - "Eine gute Lösung benennt die Trennkante ausdrücklich."
  - "Die Gegenprobe zeigt, ob die Begründung wirklich trägt."
recognizeSignals:
  - "Die Aufgabe fragt nach Reset-Pin störsicher beschalten."
