---
title: "Elektrotechnik – Leistung aus Spannung und Strom bewerten"
description: "Lerne Verlustleistung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
**Verlustleistung** ist bewusst als kleines Unterthema angelegt. Lerne Verlustleistung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Widerstand hat den richtigen Ohmwert, wird aber heiß.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-leistung-aus-spannung-und-strom-bewerten.svg" alt="Lernillustration zu Verlustleistung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Widerstandswert und Belastbarkeit werden gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Berechne oder schätze P = U mal I.</span></div>
  </div>
</div>
