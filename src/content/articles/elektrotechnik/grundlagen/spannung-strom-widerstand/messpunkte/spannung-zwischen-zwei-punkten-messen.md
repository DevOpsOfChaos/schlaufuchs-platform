---
title: "Elektrotechnik – Spannung zwischen zwei Punkten messen"
description: "Lerne Spannungsmessung als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe."
...
learningGoals:
  - "Du erklärst Spannungsmessung als eigenes Unterthema."
...
keyTakeaways:
  - "Spannungsmessung wird durch Einordnung, Trennung und Gegenprobe stabil."
...
**Spannungsmessung** ist ein kleines, bewusst abgegrenztes Unterthema. Lerne Spannungsmessung als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe. Die Seite verhindert, dass mehrere Nachbarfragen in einem breiten Sammelbegriff verschwimmen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v107-spannung-zwischen-zwei-punkten-messen.svg" alt="Lernillustration zu Spannungsmessung." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
