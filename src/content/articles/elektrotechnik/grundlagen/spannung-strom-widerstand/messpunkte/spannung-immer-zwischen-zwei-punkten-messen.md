---
title: "Elektrotechnik – Spannung immer zwischen zwei Punkten messen"
description: "Lerne Spannungsmessung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Spannungsmessung als enges Unterthema."
...
commonMistakes:
  - "Spannung wird wie eine Eigenschaft eines einzelnen Punktes behandelt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Spannungsmessung wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Spannungsmessung** ist bewusst als kleines Unterthema angelegt. Lerne Spannungsmessung als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Messwert wird ohne Bezugspunkt notiert.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-spannung-immer-zwischen-zwei-punkten-messen.svg" alt="Lernillustration zu Spannungsmessung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Spannung wird wie eine Eigenschaft eines einzelnen Punktes behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Benenne immer beide Messpunkte.</span></div>
  </div>
</div>
