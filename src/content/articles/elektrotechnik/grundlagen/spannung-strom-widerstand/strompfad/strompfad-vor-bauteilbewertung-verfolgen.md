---
title: "Elektrotechnik – Strompfad vor Bauteilbewertung verfolgen"
description: "Lerne Strompfad als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
**Strompfad** ist bewusst als kleines Unterthema angelegt. Lerne Strompfad als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine LED leuchtet nicht, obwohl Versorgung vorhanden ist.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-strompfad-vor-bauteilbewertung-verfolgen.svg" alt="Lernillustration zu Strompfad." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur ein Bauteil wird betrachtet, nicht der geschlossene Pfad.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Zeichne den vollständigen Weg von Plus nach Masse.</span></div>
  </div>
</div>
