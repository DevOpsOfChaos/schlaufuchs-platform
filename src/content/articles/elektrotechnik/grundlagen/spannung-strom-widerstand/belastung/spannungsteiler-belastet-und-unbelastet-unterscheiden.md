---
title: "Elektrotechnik – Spannungsteiler belastet und unbelastet unterscheiden"
description: "Lerne Belasteter Spannungsteiler als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Belasteter Spannungsteiler in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Belasteter Spannungsteiler wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Belasteter Spannungsteiler** ist ein bewusst kleines Unterthema. Lerne Belasteter Spannungsteiler als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein angeschlossener Verbraucher verändert den wirksamen unteren Widerstand des Teilers.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotec-v108-spannungsteiler-belastet-und-unbelastet-unterschei.svg" alt="Lernillustration zu Belasteter Spannungsteiler." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Last nicht nachträglich ignorieren.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Last nicht nachträglich ignorieren.</span></div>
