---
title: "Elektrotechnik – Widerstandsleistung als Grenzwert beachten"
description: "Lerne Leistungsgrenze als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe."
...
learningGoals:
  - "Du erklärst Leistungsgrenze als eigenes Unterthema."
...
keyTakeaways:
  - "Leistungsgrenze wird durch Einordnung, Trennung und Gegenprobe stabil."
...
**Leistungsgrenze** ist ein kleines, bewusst abgegrenztes Unterthema. Lerne Leistungsgrenze als klar abgegrenztes Unterthema mit Beispiel, Prüfraster und Gegenprobe. Die Seite verhindert, dass mehrere Nachbarfragen in einem breiten Sammelbegriff verschwimmen.
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v107-widerstandsleistung-als-grenzwert-beachten.svg" alt="Lernillustration zu Leistungsgrenze." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
```text
Quelle → Bauteil → Messpunkt → Fehlerbild
```
