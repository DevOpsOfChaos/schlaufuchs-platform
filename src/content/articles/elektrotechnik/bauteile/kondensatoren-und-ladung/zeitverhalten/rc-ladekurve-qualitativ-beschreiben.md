---
title: "Elektrotechnik – RC-Ladekurve qualitativ beschreiben"
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v107-rc-ladekurve-qualitativ-beschreiben.svg" alt="Lernillustration zu RC-Zeitverhalten." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
