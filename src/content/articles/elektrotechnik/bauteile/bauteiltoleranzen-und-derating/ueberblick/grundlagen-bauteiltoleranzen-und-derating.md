---
title: "Grundlagen: Bauteiltoleranzen und Derating"
description: "Allgemeiner Überblick über Toleranz, Grenzwerte, Sicherheitsabstand und Bauteilauswahl."
subject: "elektrotechnik"
section: "Bauteile"
topicPath: ["bauteile", "bauteiltoleranzen-und-derating", "ueberblick", "grundlagen-bauteiltoleranzen-und-derating"]
learningGoals: []
practiceIdeas: []
commonMistakes: []
keyTakeaways: []
...
**Bauteiltoleranzen und Derating** ist ein wichtiges Orientierungsthema in der Elektrotechnik. Es hilft, eine Schaltung, einen Messwert oder einen Fehlerfall nicht isoliert zu betrachten, sondern als Zusammenhang aus Ursache, Wirkung, Grenze und Prüfung.
...
Ein Bauteilwert ist selten perfekt. Zuverlässige Schaltungen planen deshalb Abweichungen und Reserven ein, statt Grenzwerte dauerhaft auszureizen.
...
- **Toleranz**: wichtiger Begriff im Zusammenhang mit Bauteiltoleranzen und Derating.
- **Grenzwert**: wichtiger Begriff im Zusammenhang mit Bauteiltoleranzen und Derating.
- **Derating**: wichtiger Begriff im Zusammenhang mit Bauteiltoleranzen und Derating.
- **Sicherheitsabstand**: wichtiger Begriff im Zusammenhang mit Bauteiltoleranzen und Derating.
...
- Datenblattgrenzen als normalen Betriebswert zu nutzen.
- Toleranzen erst nach dem Fehler zu betrachten.
- Bauteile nur nach Nennwert auszuwählen.
...
- Bauteile haben Streuung und Belastungsgrenzen.
- Derating schafft Abstand zum Grenzbetrieb.
- Gute Auswahl berücksichtigt Temperatur, Leistung und Toleranz.
