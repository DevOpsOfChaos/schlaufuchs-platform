---
title: "Elektrotechnik – RC-Hochpass und Tiefpass qualitativ unterscheiden"
description: "Lerne RC-Filter als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst RC-Filter in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "RC-Filter wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**RC-Filter** ist ein bewusst kleines Unterthema. Lerne RC-Filter als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Die Lage von Widerstand und Kondensator entscheidet, ob langsame oder schnelle Änderungen stärker durchkommen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotec-v108-rc-hochpass-und-tiefpass-qualitativ-unterscheiden.svg" alt="Lernillustration zu RC-Filter." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Sehr niedrige und sehr hohe Frequenz gedanklich prüfen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Sehr niedrige und sehr hohe Frequenz gedanklich prüfen.</span></div>
