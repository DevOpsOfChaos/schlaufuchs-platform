---
title: "Elektrotechnik – RC-Zeitkonstante qualitativ deuten"
description: "Lerne RC-Zeitkonstante als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst RC-Zeitkonstante als enges Unterthema."
...
**RC-Zeitkonstante** ist bewusst als kleines Unterthema angelegt. Lerne RC-Zeitkonstante als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Kondensator lädt nicht sofort auf.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-rc-zeitkonstante-qualitativ-deuten.svg" alt="Lernillustration zu RC-Zeitkonstante." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Zeitverhalten wird als Defekt gelesen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Vergleiche Widerstand, Kapazität und gewünschte Reaktionszeit.</span></div>
  </div>
</div>
