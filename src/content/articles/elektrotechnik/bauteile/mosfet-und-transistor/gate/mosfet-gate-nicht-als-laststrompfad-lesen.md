---
title: "Elektrotechnik – MOSFET-Gate nicht als Laststrompfad lesen"
description: "Lerne MOSFET-Gate als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst MOSFET-Gate als enges Unterthema."
...
**MOSFET-Gate** ist bewusst als kleines Unterthema angelegt. Lerne MOSFET-Gate als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein MOSFET schaltet eine Last und das Gate wird falsch eingeordnet.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-mosfet-gate-nicht-als-laststrompfad-lesen.svg" alt="Lernillustration zu MOSFET-Gate." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Gate-Strom und Laststrom werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Trenne Steueranschluss und Lastpfad.</span></div>
  </div>
</div>
