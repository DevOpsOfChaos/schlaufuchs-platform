---
title: "Elektrotechnik – Pull-up und Pull-down als Ruhezustand vergleichen"
description: "Lerne Pull-up und Pull-down als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
...
selfCheckPoints: []
level: "einfach"
tags: ["elektrotechnik", "Digitaltechnik"]
draft: false
---
## Grundidee

**Pull-up und Pull-down** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Pull-up und Pull-down als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Eingang darf nicht offen schweben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v109-pullup-und-pulldown-als-ruhezustand-vergleichen.svg" alt="Lernillustration zu Pull-up und Pull-down." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Widerstände werden nur als Strombegrenzung gesehen.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Frage, welcher Pegel ohne Ereignis stabil anliegt.</span></div>
  </div>
</div>
