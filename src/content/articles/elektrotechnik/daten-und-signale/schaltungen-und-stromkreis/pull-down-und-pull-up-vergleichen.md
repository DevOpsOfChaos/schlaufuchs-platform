---
title: "Elektrotechnik – Pull-down und Pull-up vergleichen"
description: "Lerne pull-down und pull-up vergleichen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
...
learningGoals:
  - "Du erklärst pull-down und pull-up vergleichen in einem klaren Kontext."
...
**Pull-down und Pull-up vergleichen** ist bewusst als kleines Unterthema angelegt. Lerne pull-down und pull-up vergleichen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein digitaler Eingang darf nicht schweben.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Pull-Widerstände definieren einen Ruhezustand.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Ein offener Eingang wird als zuverlässig gelesen.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Pull-Widerstände definieren einen Ruhezustand.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein digitaler Eingang darf nicht schweben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Pull-Widerstände definieren einen Ruhezustand.</p>
</div>
