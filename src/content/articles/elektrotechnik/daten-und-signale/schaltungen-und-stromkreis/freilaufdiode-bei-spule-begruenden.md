---
title: "Elektrotechnik – Freilaufdiode bei Spule begründen"
description: "Lerne freilaufdiode bei spule begründen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
...
learningGoals:
  - "Du erklärst freilaufdiode bei spule begründen in einem klaren Kontext."
...
commonMistakes:
  - "Die Diode wird als optionales Zusatzteil behandelt."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Eine Spule erzeugt beim Abschalten eine gefährliche Gegenspannung."
...
**Freilaufdiode bei Spule begründen** ist bewusst als kleines Unterthema angelegt. Lerne freilaufdiode bei spule begründen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Relais wird von einem Transistor geschaltet.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>2. Unterthema wählen</strong><span>Gehört die Aufgabe zu „Schaltungen und Stromkreis“ oder zu einem Nachbarthema?</span></div>
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Eine Spule erzeugt beim Abschalten eine gefährliche Gegenspannung.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Die Diode wird als optionales Zusatzteil behandelt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Eine Spule erzeugt beim Abschalten eine gefährliche Gegenspannung.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Relais wird von einem Transistor geschaltet.
...
Diese Seite bleibt absichtlich schmal. Sie soll ein klarer Baustein im Unterthema **Schaltungen und Stromkreis** sein. Vertiefungen, Nachbarthemen und allgemeine Grundlagen gehören auf eigene Seiten, damit die Fachbereiche übersichtlich bleiben.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Eine Spule erzeugt beim Abschalten eine gefährliche Gegenspannung.</p>
</div>
