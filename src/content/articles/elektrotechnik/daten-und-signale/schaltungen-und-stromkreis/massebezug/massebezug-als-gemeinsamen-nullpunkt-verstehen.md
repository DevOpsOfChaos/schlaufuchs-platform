---
title: "Elektrotechnik – Massebezug als gemeinsamen Nullpunkt verstehen"
description: "Lerne Massebezug als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
...
learningGoals:
  - "Du erklärst Massebezug als eigenes Unterthema."
...
commonMistakes:
  - "Signalpegel werden ohne Bezugspunkt bewertet."
  - "Das Thema nur einem breiten Kapitel zuordnen."
  - "Eine Lösung formulieren, die keine konkrete Prüfung enthält."
keyTakeaways:
  - "Massebezug wird über Einordnung, Abgrenzung und Gegenprobe stabil."
...
**Massebezug** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Massebezug als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Module kommunizieren, haben aber keinen gemeinsamen GND.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v109-massebezug-als-gemeinsamen-nullpunkt-verstehen.svg" alt="Lernillustration zu Massebezug." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Signalpegel werden ohne Bezugspunkt bewertet.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Prüfe, ob beide Seiten dieselbe Masse teilen.</span></div>
  </div>
</div>
