---
title: "Elektrotechnik – Compare Match und Overflow im Timer trennen"
description: "Lerne Compare Match und Overflow als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
...
**Compare Match und Overflow** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne Compare Match und Overflow als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Timer soll periodisch eine Aktion auslösen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v109-compare-match-und-overflow-im-timer-trennen.svg" alt="Lernillustration zu Compare Match und Overflow." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Überlauf und Vergleichswert werden gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Prüfe, ob der Zähler Maximalwert oder Vergleichswert erreicht.</span></div>
  </div>
</div>
