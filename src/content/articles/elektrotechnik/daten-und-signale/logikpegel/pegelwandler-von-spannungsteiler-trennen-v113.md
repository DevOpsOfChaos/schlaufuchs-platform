...
description: "Lerne Pegelwandler von Spannungsteiler trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Pegelwandler von Spannungsteiler trennen als enges Unterthema."
...
commonMistakes:
  - "Ein Spannungsteiler wird als allgemeiner Pegelwandler benutzt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Pegelwandler von Spannungsteiler trennen wird über eine kleine Trennkante verständlich."
...
**Pegelwandler von Spannungsteiler trennen** ist bewusst als kleines Unterthema angelegt. Lerne Pegelwandler von Spannungsteiler trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine bidirektionale Leitung soll zwischen zwei Pegeln arbeiten.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v113-pegelwandler-von-spannungsteiler-trennen-v113.svg" alt="Lernillustration zu Pegelwandler von Spannungsteiler trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Ein Spannungsteiler wird als allgemeiner Pegelwandler benutzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Muss das Signal in beide Richtungen übertragen werden?</span></div>
  </div>
</div>
