---
title: "High-Pegel nicht absolut setzen"
...
<div class="example-card">
  ...
  <h3>Ein Signal mit 3,3 V soll an einem 5-V-System gelesen werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v113-high-pegel-nicht-absolut-setzen-v113.svg" alt="Lernillustration zu High-Pegel nicht absolut setzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>High wird als überall gleiche feste Spannung verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Eingangsschwelle gilt für das Zielsystem?</span></div>
  </div>
</div>
