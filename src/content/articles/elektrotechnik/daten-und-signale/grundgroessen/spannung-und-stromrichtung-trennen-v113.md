---
title: "Spannung und Stromrichtung trennen"
description: "Lerne Spannung und Stromrichtung trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
**Spannung und Stromrichtung trennen** ist bewusst als kleines Unterthema angelegt. Lerne Spannung und Stromrichtung trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine LED leuchtet nicht, obwohl eine Spannung gemessen wird.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v113-spannung-und-stromrichtung-trennen-v113.svg" alt="Lernillustration zu Spannung und Stromrichtung trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Spannung wird mit fließendem Strom gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Gibt es einen geschlossenen Strompfad?</span></div>
  </div>
</div>
