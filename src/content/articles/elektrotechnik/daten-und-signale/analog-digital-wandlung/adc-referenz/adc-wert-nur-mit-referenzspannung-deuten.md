---
title: "Elektrotechnik – ADC-Wert nur mit Referenzspannung deuten"
...
<div class="example-card">
  ...
  <h3>Ein ADC-Wert von 512 soll in Volt übersetzt werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v109-adc-wert-nur-mit-referenzspannung-deuten.svg" alt="Lernillustration zu ADC-Referenzspannung." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Der Zahlenwert wird ohne Referenz direkt gedeutet.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Bestimme erst Referenz und Auflösung.</span></div>
  </div>
</div>
