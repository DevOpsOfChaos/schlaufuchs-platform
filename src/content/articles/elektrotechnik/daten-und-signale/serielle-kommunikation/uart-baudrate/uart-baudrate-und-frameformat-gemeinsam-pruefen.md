---
title: "Elektrotechnik – UART-Baudrate und Frameformat gemeinsam prüfen"
description: "Lerne UART-Baudrate und Frameformat als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe."
...
**UART-Baudrate und Frameformat** ist ein kleines Unterthema mit einer klaren Trennkante. Lerne UART-Baudrate und Frameformat als enges, prüfbares Unterthema mit Beispiel, Abgrenzung und Gegenprobe. Dadurch bleibt die Seite übersichtlich und landet nicht als weiterer Abschnitt in einem zu breiten Sammelthema.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Zwei Geräte senden Zeichen, aber lesen unlesbare Symbole.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v109-uart-baudrate-und-frameformat-gemeinsam-pruefen.svg" alt="Lernillustration zu UART-Baudrate und Frameformat." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Nur TX und RX werden geprüft.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Vergleiche Baudrate, Datenbits, Parität und Stopbits.</span></div>
  </div>
</div>
