---
title: "Elektrotechnik – Innenwiderstand beim Messen mitdenken"
...
<div class="example-card">
  ...
  <h3>Ein Messgerät beeinflusst eine empfindliche Schaltung.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Messgeräte sind nicht völlig unsichtbar für den Stromkreis.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Der angezeigte Wert wird ohne Messaufbau bewertet.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Messgeräte sind nicht völlig unsichtbar für den Stromkreis.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Messgerät beeinflusst eine empfindliche Schaltung.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Messgeräte sind nicht völlig unsichtbar für den Stromkreis.</p>
</div>
