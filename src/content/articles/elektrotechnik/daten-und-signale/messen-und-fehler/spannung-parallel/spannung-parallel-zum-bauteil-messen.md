---
title: "Elektrotechnik – Spannung parallel zum Bauteil messen"
...
<div class="example-card">
  ...
  <h3>An einem Widerstand soll die Spannung geprüft werden.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v109-spannung-parallel-zum-bauteil-messen.svg" alt="Lernillustration zu Spannungsmessung parallel." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Verwechslung</strong><span>Das Messgerät wird wie ein Verbraucher in Reihe geschaltet.</span></div>
    <div class="compare-item"><strong>Ruhige Prüfung</strong><span>Voltmeter parallel zum Bauteil anschließen.</span></div>
  </div>
</div>
