---
title: "Elektrotechnik – Massebezug vor Spannung prüfen"
description: "Lerne massebezug vor spannung prüfen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
subject: "elektrotechnik"
section: "Feinstruktur Elektrotechnik"
topicPath:
  - "daten-und-signale"
  - "messen-und-fehler"
  - "massebezug-vor-spannung-pruefen"
learningGoals:
  - "Du erklärst massebezug vor spannung prüfen in einem klaren Kontext."
...
**Massebezug vor Spannung prüfen** ist bewusst als kleines Unterthema angelegt. Lerne massebezug vor spannung prüfen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Spannung wird zwischen zwei Punkten gemessen.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Spannung braucht immer zwei Bezugspunkte.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Ein einzelner Punkt wird als Spannung verstanden.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Spannung braucht immer zwei Bezugspunkte.</span>
    </div>
  </div>
</div>
...
```text
Situation: Eine Spannung wird zwischen zwei Punkten gemessen.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Spannung braucht immer zwei Bezugspunkte.</p>
</div>
