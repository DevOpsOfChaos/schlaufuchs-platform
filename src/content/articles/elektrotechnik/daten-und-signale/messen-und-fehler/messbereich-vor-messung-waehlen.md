...
description: "Lerne messbereich vor messung wählen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
...
learningGoals:
  - "Du erklärst messbereich vor messung wählen in einem klaren Kontext."
...
**Messbereich vor Messung wählen** ist bewusst als kleines Unterthema angelegt. Lerne messbereich vor messung wählen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Multimeter soll eine unbekannte Spannung messen.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Der Messbereich schützt Gerät und Aussagequalität.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Mit irgendeinem Bereich wird einfach losgemessen.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Der Messbereich schützt Gerät und Aussagequalität.</span>
    </div>
  </div>
</div>
...
```text
Situation: Ein Multimeter soll eine unbekannte Spannung messen.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Der Messbereich schützt Gerät und Aussagequalität.</p>
</div>
