---
title: "Durchlassrichtung einer Diode prüfen"
description: "Lerne Durchlassrichtung einer Diode prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Durchlassrichtung einer Diode prüfen als enges Unterthema."
...
commonMistakes:
  - "Bauteilrichtung wird wie bei einem Widerstand ignoriert."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Durchlassrichtung einer Diode prüfen wird über eine kleine Trennkante verständlich."
...
**Durchlassrichtung einer Diode prüfen** ist bewusst als kleines Unterthema angelegt. Lerne Durchlassrichtung einer Diode prüfen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Eine Diode sperrt, obwohl sie scheinbar richtig eingebaut ist.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v113-durchlassrichtung-einer-diode-pruefen-v113.svg" alt="Lernillustration zu Durchlassrichtung einer Diode prüfen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Bauteilrichtung wird wie bei einem Widerstand ignoriert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Liegt die Anode positiver als die Kathode?</span></div>
  </div>
</div>
