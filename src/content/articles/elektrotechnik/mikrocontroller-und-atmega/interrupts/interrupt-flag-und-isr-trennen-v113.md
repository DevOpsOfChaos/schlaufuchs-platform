---
title: "Interrupt-Flag und ISR trennen"
description: "Lerne Interrupt-Flag und ISR trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe."
...
learningGoals:
  - "Du erklärst Interrupt-Flag und ISR trennen als enges Unterthema."
...
commonMistakes:
  - "Flag, Freigabe und globale Interrupts werden vermischt."
  - "Zu breit einordnen und dadurch die eigentliche Trennkante verlieren."
  - "Eine Lösung ohne Gegenprobe akzeptieren."
keyTakeaways:
  - "Interrupt-Flag und ISR trennen wird über eine kleine Trennkante verständlich."
...
**Interrupt-Flag und ISR trennen** ist bewusst als kleines Unterthema angelegt. Lerne Interrupt-Flag und ISR trennen als kleines, klar abgegrenztes Unterthema mit Prüffrage und Gegenprobe. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Ereignis wird ausgelöst, aber die ISR startet nicht.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v113-interrupt-flag-und-isr-trennen-v113.svg" alt="Lernillustration zu Interrupt-Flag und ISR trennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Flag, Freigabe und globale Interrupts werden vermischt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Sind Flag, Einzelmaske und globale Freigabe passend gesetzt?</span></div>
  </div>
</div>
