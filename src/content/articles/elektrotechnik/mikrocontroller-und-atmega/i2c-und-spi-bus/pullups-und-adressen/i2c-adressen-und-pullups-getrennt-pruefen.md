---
title: "Elektrotechnik – I²C-Adressen und Pull-ups getrennt prüfen"
description: "Lerne I²C-Fehlersuche als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
subject: "elektrotechnik"
section: "Kommunikation"
topicPath:
  - "mikrocontroller-und-atmega"
  - "i2c-und-spi-bus"
  - "pullups-und-adressen"
  - "i2c-adressen-und-pullups-getrennt-pruefen"
learningGoals:
  - "Du erklärst I²C-Fehlersuche in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "I²C-Fehlersuche wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**I²C-Fehlersuche** ist ein bewusst kleines Unterthema. Lerne I²C-Fehlersuche als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>I²C braucht passende Adressen und funktionierende Pull-ups; beide Fehler sehen im Code oft ähnlich aus.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotec-v108-i2c-adressen-und-pullups-getrennt-pruefen.svg" alt="Lernillustration zu I²C-Fehlersuche." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Adresse, Verdrahtung und Pull-ups einzeln prüfen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Adresse, Verdrahtung und Pull-ups einzeln prüfen.</span></div>
