---
title: "Elektrotechnik – Registername und Pinname trennen"
description: "Lerne registername und pinname trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie."
...
learningGoals:
  - "Du erklärst registername und pinname trennen in einem klaren Kontext."
...
commonMistakes:
  - "Alle Namen mit B werden gleich behandelt."
  - "Das Thema wird in einem breiten Sammelkapitel versteckt."
  - "Die Lösung nennt ein Ergebnis, aber keinen prüfbaren Weg."
keyTakeaways:
  - "Pinbezeichnung, Ausgangsregister und Eingangsregister haben verschiedene Rollen."
...
**Registername und Pinname trennen** ist bewusst als kleines Unterthema angelegt. Lerne registername und pinname trennen als kleines Unterthema mit Beispiel, Abgrenzung und Prüfstrategie. Dadurch bleibt die Seite auffindbar und landet nicht in einem übergroßen Sammelbereich.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>PB0, PORTB und PINB tauchen im gleichen Code auf.</h3>
...
<div class="figure-card">
  ...
  <div class="step-grid">
    ...
    <div class="step-item"><strong>3. Trennkante prüfen</strong><span>Pinbezeichnung, Ausgangsregister und Eingangsregister haben verschiedene Rollen.</span></div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item">
      ...
      <span>Alle Namen mit B werden gleich behandelt.</span>
    </div>
    <div class="compare-item">
      <strong>Saubere Lesart</strong>
      <span>Pinbezeichnung, Ausgangsregister und Eingangsregister haben verschiedene Rollen.</span>
    </div>
  </div>
</div>
...
```text
Situation: PB0, PORTB und PINB tauchen im gleichen Code auf.
...
<div class="note-panel">
  <p><strong>Merke:</strong> Pinbezeichnung, Ausgangsregister und Eingangsregister haben verschiedene Rollen.</p>
</div>
