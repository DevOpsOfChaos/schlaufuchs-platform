---
title: "Elektrotechnik – Compare Match und Overflow unterscheiden"
description: "Lerne Timer-Ereignisse als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Timer-Ereignisse als enges Unterthema."
...
commonMistakes:
  - "Jedes Timerereignis wird als Überlauf bezeichnet."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Timer-Ereignisse wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Timer-Ereignisse** ist bewusst als kleines Unterthema angelegt. Lerne Timer-Ereignisse als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Timer löst bei bestimmtem Wert oder am Ende des Bereichs aus.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-compare-match-und-overflow-unterscheiden.svg" alt="Lernillustration zu Timer-Ereignisse." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jedes Timerereignis wird als Überlauf bezeichnet.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob ein Vergleichswert oder der Maximalwert erreicht wird.</span></div>
  </div>
</div>
