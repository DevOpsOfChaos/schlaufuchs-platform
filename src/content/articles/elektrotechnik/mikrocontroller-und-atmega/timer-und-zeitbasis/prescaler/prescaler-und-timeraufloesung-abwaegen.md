---
title: "Elektrotechnik – Prescaler und Timerauflösung abwägen"
description: "Lerne Timer-Prescaler als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Timer-Prescaler als enges Unterthema."
...
commonMistakes:
  - "Größerer Prescaler wird nur als einfache Verlängerung gesehen."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Timer-Prescaler wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Timer-Prescaler** ist bewusst als kleines Unterthema angelegt. Lerne Timer-Prescaler als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Timer soll lange messen und trotzdem fein auflösen.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-prescaler-und-timeraufloesung-abwaegen.svg" alt="Lernillustration zu Timer-Prescaler." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Größerer Prescaler wird nur als einfache Verlängerung gesehen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Vergleiche Überlaufzeit und Schrittweite gemeinsam.</span></div>
  </div>
</div>
