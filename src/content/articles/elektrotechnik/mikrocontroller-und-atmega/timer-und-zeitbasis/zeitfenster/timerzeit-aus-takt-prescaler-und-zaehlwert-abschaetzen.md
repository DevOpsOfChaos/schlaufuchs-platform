---
title: "Elektrotechnik – Timerzeit aus Takt, Prescaler und Zählwert abschätzen"
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v107-timerzeit-aus-takt-prescaler-und-zaehlwert-a.svg" alt="Lernillustration zu Timerabschätzung." style="width:100%; max-width:52rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
