---
title: "Elektrotechnik – Open-Drain-Ausgang nicht als normalen High-Treiber lesen"
description: "Lerne Open Drain als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Open Drain als enges Unterthema."
...
**Open Drain** ist bewusst als kleines Unterthema angelegt. Lerne Open Drain als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Ausgang kann aktiv Low ziehen, aber nicht aktiv High treiben.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-open-drain-ausgang-nicht-als-normalen-high-treiber-lesen.svg" alt="Lernillustration zu Open Drain." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>High wird als aktiv getriebener Zustand verstanden.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Prüfe, ob ein Pull-up den High-Zustand erzeugt.</span></div>
  </div>
</div>
