---
title: "Elektrotechnik – Pull-up und Pull-down nach Ruhezustand wählen"
description: "Lerne Pull-up und Pull-down als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Pull-up und Pull-down als enges Unterthema."
...
commonMistakes:
  - "Der Widerstand wird nur als Zusatzbauteil gesehen."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Pull-up und Pull-down wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Pull-up und Pull-down** ist bewusst als kleines Unterthema angelegt. Lerne Pull-up und Pull-down als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Taster soll im Ruhezustand einen definierten Pegel liefern.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-pull-up-und-pull-down-nach-ruhezustand-waehlen.svg" alt="Lernillustration zu Pull-up und Pull-down." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Widerstand wird nur als Zusatzbauteil gesehen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Lege zuerst fest, welcher Pegel ohne Tastendruck gelten soll.</span></div>
  </div>
</div>
