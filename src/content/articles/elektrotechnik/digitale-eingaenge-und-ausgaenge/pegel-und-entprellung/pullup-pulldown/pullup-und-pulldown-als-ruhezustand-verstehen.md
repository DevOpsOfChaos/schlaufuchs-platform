---
title: "Elektrotechnik – Pull-up und Pull-down als Ruhezustand verstehen"
description: "Lerne Pull-up und Pull-down als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Pull-up und Pull-down in einem klar abgegrenzten Kontext."
...
keyTakeaways:
  - "Pull-up und Pull-down wird durch Einordnung, Abgrenzung und Gegenprobe prüfbar."
...
**Pull-up und Pull-down** ist ein bewusst kleines Unterthema. Lerne Pull-up und Pull-down als klar abgegrenztes Unterthema mit Beispiel, Prüfschritt und Gegenprobe. Der Punkt wird schnell unübersichtlich, wenn er nur in einem breiten Sammelbereich landet.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Pull-up und Pull-down definieren, was ein Eingang ohne aktives Signal liest.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotec-v108-pullup-und-pulldown-als-ruhezustand-verstehen.svg" alt="Lernillustration zu Pull-up und Pull-down." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    ...
    <div class="compare-item">
      ...
      <span>Ruhezustand und Ereignis getrennt lesen.</span>
    </div>
  </div>
</div>
...
<div class="step-grid">
  ...
  <div class="step-item"><strong>3. Gegenprobe bauen</strong><span>Ruhezustand und Ereignis getrennt lesen.</span></div>
