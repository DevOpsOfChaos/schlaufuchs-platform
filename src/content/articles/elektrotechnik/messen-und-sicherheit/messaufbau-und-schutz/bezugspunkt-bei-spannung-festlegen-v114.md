---
title: Bezugspunkt bei Spannung festlegen
description: Spannung immer zwischen zwei Punkten lesen
...
learningGoals:
- Du erklärst Bezugspunkt bei Spannung festlegen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Eine Spannung wird wie ein absoluter Punktwert behandelt.
...
keyTakeaways:
- Bezugspunkt bei Spannung festlegen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Bezugspunkt bei Spannung festlegen** ist bewusst als kleines Unterthema angelegt. Spannung immer zwischen zwei Punkten lesen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Signal wird gegen Masse gemessen.</h3>
  <p>Die wichtige Frage lautet: <strong>Zwischen welchen Punkten misst das Gerät?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-bezugspunkt-bei-spannung-festlegen-v114.svg" alt="Lernillustration zu Bezugspunkt bei Spannung festlegen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Eine Spannung wird wie ein absoluter Punktwert behandelt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Zwischen welchen Punkten misst das Gerät?</span></div>
  </div>
</div>
