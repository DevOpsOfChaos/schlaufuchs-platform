---
title: Thermischen Fehler beobachten
description: Temperatur als Diagnosegröße nutzen
...
learningGoals:
- Du erklärst Thermischen Fehler beobachten als klar abgegrenztes Unterthema.
...
commonMistakes:
- Der erste Kaltstart gilt als Beweis.
...
keyTakeaways:
- Thermischen Fehler beobachten wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Thermischen Fehler beobachten** ist bewusst als kleines Unterthema angelegt. Temperatur als Diagnosegröße nutzen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Bauteil funktioniert nach einigen Minuten nicht mehr.</h3>
  <p>Die wichtige Frage lautet: <strong>Verändert Wärme das Fehlerbild reproduzierbar?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-thermischen-fehler-beobachten-v114.svg" alt="Lernillustration zu Thermischen Fehler beobachten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der erste Kaltstart gilt als Beweis.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Verändert Wärme das Fehlerbild reproduzierbar?</span></div>
  </div>
</div>
