---
title: Kurzschlusszeichen erkennen
description: Spannungseinbruch und Strombegrenzung zusammen lesen
...
learningGoals:
- Du erklärst Kurzschlusszeichen erkennen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Der Fehler wird in der Software gesucht.
...
keyTakeaways:
- Kurzschlusszeichen erkennen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Kurzschlusszeichen erkennen** ist bewusst als kleines Unterthema angelegt. Spannungseinbruch und Strombegrenzung zusammen lesen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Netzteil geht sofort in Strombegrenzung.</h3>
  <p>Die wichtige Frage lautet: <strong>Fällt die Versorgung unter Last zusammen?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-kurzschlusszeichen-erkennen-v114.svg" alt="Lernillustration zu Kurzschlusszeichen erkennen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Fehler wird in der Software gesucht.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Fällt die Versorgung unter Last zusammen?</span></div>
  </div>
</div>
