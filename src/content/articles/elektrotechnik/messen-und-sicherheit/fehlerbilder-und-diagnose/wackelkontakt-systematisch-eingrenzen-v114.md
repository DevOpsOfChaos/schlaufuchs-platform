---
title: Wackelkontakt systematisch eingrenzen
description: Mechanische Fehler elektrisch prüfen
...
learningGoals:
- Du erklärst Wackelkontakt systematisch eingrenzen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Wackelkontakt systematisch eingrenzen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Wackelkontakt systematisch eingrenzen** ist bewusst als kleines Unterthema angelegt. Mechanische Fehler elektrisch prüfen. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Sensor fällt nur bei Bewegung aus.</h3>
  <p>Die wichtige Frage lautet: <strong>Ändert sich das Signal beim Bewegen der Leitung?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-wackelkontakt-systematisch-eingrenzen-v114.svg" alt="Lernillustration zu Wackelkontakt systematisch eingrenzen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur der Code wird geändert.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Ändert sich das Signal beim Bewegen der Leitung?</span></div>
  </div>
</div>
