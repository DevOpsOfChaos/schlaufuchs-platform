...
<div class="example-card">
  ...
  <h3>Ein Widerstandsteiler liefert einen unerwarteten Wert.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Größenordnung wäre plausibel?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-messwert-plausibilisieren-v114.svg" alt="Lernillustration zu Messwert plausibilisieren." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Der Messwert wird ohne Schätzung übernommen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Größenordnung wäre plausibel?</span></div>
  </div>
</div>
