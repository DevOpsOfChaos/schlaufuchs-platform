---
title: "Elektrotechnik – Flanke und Pegel in Digitalschaltungen trennen"
description: "Lerne Flanke und Pegel als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe."
...
learningGoals:
  - "Du erklärst Flanke und Pegel als enges Unterthema."
...
commonMistakes:
  - "High-Pegel und steigende Flanke werden gleichgesetzt."
  - "Das Thema in einem breiten Sammelkapitel verschwinden lassen."
  - "Eine Lösung ohne konkreten Prüfschritt formulieren."
keyTakeaways:
  - "Flanke und Pegel wird durch Kontext, Abgrenzung und Prüfung klar."
...
**Flanke und Pegel** ist bewusst als kleines Unterthema angelegt. Lerne Flanke und Pegel als kleines, klar auffindbares Unterthema mit Abgrenzung, Prüfschritt und Gegenprobe. So bleibt die Lernseite auffindbar, ohne noch mehr Inhalt in ein übergroßes Sammelthema zu schieben.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Eingang reagiert nur beim Wechsel, nicht beim Halten.</h3>
...
<div class="figure-card">
  ...
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v111-flanke-und-pegel-in-digitalschaltungen-trennen.svg" alt="Lernillustration zu Flanke und Pegel." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>High-Pegel und steigende Flanke werden gleichgesetzt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Frage, ob Zustand oder Übergang ausgewertet wird.</span></div>
  </div>
</div>
