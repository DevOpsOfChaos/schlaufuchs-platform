---
title: Sleep-Modus passend wählen
description: Energiesparen und Aufwachquelle verbinden
...
learningGoals:
- Du erklärst Sleep-Modus passend wählen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Sleep wird aktiviert, ohne Wake-up zu planen.
...
keyTakeaways:
- Sleep-Modus passend wählen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Sleep-Modus passend wählen** ist bewusst als kleines Unterthema angelegt. Energiesparen und Aufwachquelle verbinden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Sensor soll nur selten messen.</h3>
  <p>Die wichtige Frage lautet: <strong>Welches Ereignis darf den Controller wecken?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-sleep-modus-passend-waehlen-v114.svg" alt="Lernillustration zu Sleep-Modus passend wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Sleep wird aktiviert, ohne Wake-up zu planen.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welches Ereignis darf den Controller wecken?</span></div>
  </div>
</div>
