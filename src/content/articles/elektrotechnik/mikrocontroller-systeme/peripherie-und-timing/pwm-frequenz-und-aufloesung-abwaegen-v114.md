---
title: PWM-Frequenz und Auflösung abwägen
description: Tastgrad nicht isoliert betrachten
subject: elektrotechnik
section: Feinstruktur Elektrotechnik
topicPath:
- mikrocontroller-systeme
- peripherie-und-timing
- pwm-frequenz-und-aufloesung-abwaegen-v114
learningGoals:
- Du erklärst PWM-Frequenz und Auflösung abwägen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Maximale Auflösung wird ohne Frequenzfolge gewählt.
...
keyTakeaways:
- PWM-Frequenz und Auflösung abwägen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**PWM-Frequenz und Auflösung abwägen** ist bewusst als kleines Unterthema angelegt. Tastgrad nicht isoliert betrachten. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Motor soll leise und fein regelbar laufen.</h3>
  <p>Die wichtige Frage lautet: <strong>Welche Frequenz und welche Schrittweite sind nötig?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-pwm-frequenz-und-aufloesung-abwaegen-v114.svg" alt="Lernillustration zu PWM-Frequenz und Auflösung abwägen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Maximale Auflösung wird ohne Frequenzfolge gewählt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welche Frequenz und welche Schrittweite sind nötig?</span></div>
  </div>
</div>
