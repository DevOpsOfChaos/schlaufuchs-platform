---
title: Timerquelle bewusst wählen
description: Interner Takt und externer Takt unterscheiden
...
learningGoals:
- Du erklärst Timerquelle bewusst wählen als klar abgegrenztes Unterthema.
...
commonMistakes:
- Jede Zeitmessung nutzt automatisch den Systemtakt.
...
keyTakeaways:
- Timerquelle bewusst wählen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Timerquelle bewusst wählen** ist bewusst als kleines Unterthema angelegt. Interner Takt und externer Takt unterscheiden. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein Zähler soll Ereignisse zählen.</h3>
  <p>Die wichtige Frage lautet: <strong>Kommt der Takt aus dem Controller oder von außen?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-timerquelle-bewusst-waehlen-v114.svg" alt="Lernillustration zu Timerquelle bewusst wählen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jede Zeitmessung nutzt automatisch den Systemtakt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Kommt der Takt aus dem Controller oder von außen?</span></div>
  </div>
</div>
