---
title: Interruptquelle eindeutig zuordnen
description: ISR-Auslösung nicht raten
subject: elektrotechnik
section: Feinstruktur Elektrotechnik
topicPath:
- mikrocontroller-systeme
- peripherie-und-timing
- interruptquelle-eindeutig-zuordnen-v114
learningGoals:
- Du erklärst Interruptquelle eindeutig zuordnen als klar abgegrenztes Unterthema.
...
keyTakeaways:
- Interruptquelle eindeutig zuordnen wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**Interruptquelle eindeutig zuordnen** ist bewusst als kleines Unterthema angelegt. ISR-Auslösung nicht raten. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Mehrere Interrupts sind aktiv.</h3>
  <p>Die wichtige Frage lautet: <strong>Welches Flag zeigt die tatsächliche Quelle?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-interruptquelle-eindeutig-zuordnen-v114.svg" alt="Lernillustration zu Interruptquelle eindeutig zuordnen." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Jede ISR wird verdächtigt.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Welches Flag zeigt die tatsächliche Quelle?</span></div>
  </div>
</div>
