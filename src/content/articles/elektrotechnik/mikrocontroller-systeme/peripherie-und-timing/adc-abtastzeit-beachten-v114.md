---
title: ADC-Abtastzeit beachten
description: Signalquelle und Sample-Zeit zusammen denken
...
learningGoals:
- Du erklärst ADC-Abtastzeit beachten als klar abgegrenztes Unterthema.
...
commonMistakes:
- Nur die Bitauflösung wird geprüft.
...
keyTakeaways:
- ADC-Abtastzeit beachten wird verständlich, wenn du die kleine Entscheidung im Beispiel sauber benennst.
...
**ADC-Abtastzeit beachten** ist bewusst als kleines Unterthema angelegt. Signalquelle und Sample-Zeit zusammen denken. Dadurch bleibt die Seite auffindbar und vermischt sich nicht mit einem übergroßen Sammelkapitel.

<div class="example-card">
  <p class="card-kicker">Leitbeispiel</p>
  <h3>Ein hochohmiger Sensor liefert schwankende ADC-Werte.</h3>
  <p>Die wichtige Frage lautet: <strong>Hat der ADC-Eingang genug Zeit zum Laden?</strong></p>
</div>

<div class="figure-card">
  <p class="card-kicker">Lernbild</p>
  <h3>Vom Kontext zur Gegenprobe</h3>
  <img class="content-illustration" src="/schlaufuchs-platform/illustrations/elektrotechnik-v114-adc-abtastzeit-beachten-v114.svg" alt="Lernillustration zu ADC-Abtastzeit beachten." style="width:100%; max-width:54rem; border-radius:18px; border:1px solid var(--border); background:#f8fafc;" />
</div>
...
<div class="compare-card">
  ...
  <div class="compare-grid">
    <div class="compare-item"><strong>Häufiger Fehler</strong><span>Nur die Bitauflösung wird geprüft.</span></div>
    <div class="compare-item"><strong>Prüffrage</strong><span>Hat der ADC-Eingang genug Zeit zum Laden?</span></div>
  </div>
</div>
