...
`(int)3.14` macht aus dem Wert bewusst einen Integer. Der Nachkommateil wird dabei nicht als Fließkommawert beibehalten.

## Aufgabe 2

Ein expliziter Cast macht im Code sichtbar, welche Typform beabsichtigt ist. Das ist oft lesbarer als eine still vom Kontext abhängige Umdeutung.
