---
title: "Lösung: Tests als Sicherheitsnetz – Aufgabe B"
description: "Musterlösung zu Tests als Sicherheitsnetz, Aufgabe B."
subject: "informatik"
section: "softwarequalitaet"
topicPath: ["softwarequalitaet", "tests"]
taskId: "INF-V200-TESTS_ALS_SICHERHEITSNETZ-B"
relatedExercise: "informatik/sanierung-v200-architektur-datenpraxis/tests-als-sicherheitsnetz-aufgabe-b"
...
Bei **Tests als Sicherheitsnetz** ist die wichtigste Leistung nicht eine schnelle Implementierung, sondern eine Struktur, die verständlich, prüfbar und änderbar bleibt.
