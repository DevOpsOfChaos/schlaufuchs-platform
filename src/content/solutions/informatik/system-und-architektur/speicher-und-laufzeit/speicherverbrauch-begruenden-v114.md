...
Im Szenario geht es um **Speicherverbrauch begründen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welche Daten liegen gleichzeitig im Speicher?

### 2. Begründung

Ein Programm erzeugt mehrere Zwischenlisten. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Jede Kopie wird als kostenlos angenommen.
