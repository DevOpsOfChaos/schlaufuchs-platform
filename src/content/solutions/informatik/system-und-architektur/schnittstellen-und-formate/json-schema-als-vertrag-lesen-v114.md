...
Im Szenario geht es um **JSON-Schema als Vertrag lesen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welche Felder sind garantiert vorhanden?

### 2. Begründung

Eine API liefert Nutzerdaten. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Felder werden ohne Pflicht- und Optionalregeln genutzt.
