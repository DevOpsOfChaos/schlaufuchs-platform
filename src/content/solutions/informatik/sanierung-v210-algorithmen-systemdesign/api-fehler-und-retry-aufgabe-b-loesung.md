---
title: "Lösung: API-Fehler und Retry – Entwurfsaufgabe B"
description: "Musterlösung zur Entwurfsaufgabe B zu API-Fehler und Retry."
subject: "informatik"
section: "web-systeme"
topicPath: ["web-systeme", "api-fehler-und-retry"]
taskId: "INF-V210-073-B"
relatedExercise: "informatik/sanierung-v210-algorithmen-systemdesign/api-fehler-und-retry-aufgabe-b"
tags: ["informatik", "web-systeme", "api-fehler-und-retry", "systemdesign", "v210", "loesung"]
draft: false
---
## Musterlösung

Eine sinnvolle Verbesserung zu **API-Fehler und Retry** macht sichtbar, wo die bisherige Lösung unklar ist und wie sie prüfbarer wird.
