...
Im Szenario geht es um **Loglevel bewusst filtern**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welche Meldungsstufe passt zur Frage?

### 2. Begründung

Ein Dienst meldet viele Hinweise. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Jede Warnung wird gleich kritisch behandelt.
