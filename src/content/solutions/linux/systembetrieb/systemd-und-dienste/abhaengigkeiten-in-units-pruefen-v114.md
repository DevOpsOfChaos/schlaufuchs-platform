...
Im Szenario geht es um **Abhängigkeiten in Units prüfen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Geht es um Reihenfolge oder harte Abhängigkeit?

### 2. Begründung

Ein Dienst braucht Netzwerkzugang. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: After und Requires werden verwechselt.
