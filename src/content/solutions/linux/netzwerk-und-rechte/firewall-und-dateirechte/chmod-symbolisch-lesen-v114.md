...
Im Szenario geht es um **chmod symbolisch lesen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welche Nutzerklasse braucht welches Recht?

### 2. Begründung

Nur die Gruppe soll Schreibrechte bekommen. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: chmod 777 wird als schnelle Lösung genutzt.
