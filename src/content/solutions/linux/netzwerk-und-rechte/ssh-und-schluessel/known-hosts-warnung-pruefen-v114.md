...
Im Szenario geht es um **Known-Hosts-Warnung prüfen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Hat sich der Server wirklich geändert?

### 2. Begründung

SSH warnt vor geändertem Host-Key. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Die Warnung wird blind entfernt.
