...
Im Szenario geht es um **Pipeline-Fehler erkennen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welcher Teil der Pipeline darf fehlschlagen?

### 2. Begründung

Ein frühes Kommando scheitert, spätere laufen weiter. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Nur der letzte Exit-Code wird geprüft.
