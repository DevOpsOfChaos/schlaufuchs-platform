...
Im Szenario geht es um **xargs mit Leerzeichen absichern**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Wird nullgetrennte Übergabe gebraucht?

### 2. Begründung

Dateien enthalten Leerzeichen im Namen. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: xargs trennt ungewollt am Leerzeichen.
