...
Im Szenario geht es um **Temporäre Dateien sicher nutzen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Ist der temporäre Name eindeutig und wird er gelöscht?

### 2. Begründung

Ein Skript speichert Zwischenergebnisse. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Immer derselbe Dateiname in /tmp wird genutzt.
