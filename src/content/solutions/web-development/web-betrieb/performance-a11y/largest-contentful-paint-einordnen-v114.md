...
Im Szenario geht es um **Largest Contentful Paint einordnen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welches sichtbare Element bestimmt den ersten Eindruck?

### 2. Begründung

Ein großes Hero-Bild lädt spät. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Nur die Gesamtdateigröße wird betrachtet.
