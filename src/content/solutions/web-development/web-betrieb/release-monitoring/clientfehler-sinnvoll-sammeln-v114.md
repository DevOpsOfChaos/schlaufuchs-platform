...
Im Szenario geht es um **Clientfehler sinnvoll sammeln**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welche Information braucht die Diagnose?

### 2. Begründung

Nutzer melden gelegentliche weiße Seiten. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Fehler bleiben nur in lokaler Konsole.
