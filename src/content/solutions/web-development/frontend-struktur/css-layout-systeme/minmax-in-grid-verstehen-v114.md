...
Im Szenario geht es um **Minmax in Grid verstehen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welche Mindestbreite ist noch lesbar?

### 2. Begründung

Karten sollen weder zu schmal noch leer verteilt sein. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Feste Pixelbreiten brechen mobil.
