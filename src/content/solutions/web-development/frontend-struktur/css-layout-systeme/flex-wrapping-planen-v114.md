...
Im Szenario geht es um **Flex-Wrapping planen**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Was passiert, wenn kein Platz mehr da ist?

### 2. Begründung

Karten sollen auf kleinen Bildschirmen umbrechen. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Nur Desktopbreite wird geprüft.
