---
title: "Lösung: End-to-End-Tests begrenzen – Aufgabe B"
description: "Musterlösung zu End-to-End-Tests begrenzen mit Schwerpunkt Webprojekt-Praxis."
subject: "web-development"
section: "qualitaet"
topicPath: ["qualitaet-und-zugaenglichkeit", "e2e-tests"]
taskId: "WEB-V204-END_TO_END_TESTS_BEGRENZEN-B"
relatedExercise: "web-development/sanierung-v204-projektpraxis-build-qa/end-to-end-tests-begrenzen-aufgabe-b"
...
- **Zweck:** End-to-End-Tests sind wertvoll, aber teuer und sollten gezielt eingesetzt werden.
...
Die Lösung ist gut, wenn Zweck, Zuständigkeit, Fehlerfall und Kontrolle klar erkennbar sind. Dadurch bleibt end-to-end-tests begrenzen nicht nur eine Einzelmaßnahme, sondern Teil einer stabilen Projektpraxis.
