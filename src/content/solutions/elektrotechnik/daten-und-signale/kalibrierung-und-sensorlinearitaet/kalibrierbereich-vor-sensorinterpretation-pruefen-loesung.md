...
Bei dieser Aufgabe ist eine gute Antwort, dass **begründe, warum ein Messwert außerhalb des Kalibrierbereichs kritisch ist.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: ADC-Werte direkt als physikalische Größe zu lesen. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
