...
Bei dieser Aufgabe ist eine gute Antwort, dass **erkläre, warum ein Ausgang bei verrauschtem Signal ständig wechseln kann.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: Nur einen einzigen Schwellwert zu verwenden, obwohl das Signal rauscht. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
