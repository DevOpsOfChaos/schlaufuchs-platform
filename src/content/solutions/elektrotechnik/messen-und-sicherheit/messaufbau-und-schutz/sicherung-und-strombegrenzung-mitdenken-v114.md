...
Im Szenario geht es um **Sicherung und Strombegrenzung mitdenken**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Welcher Maximalstrom ist noch ungefährlich?

### 2. Begründung

Ein Labornetzteil treibt eine Testschaltung. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Die Strombegrenzung wird offen gelassen.
