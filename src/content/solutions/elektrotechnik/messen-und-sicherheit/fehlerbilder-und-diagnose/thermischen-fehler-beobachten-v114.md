...
Im Szenario geht es um **Thermischen Fehler beobachten**. Die Entscheidung darf nicht im breiten Kapitel hängen bleiben, sondern muss an der konkreten Situation festgemacht werden:

> Verändert Wärme das Fehlerbild reproduzierbar?

### 2. Begründung

Ein Bauteil funktioniert nach einigen Minuten nicht mehr. Daraus folgt: Die Situation muss zuerst über Kontext und Rolle der beteiligten Größen gelesen werden. Der häufige Fehler wäre: Der erste Kaltstart gilt als Beweis.
