...
Bei dieser Aufgabe ist eine gute Antwort, dass **prüfe, welche Angaben zwischen realem Aufbau und Schaltplan übereinstimmen müssen.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: Aufbauten zu ändern, ohne den Schaltplan mitzuziehen. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
