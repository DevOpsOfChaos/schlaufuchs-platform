...
Bei dieser Aufgabe ist eine gute Antwort, dass **formuliere eine Messnotiz so, dass sie später nachvollziehbar bleibt.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?
