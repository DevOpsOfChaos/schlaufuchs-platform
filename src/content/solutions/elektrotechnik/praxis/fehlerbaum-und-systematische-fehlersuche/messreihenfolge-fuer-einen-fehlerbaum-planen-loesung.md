...
Bei dieser Aufgabe ist eine gute Antwort, dass **plane eine ruhige Reihenfolge, um einen unklaren Schaltungsfehler einzugrenzen.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: Symptome sofort als Ursache zu behandeln. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
