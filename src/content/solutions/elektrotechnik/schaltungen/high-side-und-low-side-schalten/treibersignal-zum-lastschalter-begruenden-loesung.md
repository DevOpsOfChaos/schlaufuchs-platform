...
Bei dieser Aufgabe ist eine gute Antwort, dass **begründe, warum ein Lastschalter nicht nur nach Ausgangspegel beurteilt werden darf.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: Nur das Schaltsymbol zu betrachten und den Bezugspunkt zu ignorieren. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
