...
Bei dieser Aufgabe ist eine gute Antwort, dass **erkläre, warum der High-Pegel nicht aktiv vom Ausgang getrieben wird.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: Open-Drain wie einen normalen High-Treiber zu lesen. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
