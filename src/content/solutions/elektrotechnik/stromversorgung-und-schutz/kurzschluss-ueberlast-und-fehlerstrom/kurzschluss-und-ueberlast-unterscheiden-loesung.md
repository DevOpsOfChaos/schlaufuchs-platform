...
Bei dieser Aufgabe ist eine gute Antwort, dass **ordne Fehlerfälle danach ein, ob eher Kurzschluss oder Überlast vorliegt.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: Jeden hohen Strom als Kurzschluss zu bezeichnen. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
