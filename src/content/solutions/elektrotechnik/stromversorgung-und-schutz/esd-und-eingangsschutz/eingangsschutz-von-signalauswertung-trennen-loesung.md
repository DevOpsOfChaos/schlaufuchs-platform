...
Bei dieser Aufgabe ist eine gute Antwort, dass **trenne Schutzfunktion und normale Signalinterpretation fachlich sauber.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: ESD als seltenes Laborproblem abzutun. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
