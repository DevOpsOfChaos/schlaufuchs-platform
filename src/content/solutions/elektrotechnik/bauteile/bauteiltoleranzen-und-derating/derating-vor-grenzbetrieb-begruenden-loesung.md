...
Bei dieser Aufgabe ist eine gute Antwort, dass **erkläre, warum Bauteile nicht dauerhaft am Maximalwert betrieben werden sollten.** nicht isoliert bewertet wird. Zuerst wird der Normalzustand beschrieben: Welche Verbindung, welcher Pegel, welcher Strompfad oder welcher Messwert wäre plausibel?

Danach wird der Fehlerfall abgegrenzt. Ein typischer Irrtum wäre: Datenblattgrenzen als normalen Betriebswert zu nutzen. Deshalb sollte die Erklärung immer den Zusammenhang aus Schaltung, Messung und technischer Rolle nennen.
