---
title: "Lösung: Glättung und Mittelwert: Aufgabe A"
description: "Musterlösung zur Aufgabe daten-und-signale-v195-020a im Daten-und-Signale-Block v195."
subject: "daten-und-signale"
section: "signalverarbeitung-und-uebertragung"
topicPath: ["sanierung-v195", "glattung-und-mittelwert-loesung-a"]
taskId: "daten-und-signale-v195-020a"
relatedExercise: "daten-und-signale/sanierung-v195/glattung-und-mittelwert-aufgabe-a"
tags: ["daten-und-signale", "signalverarbeitung-und-uebertragung", "loesung"]
draft: false
---
## Musterlösung zu `daten-und-signale-v195-020a`

Ausgangsauftrag: Vergleiche zwei Glättungsfenster für Temperaturdaten.
...
Eine gute Antwort zu Glättung und Mittelwert sagt nicht nur, **was** gemessen oder übertragen wird, sondern auch, **wie sicher** diese Aussage unter den gegebenen Bedingungen ist.
