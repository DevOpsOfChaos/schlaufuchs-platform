---
title: "Lösung: Dashboard-Lesbarkeit prüfen – Aufgabe B"
description: "Musterlösung zu dashboard-lesbarkeit prüfen mit klarem Prüfweg."
subject: "daten-und-signale"
section: "betrieb"
topicPath: ["auswertung-und-betrieb", "visualisierung", "dashboard-lesbarkeit"]
taskId: "DS-V202-DASHBOARD-LESBARKEIT-B"
relatedExercise: "daten-und-signale/sanierung-v202-datenqualitaet-netze/dashboard-lesbarkeit-aufgabe-b"
tags: ["daten-und-signale", "betrieb", "v202", "loesung"]
draft: false
---
## Musterlösung

Ein sauberer Ansatz zu **Dashboard-Lesbarkeit prüfen** beginnt nicht mit einer spontanen Bewertung des Werts, sondern mit der Datenstrecke.
...
Ein Dashboard soll Entscheidungen unterstützen, nicht nur Werte sammeln. Deshalb reicht es nicht, nur den Endwert zu betrachten. Wichtig ist, welche Annahmen unterwegs gelten und wo ein Fehlerbild entstehen kann.
