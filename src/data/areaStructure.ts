...
const areaNodesBySubject: Record<PrimarySubjectSlug, AreaNodeDefinition[]> = {
  mathematik: [
    ...
    { slug: "grundlagen", title: "Grundlagen", description: "Zahlen, Anteile, Einheiten und Größen als sauber getrennte Einstiegsthemen.", icon: iconMap.numbers, chips: ["Zahlen", "Einheiten", "Anteile"], prefixes: [["grundlagen"]], children: [
      { slug: "prozent-und-wachstum", title: "Prozent und Wachstum", description: "Prozentsatz, Prozentpunkte und Wachstumsfaktor bewusst trennen.", icon: iconMap.numbers, chips: ["Prozent", "Faktor"], prefixes: [["grundlagen", "prozent-und-wachstum"], ["wachstumsfaktor"]] },
    ...
    { slug: "komplexe-zahlen", title: "Komplexe Zahlen", description: "Kartesische Form, Betrag, Argument und Polarform als zusammenhängender Zahlenbereich.", icon: iconMap.numbers, chips: ["Zahlen", "Polarform", "Argument"], prefixes: [["komplexe-zahlen"]] },
    ...
    { slug: "funktionen", title: "Funktionen", description: "Funktionen werden nach Modellierung, Graph, Änderung und Prüfung gegliedert.", icon: iconMap.graph, chips: ["Graphen", "Modelle", "Änderung"], prefixes: [["funktionen"]], children: [
      ...
      { slug: "exponentialfunktionen", title: "Exponentialfunktionen", description: "Wachstumsfaktor, Verdopplungszeit, Logarithmen und Modellgrenzen zusammenhängend prüfen.", icon: iconMap.graph, chips: ["Wachstum", "Faktor"], prefixes: [["funktionen", "exponentialfunktionen"], ["exponentialfunktionen"], ["wachstumsmodelle"], ["begrenztes-wachstum"]] },
      { slug: "logarithmen", title: "Logarithmen", description: "Logarithmen als Umkehroperation zu Potenzen und als Werkzeug für Zeitfragen in Wachstumsmodellen.", icon: iconMap.numbers, chips: ["Logarithmus", "Exponenten"], prefixes: [["logarithmen"], ["logarithmusgesetze"], ["exponentialgleichungen"]] },
    ] },
  ...
  linux: [
    ...
    { slug: "rechte-benutzer-und-sicherheit", title: "Rechte, Benutzer und Sicherheit", description: "Dateirechte, Besitzer und Gruppen werden als konkrete Zugriffsspur gelesen.", icon: iconMap.shield, chips: ["Grundlagen"], prefixes: [["dateisystem-und-rechte", "dateirechte-und-besitz"], ["benutzer-und-gruppen"], ["benutzer-und-sicherheit", "benutzer-gruppen-und-sudo"], ["rechte-und-sicherheit-v115", "dateirechte-und-besitz"], ["system", "dateirechte"], ["system", "dateirechte-und-besitz"], ["system", "benutzer-und-gruppen"]], children: [
      { slug: "dateirechte-und-besitz", title: "Dateirechte und Besitz", description: "Rechtebits, Besitzer, Gruppe, chmod und chown gemeinsam lesen.", icon: iconMap.shield, chips: ["Dateirechte", "Besitz"], prefixes: [["dateisystem-und-rechte", "dateirechte-und-besitz"], ["rechte-und-sicherheit-v115", "dateirechte-und-besitz"], ["system", "dateirechte"], ["system", "dateirechte-und-besitz"]] },
      { slug: "benutzer-und-gruppen", title: "Benutzer und Gruppen", description: "UID, GID, Gruppenmitgliedschaften und Benutzerkontext einordnen.", icon: iconMap.shield, chips: ["Benutzer", "Gruppen"], prefixes: [["benutzer-und-gruppen"], ["benutzer-und-sicherheit", "benutzer-gruppen-und-sudo"], ["system", "benutzer-und-gruppen"]] },
      { slug: "sudo-und-minimalrechte", title: "sudo und Minimalrechte", description: "Erhöhte Rechte gezielt einsetzen statt Besitz- oder Rechtefehler zu verdecken.", icon: iconMap.shield, chips: ["sudo", "Minimalrechte"], prefixes: [["system", "rechte-und-besitz"], ["rechte-und-zugriff", "besitz-rechte-sudo", "sudo"]] }
    ] },
    ...
    { slug: "automatisierung-und-skripte", title: "Automatisierung und Skripte", description: "Skripte werden über Parameter, Fehlerbehandlung und Wiederholbarkeit stabil gemacht.", icon: iconMap.terminal, chips: ["Grundlagen"], prefixes: [["automatisierung-und-skripte"]], children: [
      { slug: "shellskripte", title: "Shellskripte", description: "Wiederholbare Abläufe, Pfade und Bestätigungsschritte kontrolliert skripten.", icon: iconMap.terminal, chips: ["Skripte", "rsync"], prefixes: [["automatisierung-und-skripte", "shellskripte"]] },
      { slug: "fehlerbehandlung-in-skripten", title: "Fehlerbehandlung in Skripten", description: "Abbrüche, Exitcodes und sichtbare Fehlermeldungen bewusst einplanen.", icon: iconMap.terminal, chips: ["Exitcode", "Prüfung"], prefixes: [["automatisierung-und-skripte", "fehlerbehandlung-in-skripten"]] },
      { slug: "umgebungsvariablen-und-path", title: "Umgebungsvariablen und PATH", description: "Skriptumgebung, Suchpfade und Startkontext sauber trennen.", icon: iconMap.terminal, chips: ["PATH", "Kontext"], prefixes: [["automatisierung-und-skripte", "umgebungsvariablen-und-path"]] },
      { slug: "cron-und-systemd-timer", title: "cron und systemd Timer", description: "Geplante Skriptläufe mit Umgebung, Logs und Wiederholbarkeit prüfen.", icon: iconMap.terminal, chips: ["Cron", "Timer"], prefixes: [["automatisierung-und-skripte", "cron-und-systemd-timer"]] }
    ] },
    ...
    { slug: "rechte-und-shell-kontext", title: "Rechte und Shell-Kontext", description: "Dateirechte, Besitz, PATH und sudo klarer trennen.", icon: iconMap.shield, chips: ["Rechte", "sudo"], prefixes: [["shell", "umgebungsvariablen-und-path"], ["shell", "dateirechte-mit-ls-stat-und-chmod-lesen"]], children: [
    ...
    { slug: "praxis", title: "Praxis", description: "Backup, Restore und sichere Vorabprüfung in konkreten Arbeitsabläufen.", icon: iconMap.data, chips: ["Backup", "Restore"], prefixes: [["praxis"], ["praxis-und-betrieb"]], children: [
      { slug: "backup-und-wiederherstellung", title: "Backup und Wiederherstellung", description: "Dry-run, Restore-Test und Löschrisiken bewusst prüfen.", icon: iconMap.data, chips: ["rsync", "Restore"], prefixes: [["praxis", "backup-und-wiederherstellung"], ["praxis-und-betrieb", "backup-und-wiederherstellung"]] },
    ] },
