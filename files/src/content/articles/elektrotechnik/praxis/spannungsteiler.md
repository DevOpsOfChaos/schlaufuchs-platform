...
Spannungsteiler tauchen überall dort auf, wo aus einer vorhandenen Spannung **ein kleinerer, nutzbarer Teil** gewonnen werden soll. In Aufgaben erkennst du das oft an zwei Widerständen in Reihe und der Frage nach einer Teilspannung an einem Zwischenpunkt.

Hilfreich ist dabei die Denkweise: Nicht zuerst blind einsetzen, sondern zuerst klären, **welcher Teil der Gesamtspannung** hier überhaupt abgegriffen wird. Dann wird auch verständlicher, warum sich die Teilspannungen zusammen wieder zur Gesamtspannung ergänzen.
